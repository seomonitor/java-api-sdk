...
/**
 * API tests for KeywordResearchApi
 */
@Ignore
public class KeywordResearchApiTest {

    private final KeywordResearchApi api = new KeywordResearchApi();
     ...
     */
    @Test
    public void researchV30DomainOverviewGetTest() throws Exception {
        Integer campaignId = null;
        String url = null;
        String gapAnalysis = null;
        ResearchDomainOverview response = api.researchV30DomainOverviewGet(campaignId, url, gapAnalysis);
     ...
     */
    @Test
    public void researchV30DomainRankingKeywordsGetTest() throws Exception {
        Integer campaignId = null;
        String url = null;
        Integer limit = null;
        Integer offset = null;
        ...
        String gapAnalysis = null;
        String search = null;
        DomainRankingsData response = api.researchV30DomainRankingKeywordsGet(campaignId, url, limit, offset, orderBy, orderDirection, gapAnalysis, search);
     ...
     */
    @Test
    public void researchV30KeywordsGetTest() throws Exception {
        Integer campaignId = null;
        ...
        String orderBy = null;
        String orderDirection = null;
        List<ResearchKeywords> response = api.researchV30KeywordsGet(campaignId, keywords, limit, offset, orderBy, orderDirection);
     ...
     */
    @Test
    public void researchV30RankingDataGetTest() throws Exception {
        Integer campaignId = null;
        ...
        String orderBy = null;
        String orderDirection = null;
        List<KeywordResearchRankingData> response = api.researchV30RankingDataGet(campaignId, keywords, domains, limit, offset, orderBy, orderDirection);
     ...
     */
    @Test
    public void researchV30RelatedKeywordsGetTest() throws Exception {
        Integer campaignId = null;
        String keyword = null;
        Integer limit = null;
        Integer offset = null;
        ...
        String orderDirection = null;
        String search = null;
        List<TopicKeywordDetail> response = api.researchV30RelatedKeywordsGet(campaignId, keyword, limit, offset, orderBy, orderDirection, search);
     ...
     */
    @Test
    public void researchV30TopicOverviewGetTest() throws Exception {
        Integer campaignId = null;
        String keyword = null;
        TopicsOverview response = api.researchV30TopicOverviewGet(campaignId, keyword);
