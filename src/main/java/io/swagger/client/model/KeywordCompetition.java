...
import io.swagger.client.model.KeywordCompetitorRankingData;
...
public class KeywordCompetition {
  ...
  private List<KeywordCompetitorRankingData> competitors = null;

  public KeywordCompetition keywordId(Integer keywordId) {
   ...
   * @return keywordId
  **/
  @Schema(example = "12345", description = "The unique ID used to identify and reference the keyword in the SEOmonitor system. ")
  ...
  public KeywordCompetition keyword(String keyword) {
   ...
   * @return keyword
  **/
  @Schema(example = "buy shoes online", description = "The exact keyword phrase.")
  ...
  public KeywordCompetition competitors(List<KeywordCompetitorRankingData> competitors) {
    this.competitors = competitors;
    return this;
  }

  public KeywordCompetition addCompetitorsItem(KeywordCompetitorRankingData competitorsItem) {
    if (this.competitors == null) {
      this.competitors = new ArrayList<KeywordCompetitorRankingData>();
    }
   ...
   * @return competitors
  **/
  @Schema(example = "\"competitors\":[{\"domain\":\"footwear.com\",\"landing_page\":\"https://www.footwear.com/athletic-shoes\",\"rank\":5,\"rank_trend\":2},{\"domain\":\"shoesgalore.com\",\"landing_page\":\"https://www.shoesgalore.com/athletic\",\"rank\":7,\"rank_trend\":-1}]", description = "Parent field containing keyword ranking data for the requested competitors. ")
  public List<KeywordCompetitorRankingData> getCompetitors() {
    return competitors;
  }

  public void setCompetitors(List<KeywordCompetitorRankingData> competitors) {
    this.competitors = competitors;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordCompetition keywordCompetition = (KeywordCompetition) o;
    return Objects.equals(this.keywordId, keywordCompetition.keywordId) &&
        Objects.equals(this.keyword, keywordCompetition.keyword) &&
        Objects.equals(this.competitors, keywordCompetition.competitors);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keywordId, keyword, competitors);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordCompetition {\n");
