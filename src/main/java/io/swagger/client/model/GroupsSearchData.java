...
public class GroupsSearchData {
  ...
  public GroupsSearchData searchVolume(Integer searchVolume) {
   ...
   * @return searchVolume
  **/
  @Schema(example = "57000", description = "The average 12-month search volume of all the keywords included in the group, as provided by Google Ads.")
  ...
  public GroupsSearchData monthlySearches(List<MonthlySearches> monthlySearches) {
    this.monthlySearches = monthlySearches;
    return this;
  }

  public GroupsSearchData addMonthlySearchesItem(MonthlySearches monthlySearchesItem) {
  ...
  **/
  @Schema(example = "[{\"month\": \"January\",\"year\": 2022,\"search_volume\": 61000},{\"month\": \"February\",\"year\": 2022,\"search_volume\": 59000}]", description = "An array of objects containing the aggregated search volumes for each of the previous 13 months as provided by Google Ads.")
  ...
  public GroupsSearchData volumeByDevice(GroupsVolumeByDevice volumeByDevice) {
  ...
  **/
  ...
  public GroupsSearchData yearOverYear(Double yearOverYear) {
   ...
   * @return yearOverYear
  **/
  @Schema(example = "1.49", description = "A numeric value representing the last month's search volume divided by the search volume of the same month of the previous year. E.g. +49% year-over-year search trend would be represented as 1.49.  The returned values will be capped at 10, which represents \"newcomers\" (keywords that registered very low search volumes in the previous year).")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsSearchData groupsSearchData = (GroupsSearchData) o;
    return Objects.equals(this.searchVolume, groupsSearchData.searchVolume) &&
        Objects.equals(this.monthlySearches, groupsSearchData.monthlySearches) &&
        Objects.equals(this.volumeByDevice, groupsSearchData.volumeByDevice) &&
        Objects.equals(this.yearOverYear, groupsSearchData.yearOverYear);
  }

  @Override
  public int hashCode() {
    return Objects.hash(searchVolume, monthlySearches, volumeByDevice, yearOverYear);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsSearchData {\n");
