 ...
 */
@Schema(description = "Parent field containing the average desktop and mobile ranks of the keywords weighted by their search volume, for the date specified.")
...
public class GroupsAvgRank {
  ...
  public GroupsAvgRank desktop(Integer desktop) {
   ...
   * @return desktop
  **/
  @Schema(description = "The average rank of the keywords in the specified group weighted by their search volume, for searches coming from desktop devices.")
  ...
  public GroupsAvgRank mobile(Integer mobile) {
    this.mobile = mobile;
    return this;
  }
   ...
   * @return mobile
  **/
  @Schema(description = "The average rank of the keywords in the specified group weighted by their search volume, for searches coming from mobile devices.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsAvgRank groupsAvgRank = (GroupsAvgRank) o;
    return Objects.equals(this.desktop, groupsAvgRank.desktop) &&
        Objects.equals(this.mobile, groupsAvgRank.mobile);
  }
