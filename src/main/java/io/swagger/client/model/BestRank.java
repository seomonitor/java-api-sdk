...
/**
 * Parent field containing the highest position the keyword ranked on Google since it was tracked in the app and the date when it was recorded, for desktop devices.
 */
@Schema(description = "Parent field containing the highest position the keyword ranked on Google since it was tracked in the app and the date when it was recorded, for desktop devices.")
...
public class BestRank {
  ...
  public BestRank rank(Integer rank) {
    this.rank = rank;
    return this;
  }

   /**
   * The highest position the keyword ranked on Google since it was tracked in the app.
   * @return rank
  **/
  @Schema(example = "4", description = "The highest position the keyword ranked on Google since it was tracked in the app.")
  ...
  public BestRank date(LocalDate date) {
    this.date = date;
    return this;
  }

   /**
   * The latest date when the keyword reached the highest position on Google since it was tracked in the app, for desktop devices.
   * @return date
  **/
  @Schema(description = "The latest date when the keyword reached the highest position on Google since it was tracked in the app, for desktop devices.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BestRank bestRank = (BestRank) o;
    return Objects.equals(this.rank, bestRank.rank) &&
        Objects.equals(this.date, bestRank.date);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rank, date);
  }
