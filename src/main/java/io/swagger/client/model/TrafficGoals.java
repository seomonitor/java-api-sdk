...
public class TrafficGoals {
  ...
  public TrafficGoals completions(Integer completions) {
   ...
   * @return completions
  **/
  @Schema(example = "9100", description = "The total number of goal completions uncovered through the (not provided) solution for the selected goals for the date within the selected timeframe.")
  ...
  public TrafficGoals revenue(Integer revenue) {
   ...
   * @return revenue
  **/
  @Schema(example = "273000", description = "The goal revenue uncovered through the (not provided) solution for the selected goals on the date within the selected timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TrafficGoals trafficGoals = (TrafficGoals) o;
    return Objects.equals(this.completions, trafficGoals.completions) &&
        Objects.equals(this.revenue, trafficGoals.revenue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(completions, revenue);
  }
