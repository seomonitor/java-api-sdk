...
import io.swagger.client.model.GroupDetailsVisibility;
import io.swagger.client.model.GroupKeywordCounters;
import io.swagger.client.model.GroupsOpportunity;
import io.swagger.client.model.GroupsSearchData;
import io.swagger.client.model.GroupsSearchIntent;
import io.swagger.client.model.GroupsSerpData;
import io.swagger.client.model.GroupsTrafficData;
...
public class GroupDetails {
  ...
  @SerializedName("keyword_counters")
  private GroupKeywordCounters keywordCounters = null;

  @SerializedName("serp_data")
  private GroupsSerpData serpData = null;

  @SerializedName("percentage_clicks")
  private Double percentageClicks = null;

  @SerializedName("search_intent")
  private GroupsSearchIntent searchIntent = null;

  @SerializedName("search_data")
  private GroupsSearchData searchData = null;

  @SerializedName("visibility")
  private GroupDetailsVisibility visibility = null;

  @SerializedName("opportunity")
  private GroupsOpportunity opportunity = null;

  @SerializedName("traffic_data")
  private GroupsTrafficData trafficData = null;

  public GroupDetails groupId(Integer groupId) {
   ...
   * @return groupId
  **/
  @Schema(example = "2261", description = "The unique identifier for the group in the SEOmonitor system.")
   ...
   * @return groupName
  **/
  @Schema(example = "High opportunity", description = "The name assigned to the group in the SEOmonitor platform.")
  ...
  public GroupDetails keywordCounters(GroupKeywordCounters keywordCounters) {
    this.keywordCounters = keywordCounters;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public GroupKeywordCounters getKeywordCounters() {
    return keywordCounters;
  }

  public void setKeywordCounters(GroupKeywordCounters keywordCounters) {
    this.keywordCounters = keywordCounters;
  }

  public GroupDetails serpData(GroupsSerpData serpData) {
  ...
  **/
  @Schema(description = "")
  public GroupsSerpData getSerpData() {
    return serpData;
  }

  public void setSerpData(GroupsSerpData serpData) {
    this.serpData = serpData;
  }

  public GroupDetails percentageClicks(Double percentageClicks) {
  ...
  **/
  @Schema(example = "0.69", description = "The percentage of searches that end up clicking on organic results, after discounting the searches satisfied by SERP features. Blended metric between desktop and mobile searches.")
  ...
  public GroupDetails searchIntent(GroupsSearchIntent searchIntent) {
  ...
  **/
  @Schema(description = "")
  public GroupsSearchIntent getSearchIntent() {
    return searchIntent;
  }

  public void setSearchIntent(GroupsSearchIntent searchIntent) {
    this.searchIntent = searchIntent;
  }

  public GroupDetails searchData(GroupsSearchData searchData) {
  ...
  **/
  @Schema(description = "")
  public GroupsSearchData getSearchData() {
    return searchData;
  }

  public void setSearchData(GroupsSearchData searchData) {
    this.searchData = searchData;
  }

  public GroupDetails visibility(GroupDetailsVisibility visibility) {
  ...
  **/
  @Schema(description = "")
  public GroupDetailsVisibility getVisibility() {
    return visibility;
  }

  public void setVisibility(GroupDetailsVisibility visibility) {
    this.visibility = visibility;
  }

  public GroupDetails opportunity(GroupsOpportunity opportunity) {
  ...
  **/
  @Schema(description = "")
  public GroupsOpportunity getOpportunity() {
    return opportunity;
  }

  public void setOpportunity(GroupsOpportunity opportunity) {
    this.opportunity = opportunity;
  }

  public GroupDetails trafficData(GroupsTrafficData trafficData) {
  ...
  **/
  @Schema(description = "")
  public GroupsTrafficData getTrafficData() {
    return trafficData;
  }

  public void setTrafficData(GroupsTrafficData trafficData) {
    this.trafficData = trafficData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.groupId, groupDetails.groupId) &&
        Objects.equals(this.groupName, groupDetails.groupName) &&
        Objects.equals(this.keywordCounters, groupDetails.keywordCounters) &&
        Objects.equals(this.serpData, groupDetails.serpData) &&
        Objects.equals(this.percentageClicks, groupDetails.percentageClicks) &&
        Objects.equals(this.searchIntent, groupDetails.searchIntent) &&
        Objects.equals(this.searchData, groupDetails.searchData) &&
        Objects.equals(this.visibility, groupDetails.visibility) &&
        Objects.equals(this.opportunity, groupDetails.opportunity) &&
        Objects.equals(this.trafficData, groupDetails.trafficData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupId, groupName, keywordCounters, serpData, percentageClicks, searchIntent, searchData, visibility, opportunity, trafficData);
  }
  ...
  public String toString() {
    ...
    sb.append("    keywordCounters: ").append(toIndentedString(keywordCounters)).append("\n");
