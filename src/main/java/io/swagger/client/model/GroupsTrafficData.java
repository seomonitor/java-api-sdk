...
public class GroupsTrafficData {
  ...
  public GroupsTrafficData sessions(Integer sessions) {
   ...
   * @return sessions
  **/
  @Schema(description = "The sum of sessions, if the campaign is connected to both Google Search Console and Google Analytics – or clicks, if the campaign is only connected to Google Search Console, within the selected timeframe.")
  ...
  public GroupsTrafficData ecommerce(KeywordTrafficEcommerce ecommerce) {
  ...
  **/
  ...
  public GroupsTrafficData goals(KeywordTrafficGoals goals) {
    this.goals = goals;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsTrafficData groupsTrafficData = (GroupsTrafficData) o;
    return Objects.equals(this.sessions, groupsTrafficData.sessions) &&
        Objects.equals(this.ecommerce, groupsTrafficData.ecommerce) &&
        Objects.equals(this.goals, groupsTrafficData.goals);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sessions, ecommerce, goals);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsTrafficData {\n");
