...
import io.swagger.client.model.DomainCompetitorVisibility;
...
public class DomainOverviewVisibility {
  @SerializedName("my_visibility")
  private DomainCompetitorVisibility myVisibility = null;

  @SerializedName("competitor_visibility")
  private DomainCompetitorVisibility competitorVisibility = null;

  public DomainOverviewVisibility myVisibility(DomainCompetitorVisibility myVisibility) {
  ...
  **/
  @Schema(description = "")
  public DomainCompetitorVisibility getMyVisibility() {
    return myVisibility;
  }

  public void setMyVisibility(DomainCompetitorVisibility myVisibility) {
    this.myVisibility = myVisibility;
  }

  public DomainOverviewVisibility competitorVisibility(DomainCompetitorVisibility competitorVisibility) {
    this.competitorVisibility = competitorVisibility;
    return this;
  }

   /**
   * Get competitorVisibility
   * @return competitorVisibility
  **/
  @Schema(description = "")
  public DomainCompetitorVisibility getCompetitorVisibility() {
    return competitorVisibility;
  }

  public void setCompetitorVisibility(DomainCompetitorVisibility competitorVisibility) {
    this.competitorVisibility = competitorVisibility;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DomainOverviewVisibility domainOverviewVisibility = (DomainOverviewVisibility) o;
    return Objects.equals(this.myVisibility, domainOverviewVisibility.myVisibility) &&
        Objects.equals(this.competitorVisibility, domainOverviewVisibility.competitorVisibility);
  }

  @Override
  public int hashCode() {
    return Objects.hash(myVisibility, competitorVisibility);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainOverviewVisibility {\n");
    
    sb.append("    myVisibility: ").append(toIndentedString(myVisibility)).append("\n");
    sb.append("    competitorVisibility: ").append(toIndentedString(competitorVisibility)).append("\n");
    sb.append("}");
    return sb.toString();
  }
