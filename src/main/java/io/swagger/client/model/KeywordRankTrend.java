...
import io.swagger.client.model.BestRank;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * An object containing information about the ranking data on Google search on specific device (desktop or mobile).
 */
@Schema(description = "An object containing information about the ranking data on Google search on specific device (desktop or mobile).")
...
public class KeywordRankTrend {
  ...
  @SerializedName("trend_impact")
  private Integer trendImpact = null;

  @SerializedName("best_rank")
  private BestRank bestRank = null;

  public KeywordRankTrend rank(Integer rank) {
    this.rank = rank;
    return this;
  }

   /**
   * The keyword&#x27;s position on Google at the end of the selected timeframe.
   * @return rank
  **/
  @Schema(description = "The keyword's position on Google at the end of the selected timeframe.")
  ...
  public KeywordRankTrend trend(Integer trend) {
    this.trend = trend;
    return this;
  }

   /**
   * The difference in positions on Google between the start and the end of the timeframe.
   * @return trend
  **/
  @Schema(description = "The difference in positions on Google between the start and the end of the timeframe.")
  ...
  public KeywordRankTrend trendImpact(Integer trendImpact) {
    this.trendImpact = trendImpact;
    return this;
  }

   /**
   * The number of impressions gained or lost based on the rank change and the keyword&#x27;s search volume. This reflects the impact of the rank change in the desktop Visibility metric.
   * @return trendImpact
  **/
  @Schema(example = "-21530", description = "The number of impressions gained or lost based on the rank change and the keyword's search volume. This reflects the impact of the rank change in the desktop Visibility metric.")
  public Integer getTrendImpact() {
    return trendImpact;
  }

  public void setTrendImpact(Integer trendImpact) {
    this.trendImpact = trendImpact;
  }

  public KeywordRankTrend bestRank(BestRank bestRank) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordRankTrend keywordRankTrend = (KeywordRankTrend) o;
    return Objects.equals(this.rank, keywordRankTrend.rank) &&
        Objects.equals(this.trend, keywordRankTrend.trend) &&
        Objects.equals(this.trendImpact, keywordRankTrend.trendImpact) &&
        Objects.equals(this.bestRank, keywordRankTrend.bestRank);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rank, trend, trendImpact, bestRank);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordRankTrend {\n");
    
    sb.append("    rank: ").append(toIndentedString(rank)).append("\n");
    sb.append("    trend: ").append(toIndentedString(trend)).append("\n");
    sb.append("    trendImpact: ").append(toIndentedString(trendImpact)).append("\n");
    sb.append("    bestRank: ").append(toIndentedString(bestRank)).append("\n");
    sb.append("}");
    return sb.toString();
  }
