...
public class ShareOfClicksDomains {
  @SerializedName("domain")
  private String domain = null;

  @SerializedName("share_of_clicks")
  private Double shareOfClicks = null;

  @SerializedName("monthly_clicks")
  private Integer monthlyClicks = null;

  public ShareOfClicksDomains domain(String domain) {
    this.domain = domain;
    return this;
  }

   /**
   * The domain sharing clicks with the campaign domain.
   * @return domain
  **/
  @Schema(example = "amazon.com", description = "The domain sharing clicks with the campaign domain.")
  ...
  public ShareOfClicksDomains shareOfClicks(Double shareOfClicks) {
    this.shareOfClicks = shareOfClicks;
    return this;
  }

   /**
   * The percentage of the estimated monthly share of clicks the domain receives for the current list of keywords.
   * @return shareOfClicks
  **/
  @Schema(example = "0.53", description = "The percentage of the estimated monthly share of clicks the domain receives for the current list of keywords.")
  public Double getShareOfClicks() {
    return shareOfClicks;
  }

  public void setShareOfClicks(Double shareOfClicks) {
    this.shareOfClicks = shareOfClicks;
  }

  public ShareOfClicksDomains monthlyClicks(Integer monthlyClicks) {
    this.monthlyClicks = monthlyClicks;
    return this;
  }

   /**
   * The estimated monthly clicks the domain receives for the current list of keywords.
   * @return monthlyClicks
  **/
  @Schema(example = "2345000", description = "The estimated monthly clicks the domain receives for the current list of keywords.")
  public Integer getMonthlyClicks() {
    return monthlyClicks;
  }

  public void setMonthlyClicks(Integer monthlyClicks) {
    this.monthlyClicks = monthlyClicks;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ShareOfClicksDomains shareOfClicksDomains = (ShareOfClicksDomains) o;
    return Objects.equals(this.domain, shareOfClicksDomains.domain) &&
        Objects.equals(this.shareOfClicks, shareOfClicksDomains.shareOfClicks) &&
        Objects.equals(this.monthlyClicks, shareOfClicksDomains.monthlyClicks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, shareOfClicks, monthlyClicks);
  }
  ...
  public String toString() {
    ...
    sb.append("class ShareOfClicksDomains {\n");
    
    sb.append("    domain: ").append(toIndentedString(domain)).append("\n");
    sb.append("    shareOfClicks: ").append(toIndentedString(shareOfClicks)).append("\n");
    sb.append("    monthlyClicks: ").append(toIndentedString(monthlyClicks)).append("\n");
    sb.append("}");
    return sb.toString();
  }
