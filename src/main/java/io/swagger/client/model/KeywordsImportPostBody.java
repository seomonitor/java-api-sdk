...
public class KeywordsImportPostBody {
  ...
  public KeywordsImportPostBody campaignId(Integer campaignId) {
    this.campaignId = campaignId;
    return this;
  }

   /**
   * The ID of the campaign to which you want to add/import keywords.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns.
   * @return campaignId
  **/
  @Schema(example = "1234", description = "The ID of the campaign to which you want to add/import keywords.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns.")
  ...
  public KeywordsImportPostBody keywords(String keywords) {
    this.keywords = keywords;
    return this;
  }

   /**
   * A comma-separated list of new keywords that you want to import into the campaign. E.g. &#x60;\&quot;christmas party dresses, christmas sweater, christmas jumpers\&quot;&#x60;.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your keywords.
   * @return keywords
  **/
  @Schema(example = "\"keyword one,keyword two,keyword three\"", description = "A comma-separated list of new keywords that you want to import into the campaign. E.g. `\"christmas party dresses, christmas sweater, christmas jumpers\"`.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your keywords.")
  ...
  public KeywordsImportPostBody groupIds(String groupIds) {
    this.groupIds = groupIds;
    return this;
  }

   /**
   * A comma-separated list of group IDs into which you want to import the keywords. E.g. &#x60;\&quot;199212, 1237564\&quot;&#x60;.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your groups.  If you don&#x27;t specify &#x60;group_ids&#x60;, the keywords will be added to an automatically-generated group (&#x60;API-import-YYYY-MM-DD&#x60;).
   * @return groupIds
  **/
  @Schema(example = "\"199212, 1237564\"", description = "A comma-separated list of group IDs into which you want to import the keywords. E.g. `\"199212, 1237564\"`.  Please refer to the Quick Start Guide to learn how to retrieve the IDs of your groups.  If you don't specify `group_ids`, the keywords will be added to an automatically-generated group (`API-import-YYYY-MM-DD`).")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordsImportPostBody keywordsImportPostBody = (KeywordsImportPostBody) o;
    return Objects.equals(this.campaignId, keywordsImportPostBody.campaignId) &&
        Objects.equals(this.keywords, keywordsImportPostBody.keywords) &&
        Objects.equals(this.groupIds, keywordsImportPostBody.groupIds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(campaignId, keywords, groupIds);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordsImportPostBody {\n");
