...
import io.swagger.client.model.ForecastAdditionalTraffic;
import io.swagger.client.model.ForecastAdsEquivalent;
import io.swagger.client.model.ForecastOverviewInertialTraffic;
...
public class ForecastOverviewData {
  @SerializedName("additional_traffic")
  private ForecastAdditionalTraffic additionalTraffic = null;

  @SerializedName("inertial_traffic")
  private ForecastOverviewInertialTraffic inertialTraffic = null;

  @SerializedName("ads_equivalent")
  private ForecastAdsEquivalent adsEquivalent = null;

  public ForecastOverviewData additionalTraffic(ForecastAdditionalTraffic additionalTraffic) {
    this.additionalTraffic = additionalTraffic;
    return this;
  }

   /**
   * Get additionalTraffic
   * @return additionalTraffic
  **/
  @Schema(description = "")
  public ForecastAdditionalTraffic getAdditionalTraffic() {
    return additionalTraffic;
  }

  public void setAdditionalTraffic(ForecastAdditionalTraffic additionalTraffic) {
    this.additionalTraffic = additionalTraffic;
  }

  public ForecastOverviewData inertialTraffic(ForecastOverviewInertialTraffic inertialTraffic) {
    this.inertialTraffic = inertialTraffic;
    return this;
  }

   /**
   * Get inertialTraffic
   * @return inertialTraffic
  **/
  @Schema(description = "")
  public ForecastOverviewInertialTraffic getInertialTraffic() {
    return inertialTraffic;
  }

  public void setInertialTraffic(ForecastOverviewInertialTraffic inertialTraffic) {
    this.inertialTraffic = inertialTraffic;
  }

  public ForecastOverviewData adsEquivalent(ForecastAdsEquivalent adsEquivalent) {
   ...
   /**
   * Get adsEquivalent
   * @return adsEquivalent
  **/
  @Schema(description = "")
  public ForecastAdsEquivalent getAdsEquivalent() {
    return adsEquivalent;
  }

  public void setAdsEquivalent(ForecastAdsEquivalent adsEquivalent) {
    this.adsEquivalent = adsEquivalent;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastOverviewData forecastOverviewData = (ForecastOverviewData) o;
    return Objects.equals(this.additionalTraffic, forecastOverviewData.additionalTraffic) &&
        Objects.equals(this.inertialTraffic, forecastOverviewData.inertialTraffic) &&
        Objects.equals(this.adsEquivalent, forecastOverviewData.adsEquivalent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(additionalTraffic, inertialTraffic, adsEquivalent);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastOverviewData {\n");
    
    sb.append("    additionalTraffic: ").append(toIndentedString(additionalTraffic)).append("\n");
    sb.append("    inertialTraffic: ").append(toIndentedString(inertialTraffic)).append("\n");
    sb.append("    adsEquivalent: ").append(toIndentedString(adsEquivalent)).append("\n");
    sb.append("}");
    return sb.toString();
  }
