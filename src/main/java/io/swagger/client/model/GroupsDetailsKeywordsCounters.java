...
public class GroupsDetailsKeywordsCounters {
  @SerializedName("main_keywords")
  private Integer mainKeywords = null;

  @SerializedName("close_variations")
  private Integer closeVariations = null;

  public GroupsDetailsKeywordsCounters mainKeywords(Integer mainKeywords) {
   ...
   * @return mainKeywords
  **/
  @Schema(description = "Group main keywords")
  public Integer getMainKeywords() {
    return mainKeywords;
  }

  public void setMainKeywords(Integer mainKeywords) {
    this.mainKeywords = mainKeywords;
  }

  public GroupsDetailsKeywordsCounters closeVariations(Integer closeVariations) {
    this.closeVariations = closeVariations;
    return this;
  }

   /**
   * Group keyword close variations
   * @return closeVariations
  **/
  @Schema(description = "Group keyword close variations")
  public Integer getCloseVariations() {
    return closeVariations;
  }

  public void setCloseVariations(Integer closeVariations) {
    this.closeVariations = closeVariations;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsDetailsKeywordsCounters groupsDetailsKeywordsCounters = (GroupsDetailsKeywordsCounters) o;
    return Objects.equals(this.mainKeywords, groupsDetailsKeywordsCounters.mainKeywords) &&
        Objects.equals(this.closeVariations, groupsDetailsKeywordsCounters.closeVariations);
  }

  @Override
  public int hashCode() {
    return Objects.hash(mainKeywords, closeVariations);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsDetailsKeywordsCounters {\n");
    
    sb.append("    mainKeywords: ").append(toIndentedString(mainKeywords)).append("\n");
    sb.append("    closeVariations: ").append(toIndentedString(closeVariations)).append("\n");
    sb.append("}");
    return sb.toString();
  }
