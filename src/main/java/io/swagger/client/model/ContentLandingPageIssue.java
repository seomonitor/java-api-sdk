...
import io.swagger.client.model.DifficultyValue;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;
/**
 * A single issue of a landing page for the campaign
 */
@Schema(description = "A single issue of a landing page for the campaign")
...
public class ContentLandingPageIssue {
  ...
  @SerializedName("average_ctr")
  private Double averageCtr = null;

  @SerializedName("search_volume")
  private Integer searchVolume = null;

  @SerializedName("year_over_year")
  private Double yearOverYear = null;

  @SerializedName("visibility_score")
  private Integer visibilityScore = null;

  @SerializedName("visibility_score_change")
  private Integer visibilityScoreChange = null;

  @SerializedName("difficulty")
  private DifficultyValue difficulty = null;

  @SerializedName("opportunity_score")
  private Integer opportunityScore = null;

  public ContentLandingPageIssue issueId(Integer issueId) {
    this.issueId = issueId;
    return this;
  }

   /**
   * Internal ID for this issue.
   * @return issueId
  **/
  @Schema(description = "Internal ID for this issue.")
  ...
  public ContentLandingPageIssue url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return url
  **/
  @Schema(description = "URL of the landing page")
  ...
  public ContentLandingPageIssue type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(description = "The type of the issue reported. Available values are: missing_title => Pages with missing title or h1; suboptimal_title_inclusion => Pages with suboptimal keyword inclusion in the title or h1; suboptimal_content_inclusion => Pages with suboptimal keyword inclusion in the content; pages_with_many_keywords => Pages considered to be serving too many keywords; visibility_increase => Pages with an increase in the visibility metric that can be correlated with a content change; visibility_drop => Pages with a drop in the visibility metric that can be correlated with a content change;")
  ...
  public ContentLandingPageIssue keywords(List<Integer> keywords) {
    this.keywords = keywords;
    return this;
  }

  public ContentLandingPageIssue addKeywordsItem(Integer keywordsItem) {
   ...
   /**
   * Array of keyword IDs of the keywords which rank for this landing page.
   * @return keywords
  **/
  @Schema(description = "Array of keyword IDs of the keywords which rank for this landing page.")
  ...
  public ContentLandingPageIssue averageCtr(Double averageCtr) {
   ...
   * @return averageCtr
  **/
  @Schema(description = "The percentage of the search volume that ends up by clicking on the organic results. This is calculated for every keyword for their unique mix of SERP features. For a landing page, this is calculated by taking into account the CTR of every keyword it ranks for and the potential search volume of that particular keyword.")
  ...
  public ContentLandingPageIssue searchVolume(Integer searchVolume) {
    this.searchVolume = searchVolume;
    return this;
  }

   /**
   * The sum of the average search volume as an integer as provided by Google Ads for the keywords ranking for this landing page.
   * @return searchVolume
  **/
  @Schema(description = "The sum of the average search volume as an integer as provided by Google Ads for the keywords ranking for this landing page.")
  ...
  public ContentLandingPageIssue yearOverYear(Double yearOverYear) {
    this.yearOverYear = yearOverYear;
    return this;
  }

   /**
   * The Year-over-Year search trend as a positive or negative percentage calculated as last month Search Volume compared to one year ago, as provided by Google Ads.
   * @return yearOverYear
  **/
  @Schema(description = "The Year-over-Year search trend as a positive or negative percentage calculated as last month Search Volume compared to one year ago, as provided by Google Ads.")
  ...
  public ContentLandingPageIssue visibilityScore(Integer visibilityScore) {
    this.visibilityScore = visibilityScore;
    return this;
  }

   /**
   * The visibility score of the landing page as a percentage calculated by taking into account the ranks and the search volumes of the keywords the landing page ranks for. For more detalils on visibility metric: https://help.seomonitor.com/en/articles/6344566-reliable-visibility-metric
   * @return visibilityScore
  **/
  @Schema(description = "The visibility score of the landing page as a percentage calculated by taking into account the ranks and the search volumes of the keywords the landing page ranks for. For more detalils on visibility metric: https://help.seomonitor.com/en/articles/6344566-reliable-visibility-metric")
  ...
  public ContentLandingPageIssue visibilityScoreChange(Integer visibilityScoreChange) {
    this.visibilityScoreChange = visibilityScoreChange;
    return this;
  }

   /**
   * The visibility score change for the past 30 days as a positive or negative percentage. For more information on the visibility trend: https://help.seomonitor.com/en/articles/6344738-visibility-trend-explainer
   * @return visibilityScoreChange
  **/
  @Schema(description = "The visibility score change for the past 30 days as a positive or negative percentage. For more information on the visibility trend: https://help.seomonitor.com/en/articles/6344738-visibility-trend-explainer")
  public Integer getVisibilityScoreChange() {
    return visibilityScoreChange;
  }

  public void setVisibilityScoreChange(Integer visibilityScoreChange) {
    this.visibilityScoreChange = visibilityScoreChange;
  }

  public ContentLandingPageIssue difficulty(DifficultyValue difficulty) {
  ...
  **/
  @Schema(description = "")
  public DifficultyValue getDifficulty() {
    return difficulty;
  }

  public void setDifficulty(DifficultyValue difficulty) {
    this.difficulty = difficulty;
  }

  public ContentLandingPageIssue opportunityScore(Integer opportunityScore) {
  ...
  **/
  @Schema(description = "The opportunity score of this particular landing page. This indicates on a scale of 1 to 10 the potential benefits of optimizing this landing page to rank in top 3 for it's keywords as compared to the difficulty of reaching that milestone. For more information about keywords and groups of keywords opportunity score: https://help.seomonitor.com/en/articles/6222130-seo-opportunity")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ContentLandingPageIssue contentLandingPageIssue = (ContentLandingPageIssue) o;
    return Objects.equals(this.issueId, contentLandingPageIssue.issueId) &&
        Objects.equals(this.url, contentLandingPageIssue.url) &&
        Objects.equals(this.type, contentLandingPageIssue.type) &&
        Objects.equals(this.keywords, contentLandingPageIssue.keywords) &&
        Objects.equals(this.averageCtr, contentLandingPageIssue.averageCtr) &&
        Objects.equals(this.searchVolume, contentLandingPageIssue.searchVolume) &&
        Objects.equals(this.yearOverYear, contentLandingPageIssue.yearOverYear) &&
        Objects.equals(this.visibilityScore, contentLandingPageIssue.visibilityScore) &&
        Objects.equals(this.visibilityScoreChange, contentLandingPageIssue.visibilityScoreChange) &&
        Objects.equals(this.difficulty, contentLandingPageIssue.difficulty) &&
        Objects.equals(this.opportunityScore, contentLandingPageIssue.opportunityScore);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issueId, url, type, keywords, averageCtr, searchVolume, yearOverYear, visibilityScore, visibilityScoreChange, difficulty, opportunityScore);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContentLandingPageIssue {\n");
    
    sb.append("    issueId: ").append(toIndentedString(issueId)).append("\n");
    sb.append("    url: ").append(toIndentedString(url)).append("\n");
    sb.append("    type: ").append(toIndentedString(type)).append("\n");
    sb.append("    keywords: ").append(toIndentedString(keywords)).append("\n");
    sb.append("    averageCtr: ").append(toIndentedString(averageCtr)).append("\n");
    sb.append("    searchVolume: ").append(toIndentedString(searchVolume)).append("\n");
    sb.append("    yearOverYear: ").append(toIndentedString(yearOverYear)).append("\n");
    sb.append("    visibilityScore: ").append(toIndentedString(visibilityScore)).append("\n");
    sb.append("    visibilityScoreChange: ").append(toIndentedString(visibilityScoreChange)).append("\n");
