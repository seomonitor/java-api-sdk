...
import io.swagger.client.model.SerpFeaturePresenceByDevice;
...
public class SerpFeaturePresenceSerpData {
  @SerializedName("date")
  private LocalDate date = null;

  @SerializedName("desktop")
  private List<SerpFeaturePresenceByDevice> desktop = null;

  @SerializedName("mobile")
  private List<SerpFeaturePresenceByDevice> mobile = null;

  public SerpFeaturePresenceSerpData date(LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   * @return date
  **/
  @Schema(example = "Mon Jul 10 02:00:00 SAST 2023", description = "The date within the selected timeframe when the SERP features were detected. ")
  ...
  public SerpFeaturePresenceSerpData desktop(List<SerpFeaturePresenceByDevice> desktop) {
    this.desktop = desktop;
    return this;
  }

  public SerpFeaturePresenceSerpData addDesktopItem(SerpFeaturePresenceByDevice desktopItem) {
    if (this.desktop == null) {
      this.desktop = new ArrayList<SerpFeaturePresenceByDevice>();
    }
   ...
   * @return desktop
  **/
  @Schema(example = "{             \"feature\": \"IMG\",             \"listed\": false         }", description = "Parent field containing the features present in the desktop SERP on the returned date.")
  public List<SerpFeaturePresenceByDevice> getDesktop() {
    return desktop;
  }

  public void setDesktop(List<SerpFeaturePresenceByDevice> desktop) {
    this.desktop = desktop;
  }

  public SerpFeaturePresenceSerpData mobile(List<SerpFeaturePresenceByDevice> mobile) {
    this.mobile = mobile;
    return this;
  }

  public SerpFeaturePresenceSerpData addMobileItem(SerpFeaturePresenceByDevice mobileItem) {
    if (this.mobile == null) {
      this.mobile = new ArrayList<SerpFeaturePresenceByDevice>();
    }
   ...
   * @return mobile
  **/
  @Schema(example = "{             \"feature\": \"IMG\",             \"listed\": false         }", description = "Parent field containing the SERP features detected on searches from mobile devices.")
  public List<SerpFeaturePresenceByDevice> getMobile() {
    return mobile;
  }

  public void setMobile(List<SerpFeaturePresenceByDevice> mobile) {
    this.mobile = mobile;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SerpFeaturePresenceSerpData serpFeaturePresenceSerpData = (SerpFeaturePresenceSerpData) o;
    return Objects.equals(this.date, serpFeaturePresenceSerpData.date) &&
        Objects.equals(this.desktop, serpFeaturePresenceSerpData.desktop) &&
        Objects.equals(this.mobile, serpFeaturePresenceSerpData.mobile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, desktop, mobile);
  }
  ...
  public String toString() {
    ...
    sb.append("class SerpFeaturePresenceSerpData {\n");
