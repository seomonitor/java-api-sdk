...
import io.swagger.client.model.KeywordTrafficEcommerce;
import io.swagger.client.model.KeywordTrafficGoals;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * An object containing the traffic metrics aggregated as sums in the selected timeframe.
 */
@Schema(description = "An object containing the traffic metrics aggregated as sums in the selected timeframe.")
...
public class KeywordTrafficData {
  @SerializedName("currency")
  private String currency = null;

  @SerializedName("ecommerce")
  private KeywordTrafficEcommerce ecommerce = null;

  @SerializedName("goals")
  private KeywordTrafficGoals goals = null;

  @SerializedName("sessions")
  private Integer sessions = null;

  public KeywordTrafficData currency(String currency) {
    this.currency = currency;
    return this;
  }

   /**
   * The currency for the revenue metrics in the eccomerce and goals objects.
   * @return currency
  **/
  @Schema(description = "The currency for the revenue metrics in the eccomerce and goals objects.")
  ...
  public KeywordTrafficData ecommerce(KeywordTrafficEcommerce ecommerce) {
  ...
  **/
  @Schema(description = "")
  public KeywordTrafficEcommerce getEcommerce() {
    return ecommerce;
  }

  public void setEcommerce(KeywordTrafficEcommerce ecommerce) {
    this.ecommerce = ecommerce;
  }

  public KeywordTrafficData goals(KeywordTrafficGoals goals) {
    this.goals = goals;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public KeywordTrafficGoals getGoals() {
    return goals;
  }

  public void setGoals(KeywordTrafficGoals goals) {
    this.goals = goals;
  }

  public KeywordTrafficData sessions(Integer sessions) {
   ...
   * @return sessions
  **/
  @Schema(example = "32000", description = "The sum of sessions, if the campaign is connected to both Google Search Console and Google Analytics – or clicks, if the campaign is only connected to Google Search Console, within the selected timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordTrafficData keywordTrafficData = (KeywordTrafficData) o;
    return Objects.equals(this.currency, keywordTrafficData.currency) &&
        Objects.equals(this.ecommerce, keywordTrafficData.ecommerce) &&
        Objects.equals(this.goals, keywordTrafficData.goals) &&
        Objects.equals(this.sessions, keywordTrafficData.sessions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(currency, ecommerce, goals, sessions);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordTrafficData {\n");
