...
public class Group {
   ...
   * @return groupId
  **/
  @Schema(example = "12345", description = "The unique identifier for the keyword group. It can be used to reference the group in other endpoints.")
   ...
   * @return name
  **/
  @Schema(example = "Keyword Opportunities", description = "The name of the group.")
   ...
   * @return type
  **/
  @Schema(example = "folder", description = "Indicates the type of group - either a regular group, a folder for organizing groups, or smart group based on rules.   Possible values are `group`, `folder`, or `smart_group`.")
  ...
  public Group addSubgroupsItem(Group subgroupsItem) {
   ...
   /**
   * Parent field containing subgroup objects if the group type is &#x60;folder&#x60;. 
   * @return subgroups
  **/
  @Schema(example = "{\"group_id\":178456,\"name\":\"High opportunity\",\"type\":\"smart_group\"}", description = "Parent field containing subgroup objects if the group type is `folder`. ")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(groupId, name, type, subgroups);
  }
