...
public class ForecastTrafficVisibility {
  ...
  public ForecastTrafficVisibility estimated(Double estimated) {
    this.estimated = estimated;
    return this;
  }

   /**
   * The estimated Visibility.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this is the value calculated for the lower (worst) target rank.
   * @return estimated
  **/
  @Schema(description = "The estimated Visibility.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.")
  ...
  public ForecastTrafficVisibility estimatedBestTarget(Integer estimatedBestTarget) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastTrafficVisibility forecastTrafficVisibility = (ForecastTrafficVisibility) o;
    return Objects.equals(this.estimated, forecastTrafficVisibility.estimated) &&
        Objects.equals(this.estimatedBestTarget, forecastTrafficVisibility.estimatedBestTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(estimated, estimatedBestTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastTrafficVisibility {\n");
