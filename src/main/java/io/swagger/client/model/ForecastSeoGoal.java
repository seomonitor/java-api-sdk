...
import io.swagger.client.model.ForecastScenarioSearchData;
import io.swagger.client.model.ForecastTargetData;
...
public class ForecastSeoGoal {
  @SerializedName("keywords_count")
  private Integer keywordsCount = null;

  @SerializedName("search_data")
  private ForecastScenarioSearchData searchData = null;

  @SerializedName("target")
  private ForecastTargetData target = null;

  @SerializedName("goal_chance")
  private String goalChance = null;

  public ForecastSeoGoal keywordsCount(Integer keywordsCount) {
  ...
  **/
  @Schema(example = "234", description = "The total number of keywords included in the Objective.")
  ...
  public ForecastSeoGoal searchData(ForecastScenarioSearchData searchData) {
  ...
  **/
  @Schema(description = "")
  public ForecastScenarioSearchData getSearchData() {
    return searchData;
  }

  public void setSearchData(ForecastScenarioSearchData searchData) {
    this.searchData = searchData;
  }

  public ForecastSeoGoal target(ForecastTargetData target) {
    this.target = target;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public ForecastTargetData getTarget() {
    return target;
  }

  public void setTarget(ForecastTargetData target) {
    this.target = target;
  }

  public ForecastSeoGoal goalChance(String goalChance) {
   ...
   * @return goalChance
  **/
  @Schema(example = "realistic", description = "The chance of achieving the target ranks considering the average Difficulty of the keywords weighted by Additional Sessions, the average Target Rank and the Initial Rank, and the configured Progression Speed.  Possible values are `realistic`, `ambitious`, or `too ambitious`.")
  public String getGoalChance() {
    return goalChance;
  }

  public void setGoalChance(String goalChance) {
    this.goalChance = goalChance;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastSeoGoal forecastSeoGoal = (ForecastSeoGoal) o;
    return Objects.equals(this.keywordsCount, forecastSeoGoal.keywordsCount) &&
        Objects.equals(this.searchData, forecastSeoGoal.searchData) &&
        Objects.equals(this.target, forecastSeoGoal.target) &&
        Objects.equals(this.goalChance, forecastSeoGoal.goalChance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keywordsCount, searchData, target, goalChance);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastSeoGoal {\n");
    ...
    sb.append("    goalChance: ").append(toIndentedString(goalChance)).append("\n");
    sb.append("}");
    return sb.toString();
  }
