...
public class ResearchSearchData {
  ...
  private MonthlySearches monthlySearches = null;

  public ResearchSearchData searchVolume(Integer searchVolume) {
   ...
   * @return searchVolume
  **/
  @Schema(example = "18100", description = "The average 12-month desktop search volume as provided by Google Ads.")
  ...
  public ResearchSearchData yearOverYear(Double yearOverYear) {
  ...
  **/
  ...
  public ResearchSearchData monthlySearches(MonthlySearches monthlySearches) {
  ...
  **/
  @Schema(description = "")
  public MonthlySearches getMonthlySearches() {
    return monthlySearches;
  }

  public void setMonthlySearches(MonthlySearches monthlySearches) {
    this.monthlySearches = monthlySearches;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResearchSearchData researchSearchData = (ResearchSearchData) o;
    return Objects.equals(this.searchVolume, researchSearchData.searchVolume) &&
        Objects.equals(this.yearOverYear, researchSearchData.yearOverYear) &&
        Objects.equals(this.monthlySearches, researchSearchData.monthlySearches);
  }

  @Override
  public int hashCode() {
    return Objects.hash(searchVolume, yearOverYear, monthlySearches);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResearchSearchData {\n");
