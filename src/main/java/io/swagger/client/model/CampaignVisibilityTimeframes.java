...
import io.swagger.client.model.VisbilityAndPerformance;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * The Visibility shows your website’s share of the total searches (impressions), out of the total potential it could get.  Performance is the Visibility trend generated by the keywords tracked throughout the entire selected timeframe (so ignoring the ones added later than the start date, for example)
 */
@Schema(description = "The Visibility shows your website’s share of the total searches (impressions), out of the total potential it could get.  Performance is the Visibility trend generated by the keywords tracked throughout the entire selected timeframe (so ignoring the ones added later than the start date, for example)")
...
public class CampaignVisibilityTimeframes {
  @SerializedName("desktop")
  private VisbilityAndPerformance desktop = null;

  @SerializedName("mobile")
  private VisbilityAndPerformance mobile = null;

  @SerializedName("blended")
  private VisbilityAndPerformance blended = null;

  public CampaignVisibilityTimeframes desktop(VisbilityAndPerformance desktop) {
  ...
  **/
  @Schema(description = "")
  public VisbilityAndPerformance getDesktop() {
    return desktop;
  }

  public void setDesktop(VisbilityAndPerformance desktop) {
    this.desktop = desktop;
  }

  public CampaignVisibilityTimeframes mobile(VisbilityAndPerformance mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public VisbilityAndPerformance getMobile() {
    return mobile;
  }

  public void setMobile(VisbilityAndPerformance mobile) {
    this.mobile = mobile;
  }

  public CampaignVisibilityTimeframes blended(VisbilityAndPerformance blended) {
  ...
  **/
  @Schema(description = "")
  public VisbilityAndPerformance getBlended() {
    return blended;
  }

  public void setBlended(VisbilityAndPerformance blended) {
    this.blended = blended;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CampaignVisibilityTimeframes campaignVisibilityTimeframes = (CampaignVisibilityTimeframes) o;
    return Objects.equals(this.desktop, campaignVisibilityTimeframes.desktop) &&
        Objects.equals(this.mobile, campaignVisibilityTimeframes.mobile) &&
        Objects.equals(this.blended, campaignVisibilityTimeframes.blended);
  }

  @Override
  public int hashCode() {
    return Objects.hash(desktop, mobile, blended);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignVisibilityTimeframes {\n");
    
    sb.append("    desktop: ").append(toIndentedString(desktop)).append("\n");
    sb.append("    mobile: ").append(toIndentedString(mobile)).append("\n");
    sb.append("    blended: ").append(toIndentedString(blended)).append("\n");
    sb.append("}");
    return sb.toString();
  }
