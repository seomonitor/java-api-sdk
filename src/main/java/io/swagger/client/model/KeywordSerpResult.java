...
public class KeywordSerpResult {
  ...
  public KeywordSerpResult rank(Integer rank) {
    this.rank = rank;
    return this;
  }
   ...
   * @return rank
  **/
  @Schema(description = "Serp result rank")
  ...
  public KeywordSerpResult url(String url) {
    this.url = url;
    return this;
  }
   ...
   * @return url
  **/
  @Schema(description = "Serp result url")
  ...
  public KeywordSerpResult title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return title
  **/
  @Schema(description = "Serp result title")
  ...
  public KeywordSerpResult description(String description) {
   ...
   * @return description
  **/
  @Schema(description = "Serp result description")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordSerpResult keywordSerpResult = (KeywordSerpResult) o;
    return Objects.equals(this.rank, keywordSerpResult.rank) &&
        Objects.equals(this.url, keywordSerpResult.url) &&
        Objects.equals(this.title, keywordSerpResult.title) &&
        Objects.equals(this.description, keywordSerpResult.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rank, url, title, description);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordSerpResult {\n");
