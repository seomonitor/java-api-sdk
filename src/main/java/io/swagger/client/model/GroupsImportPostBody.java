...
public class GroupsImportPostBody {
  ...
  public GroupsImportPostBody campaignId(Integer campaignId) {
    this.campaignId = campaignId;
    return this;
  }

   /**
   * The campaign in which to import the folders and groups.
   * @return campaignId
  **/
  @Schema(example = "1234", description = "The campaign in which to import the folders and groups.")
  ...
  public GroupsImportPostBody folders(String folders) {
    this.folders = folders;
    return this;
  }

   /**
   * An array of folders and groups in which to be imported.
   * @return folders
  **/
  @Schema(example = "\"folders\": [         {             \"name\": \"first folder\",             \"groups\": [                 \"test\",                 \"test1\"             ]         },         {             \"name\": \"Second folder\",             \"groups\": [                 \"test\",                 \"test2\"             ]         }     ]", description = "An array of folders and groups in which to be imported.")
  ...
  public GroupsImportPostBody groups(String groups) {
    this.groups = groups;
    return this;
  }
   ...
   * @return groups
  **/
  @Schema(example = " \"groups\": [         \"test4\",         \"test5\"     ]", description = "The groups to be added.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsImportPostBody groupsImportPostBody = (GroupsImportPostBody) o;
    return Objects.equals(this.campaignId, groupsImportPostBody.campaignId) &&
        Objects.equals(this.folders, groupsImportPostBody.folders) &&
        Objects.equals(this.groups, groupsImportPostBody.groups);
  }

  @Override
  public int hashCode() {
    return Objects.hash(campaignId, folders, groups);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsImportPostBody {\n");
