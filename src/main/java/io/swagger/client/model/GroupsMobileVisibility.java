 ...
 */
@Schema(description = "Parent field containing the mobile Visibility of the website for all the keywords of the group and the change in their percentage.")
...
public class GroupsMobileVisibility {
  ...
  public GroupsMobileVisibility latest(Double latest) {
    this.latest = latest;
    return this;
  }

   /**
   * The overall mobile Visibility at the end of the specified timeframe.
   * @return latest
  **/
  @Schema(description = "The overall mobile Visibility at the end of the specified timeframe.")
  ...
  public GroupsMobileVisibility trend(Double trend) {
    this.trend = trend;
    return this;
  }

   /**
   * Percentage change in mobile Visibility of the website for all the keywords in the group over the given timeframe.
   * @return trend
  **/
  @Schema(description = "Percentage change in mobile Visibility of the website for all the keywords in the group over the given timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsMobileVisibility groupsMobileVisibility = (GroupsMobileVisibility) o;
    return Objects.equals(this.latest, groupsMobileVisibility.latest) &&
        Objects.equals(this.trend, groupsMobileVisibility.trend);
  }

  @Override
  public int hashCode() {
    return Objects.hash(latest, trend);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsMobileVisibility {\n");
