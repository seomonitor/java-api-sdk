...
public class GroupKeywordCounters {
  ...
  public GroupKeywordCounters mainKeywords(Integer mainKeywords) {
   ...
   * @return mainKeywords
  **/
  @Schema(example = "467", description = "The total number of main keywords (non-close variations) present in the group.")
  ...
  public GroupKeywordCounters closeVariations(Integer closeVariations) {
  ...
  **/
  @Schema(example = "3", description = "The total number of close variations present in the group.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupKeywordCounters groupKeywordCounters = (GroupKeywordCounters) o;
    return Objects.equals(this.mainKeywords, groupKeywordCounters.mainKeywords) &&
        Objects.equals(this.closeVariations, groupKeywordCounters.closeVariations);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupKeywordCounters {\n");
