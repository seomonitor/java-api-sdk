...
public class OverviewTrafficData {
  ...
  public OverviewTrafficData traffic(Integer traffic) {
    this.traffic = traffic;
    return this;
  }

   /**
   * The estimated organic traffic of the campaign website over the past 30 days.
   * @return traffic
  **/
  @Schema(example = "290000", description = "The estimated organic traffic of the campaign website over the past 30 days.")
  ...
  public OverviewTrafficData trend(Double trend) {
    this.trend = trend;
    return this;
  }

   /**
   * The percentage change in the estimated traffic over the last 30 days compared to the previous 30 days.
   * @return trend
  **/
  @Schema(example = "0.1", description = "The percentage change in the estimated traffic over the last 30 days compared to the previous 30 days.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OverviewTrafficData overviewTrafficData = (OverviewTrafficData) o;
    return Objects.equals(this.traffic, overviewTrafficData.traffic) &&
        Objects.equals(this.trend, overviewTrafficData.trend);
  }

  @Override
  public int hashCode() {
    return Objects.hash(traffic, trend);
  }
  ...
  public String toString() {
    ...
    sb.append("class OverviewTrafficData {\n");
