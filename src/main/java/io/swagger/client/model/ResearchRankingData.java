...
public class ResearchRankingData {
  @SerializedName("updated_on")
  private LocalDate updatedOn = null;
  ...
  public ResearchRankingData updatedOn(LocalDate updatedOn) {
   ...
   * @return updatedOn
  **/
  @Schema(description = "The date when the latest crawl was performed, in YYYY-MM-DD format.")
  ...
  public ResearchRankingData rank(Integer rank) {
    this.rank = rank;
    return this;
  }
   ...
   * @return rank
  **/
  @Schema(example = "45", description = "The position on Google at the latest crawl date refreshed within the past 30 days, for desktop devices.")
  ...
  public ResearchRankingData trend(Integer trend) {
    this.trend = trend;
    return this;
  }
   ...
   * @return trend
  **/
  @Schema(example = "3", description = "The difference in positions on Google between the latest rank and the rank identified at the previous crawl, for desktop devices.")
  ...
  public ResearchRankingData landingPage(String landingPage) {
   ...
   * @return landingPage
  **/
  @Schema(example = "\"https://deliveroo.co.uk/restaurants/manchester/sale\"", description = "The landing page of your website that is currently ranking with the keyword on Google searches performed from desktop devices.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResearchRankingData researchRankingData = (ResearchRankingData) o;
    return Objects.equals(this.updatedOn, researchRankingData.updatedOn) &&
        Objects.equals(this.rank, researchRankingData.rank) &&
        Objects.equals(this.trend, researchRankingData.trend) &&
        Objects.equals(this.landingPage, researchRankingData.landingPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updatedOn, rank, trend, landingPage);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResearchRankingData {\n");
