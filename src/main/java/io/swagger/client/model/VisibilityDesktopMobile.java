...
/**
 * The Visibility shows your campaign’s share of the total searches (impressions), out of the total potential it could get.
 */
@Schema(description = "The Visibility shows your campaign’s share of the total searches (impressions), out of the total potential it could get.")
...
public class VisibilityDesktopMobile {
  @SerializedName("latest")
  private Double latest = null;

  @SerializedName("trend_7days")
  private BigDecimal trend7days = null;

  @SerializedName("trend_30days")
  private BigDecimal trend30days = null;

  public VisibilityDesktopMobile latest(Double latest) {
    this.latest = latest;
    return this;
  }

   /**
   * The group of keyword&#x27;s share of the total searches (impressions) , out of the total potential it could get. It is measured in percentages, from 0% (outside Top 20 on all keywords) to 100% (ranking 1st on all keywords) taking into account the desktop positions.
   * @return latest
  **/
  @Schema(description = "The group of keyword's share of the total searches (impressions) , out of the total potential it could get. It is measured in percentages, from 0% (outside Top 20 on all keywords) to 100% (ranking 1st on all keywords) taking into account the desktop positions.")
  ...
  public VisibilityDesktopMobile trend7days(BigDecimal trend7days) {
    this.trend7days = trend7days;
    return this;
  }

   /**
   * The group of keyword&#x27;s share of the total searches (impressions) , out of the total potential it could get. It is measured in percentages, from 0% (outside Top 20 on all keywords) to 100% (ranking 1st on all keywords) taking into account the mobile positions.
   * @return trend7days
  **/
  @Schema(example = "0.2", description = "The group of keyword's share of the total searches (impressions) , out of the total potential it could get. It is measured in percentages, from 0% (outside Top 20 on all keywords) to 100% (ranking 1st on all keywords) taking into account the mobile positions.")
  public BigDecimal getTrend7days() {
    return trend7days;
  }

  public void setTrend7days(BigDecimal trend7days) {
    this.trend7days = trend7days;
  }

  public VisibilityDesktopMobile trend30days(BigDecimal trend30days) {
    this.trend30days = trend30days;
    return this;
  }

   /**
   * The change in desktop Visibility over the past 30 days, as a numeric value between 0-100.
   * @return trend30days
  **/
  @Schema(example = "1.2", description = "The change in desktop Visibility over the past 30 days, as a numeric value between 0-100.")
  public BigDecimal getTrend30days() {
    return trend30days;
  }

  public void setTrend30days(BigDecimal trend30days) {
    this.trend30days = trend30days;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VisibilityDesktopMobile visibilityDesktopMobile = (VisibilityDesktopMobile) o;
    return Objects.equals(this.latest, visibilityDesktopMobile.latest) &&
        Objects.equals(this.trend7days, visibilityDesktopMobile.trend7days) &&
        Objects.equals(this.trend30days, visibilityDesktopMobile.trend30days);
  }

  @Override
  public int hashCode() {
    return Objects.hash(latest, trend7days, trend30days);
  }
  ...
  public String toString() {
    ...
    sb.append("class VisibilityDesktopMobile {\n");
    
    sb.append("    latest: ").append(toIndentedString(latest)).append("\n");
    sb.append("    trend7days: ").append(toIndentedString(trend7days)).append("\n");
    sb.append("    trend30days: ").append(toIndentedString(trend30days)).append("\n");
    sb.append("}");
    return sb.toString();
  }
