...
import io.swagger.client.model.ForecastMonthlyForecastsTraffic;
...
public class ForecastMonthlyForecasts {
  @SerializedName("month")
  private String month = null;

  @SerializedName("seasonality")
  private Double seasonality = null;

  @SerializedName("traffic_data")
  private ForecastMonthlyForecastsTraffic trafficData = null;

  public ForecastMonthlyForecasts month(String month) {
    this.month = month;
    return this;
  }
   ...
   * @return month
  **/
  @Schema(description = "The month and year in the forecast timeframe for which data is returned.")
  ...
  public ForecastMonthlyForecasts seasonality(Double seasonality) {
   ...
   * @return seasonality
  **/
  @Schema(description = "The average search seasonality of the keywords included in the forecast scenario for the specific month of the timeframe. The value is returned as a percentage related to the 12-month seasonality average, where 1.00 represents the average value.")
  ...
  public ForecastMonthlyForecasts trafficData(ForecastMonthlyForecastsTraffic trafficData) {
  ...
  **/
  @Schema(description = "")
  public ForecastMonthlyForecastsTraffic getTrafficData() {
    return trafficData;
  }

  public void setTrafficData(ForecastMonthlyForecastsTraffic trafficData) {
    this.trafficData = trafficData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastMonthlyForecasts forecastMonthlyForecasts = (ForecastMonthlyForecasts) o;
    return Objects.equals(this.month, forecastMonthlyForecasts.month) &&
        Objects.equals(this.seasonality, forecastMonthlyForecasts.seasonality) &&
        Objects.equals(this.trafficData, forecastMonthlyForecasts.trafficData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(month, seasonality, trafficData);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastMonthlyForecasts {\n");
