...
public class KeywordVaultGetKeywordDataByList {
  ...
  public KeywordVaultGetKeywordDataByList keyword(String keyword) {
   ...
   * @return keyword
  **/
  @Schema(description = "The exact keyword phrase.")
  ...
  public KeywordVaultGetKeywordDataByList searchData(ResearchSearchData searchData) {
  ...
  **/
  ...
  public KeywordVaultGetKeywordDataByList rankingData(ResearchRankingData rankingData) {
  ...
  **/
  ...
  public KeywordVaultGetKeywordDataByList serpData(ResearchSerpData serpData) {
  ...
  **/
  ...
  public KeywordVaultGetKeywordDataByList trackedKeywordId(Integer trackedKeywordId) {
  ...
  **/
  @Schema(description = "The unique ID used to identify and reference the keyword in the system. Returned only if the keyword is tracked in the SEOmonitor campaign. It can be stored and used in other endpoints for filtering.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordVaultGetKeywordDataByList keywordVaultGetKeywordDataByList = (KeywordVaultGetKeywordDataByList) o;
    return Objects.equals(this.keyword, keywordVaultGetKeywordDataByList.keyword) &&
        Objects.equals(this.searchData, keywordVaultGetKeywordDataByList.searchData) &&
        Objects.equals(this.rankingData, keywordVaultGetKeywordDataByList.rankingData) &&
        Objects.equals(this.serpData, keywordVaultGetKeywordDataByList.serpData) &&
        Objects.equals(this.trackedKeywordId, keywordVaultGetKeywordDataByList.trackedKeywordId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyword, searchData, rankingData, serpData, trackedKeywordId);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordVaultGetKeywordDataByList {\n");
