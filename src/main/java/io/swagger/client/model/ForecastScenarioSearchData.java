...
import io.swagger.client.model.GroupsVolumeByDevice;
import io.swagger.client.model.MonthlySearches;
...
public class ForecastScenarioSearchData {
  ...
  @SerializedName("monthly_searches")
  private List<MonthlySearches> monthlySearches = null;

  @SerializedName("volume_by_device")
  private GroupsVolumeByDevice volumeByDevice = null;

  @SerializedName("percentage_clicks")
  private Double percentageClicks = null;

  public ForecastScenarioSearchData searchVolume(Integer searchVolume) {
    this.searchVolume = searchVolume;
    return this;
  }

   /**
   * The average 12-month search volume of the keywords included in the scenario, as provided by Google Ads.
   * @return searchVolume
  **/
  @Schema(description = "The average 12-month search volume of the keywords included in the scenario, as provided by Google Ads.")
  ...
  public ForecastScenarioSearchData yearOverYear(Double yearOverYear) {
    this.yearOverYear = yearOverYear;
    return this;
  }

   /**
   * A numeric value representing the last month&#x27;s search volume divided by the search volume of the same month of the previous year. E.g. +27% year-over-year search trend would be represented as 1.27.  The returned values will be capped at 10, which represents \&quot;newcomers\&quot; (keywords that registered very low search volumes in the previous year).
   * @return yearOverYear
  **/
  @Schema(description = "A numeric value representing the last month's search volume divided by the search volume of the same month of the previous year. E.g. +27% year-over-year search trend would be represented as 1.27.  The returned values will be capped at 10, which represents \"newcomers\" (keywords that registered very low search volumes in the previous year).")
  ...
  public ForecastScenarioSearchData monthlySearches(List<MonthlySearches> monthlySearches) {
    this.monthlySearches = monthlySearches;
    return this;
  }

  public ForecastScenarioSearchData addMonthlySearchesItem(MonthlySearches monthlySearchesItem) {
    if (this.monthlySearches == null) {
      this.monthlySearches = new ArrayList<MonthlySearches>();
    }
   ...
   /**
   * An array of objects containing the average search volumes for each of the previous 13 months for the keywords included in the scenario, as provided by Google Ads.
   * @return monthlySearches
  **/
  @Schema(example = "[ {         \"month\": \"January\",         \"year\": 2023,         \"search_volume\": 6700     }     ]", description = "An array of objects containing the average search volumes for each of the previous 13 months for the keywords included in the scenario, as provided by Google Ads.")
  ...
  public ForecastScenarioSearchData volumeByDevice(GroupsVolumeByDevice volumeByDevice) {
    this.volumeByDevice = volumeByDevice;
    return this;
  }

   /**
   * Get volumeByDevice
   * @return volumeByDevice
  **/
  @Schema(description = "")
  public GroupsVolumeByDevice getVolumeByDevice() {
    return volumeByDevice;
  }

  public void setVolumeByDevice(GroupsVolumeByDevice volumeByDevice) {
    this.volumeByDevice = volumeByDevice;
  }

  public ForecastScenarioSearchData percentageClicks(Double percentageClicks) {
    this.percentageClicks = percentageClicks;
    return this;
  }
   ...
   * @return percentageClicks
  **/
  @Schema(description = "The percentage of searches that end up clicking on organic results, after discounting the searches satisfied by SERP features. Blended metric between desktop and mobile searches.")
  public Double getPercentageClicks() {
    return percentageClicks;
  }

  public void setPercentageClicks(Double percentageClicks) {
    this.percentageClicks = percentageClicks;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastScenarioSearchData forecastScenarioSearchData = (ForecastScenarioSearchData) o;
    return Objects.equals(this.searchVolume, forecastScenarioSearchData.searchVolume) &&
        Objects.equals(this.yearOverYear, forecastScenarioSearchData.yearOverYear) &&
        Objects.equals(this.monthlySearches, forecastScenarioSearchData.monthlySearches) &&
        Objects.equals(this.volumeByDevice, forecastScenarioSearchData.volumeByDevice) &&
        Objects.equals(this.percentageClicks, forecastScenarioSearchData.percentageClicks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(searchVolume, yearOverYear, monthlySearches, volumeByDevice, percentageClicks);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastScenarioSearchData {\n");
    ...
    sb.append("    volumeByDevice: ").append(toIndentedString(volumeByDevice)).append("\n");
    sb.append("    percentageClicks: ").append(toIndentedString(percentageClicks)).append("\n");
    sb.append("}");
    return sb.toString();
  }
