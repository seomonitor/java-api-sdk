...
public class RankingKeywords {
  ...
  public RankingKeywords keywordId(Integer keywordId) {
   ...
   * @return keywordId
  **/
  @Schema(example = "123456", description = "The unique ID used to identify and reference the keyword in the SEOmonitor system. ")
  ...
  public RankingKeywords keyword(String keyword) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RankingKeywords rankingKeywords = (RankingKeywords) o;
    return Objects.equals(this.keywordId, rankingKeywords.keywordId) &&
        Objects.equals(this.keyword, rankingKeywords.keyword);
  }
  ...
  public String toString() {
    ...
    sb.append("class RankingKeywords {\n");
