...
import io.swagger.client.model.OpportunityTop3Values;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * An object containing details about the SEO Opportunity. The SEO Opportunity in SEOmonitor has been designed as the one keyword-level metric that brings together all the qualitative and quantitative attributes of a keyword and helps users sort their keywords based on the opportunity to start optimizing their website for them right now.
 */
...
public class Opportunity {
  ...
  @SerializedName("additional_montly_sessions")
  private OpportunityTop3Values additionalMontlySessions = null;
  ...
  public Opportunity score(Integer score) {
    this.score = score;
    return this;
  }
   ...
   * @return score
  **/
  @Schema(example = "1", description = "The Opportunity score from 0 to 10.  For the keywords where the Opportunity score is not computed, the value returned will be \"N/A\".")
  ...
  public Opportunity additionalMontlySessions(OpportunityTop3Values additionalMontlySessions) {
    this.additionalMontlySessions = additionalMontlySessions;
    return this;
  }

   /**
   * Get additionalMontlySessions
   * @return additionalMontlySessions
  **/
  @Schema(description = "")
  public OpportunityTop3Values getAdditionalMontlySessions() {
    return additionalMontlySessions;
  }

  public void setAdditionalMontlySessions(OpportunityTop3Values additionalMontlySessions) {
    this.additionalMontlySessions = additionalMontlySessions;
  }

  public Opportunity difficulty(String difficulty) {
   ...
   * @return difficulty
  **/
  @Schema(example = "medium", description = "The Difficulty level of the keyword to rank in Top10. Possible values are \"already_top_10\", \"easy\", \"medium\", \"hard\".")
  ...
  public Opportunity avgCpc(Double avgCpc) {
    this.avgCpc = avgCpc;
    return this;
  }
   ...
   * @return avgCpc
  **/
  @Schema(example = "0.06", description = "The keyword's average cost per click in the currency of the campaign.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.score, opportunity.score) &&
        Objects.equals(this.additionalMontlySessions, opportunity.additionalMontlySessions) &&
        Objects.equals(this.difficulty, opportunity.difficulty) &&
        Objects.equals(this.avgCpc, opportunity.avgCpc);
  }

  @Override
  public int hashCode() {
    return Objects.hash(score, additionalMontlySessions, difficulty, avgCpc);
  }
  ...
  public String toString() {
    ...
    sb.append("    additionalMontlySessions: ").append(toIndentedString(additionalMontlySessions)).append("\n");
