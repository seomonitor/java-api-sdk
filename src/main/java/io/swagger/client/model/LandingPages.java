...
public class LandingPages {
  ...
  public LandingPages current(String current) {
    this.current = current;
    return this;
  }

   /**
   * The landing page that is currently ranking for the keyword on Google searches performed from mobile devices.
   * @return current
  **/
  @Schema(description = "The landing page that is currently ranking for the keyword on Google searches performed from mobile devices.")
  ...
  public LandingPages desired(String desired) {
    this.desired = desired;
    return this;
  }

   /**
   * The landing page you target to rank with on Google searches performed from mobile devices.
   * @return desired
  **/
  @Schema(description = "The landing page you target to rank with on Google searches performed from mobile devices.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    LandingPages landingPages = (LandingPages) o;
    return Objects.equals(this.current, landingPages.current) &&
        Objects.equals(this.desired, landingPages.desired);
  }

  @Override
  public int hashCode() {
    return Objects.hash(current, desired);
  }
