...
public class GroupsVolumeByDevice {
  @SerializedName("desktop")
  private Double desktop = null;

  @SerializedName("mobile")
  private Double mobile = null;

  public GroupsVolumeByDevice desktop(Double desktop) {
    this.desktop = desktop;
    return this;
  }

   /**
   * The percentage from total searches that come from desktop devices.
   * @return desktop
  **/
  @Schema(example = "0.25", description = "The percentage from total searches that come from desktop devices.")
  ...
  public GroupsVolumeByDevice mobile(Double mobile) {
    this.mobile = mobile;
    return this;
  }

   /**
   * The percentage from total searches that come from mobile devices.
   * @return mobile
  **/
  @Schema(example = "0.75", description = "The percentage from total searches that come from mobile devices.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsVolumeByDevice groupsVolumeByDevice = (GroupsVolumeByDevice) o;
    return Objects.equals(this.desktop, groupsVolumeByDevice.desktop) &&
        Objects.equals(this.mobile, groupsVolumeByDevice.mobile);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsVolumeByDevice {\n");
