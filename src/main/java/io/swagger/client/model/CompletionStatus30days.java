...
public class CompletionStatus30days {
  ...
  public CompletionStatus30days actualSessions(Integer actualSessions) {
    this.actualSessions = actualSessions;
    return this;
  }

   /**
   * The number of sessions recorded within the last 30 days.
   * @return actualSessions
  **/
  @Schema(example = "89500", description = "The number of sessions recorded within the last 30 days.")
  ...
  public CompletionStatus30days forecastedSessions(Integer forecastedSessions) {
    this.forecastedSessions = forecastedSessions;
    return this;
  }

   /**
   * The number of sessions estimated to be obtained within the last 30 days.
   * @return forecastedSessions
  **/
  @Schema(example = "89500", description = "The number of sessions estimated to be obtained within the last 30 days.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CompletionStatus30days completionStatus30days = (CompletionStatus30days) o;
    return Objects.equals(this.actualSessions, completionStatus30days.actualSessions) &&
        Objects.equals(this.forecastedSessions, completionStatus30days.forecastedSessions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompletionStatus30days {\n");
