...
import io.swagger.client.model.ResearchDomainRanking;
...
public class KeywordResearchRankingData {
  ...
  private ResearchDomainRanking rankingData = null;

  public KeywordResearchRankingData keyword(String keyword) {
  ...
  **/
  ...
  public KeywordResearchRankingData updatedOn(String updatedOn) {
   ...
   * @return updatedOn
  **/
  @Schema(example = "\"2023-09-06\"", description = "The date when the latest crawl was performed, in YYYY-MM-DD format.")
  ...
  public KeywordResearchRankingData rankingData(ResearchDomainRanking rankingData) {
  ...
  **/
  @Schema(description = "")
  public ResearchDomainRanking getRankingData() {
    return rankingData;
  }

  public void setRankingData(ResearchDomainRanking rankingData) {
    this.rankingData = rankingData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordResearchRankingData keywordResearchRankingData = (KeywordResearchRankingData) o;
    return Objects.equals(this.keyword, keywordResearchRankingData.keyword) &&
        Objects.equals(this.updatedOn, keywordResearchRankingData.updatedOn) &&
        Objects.equals(this.rankingData, keywordResearchRankingData.rankingData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyword, updatedOn, rankingData);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordResearchRankingData {\n");
