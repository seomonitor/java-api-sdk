...
import io.swagger.client.model.ShareOfClicksDomains;
...
public class DailyShareOfClicks {
  @SerializedName("date")
  private LocalDate date = null;

  @SerializedName("domains")
  private ShareOfClicksDomains domains = null;

  public DailyShareOfClicks date(LocalDate date) {
    this.date = date;
    return this;
  }

   /**
   * The date within the requested timeframe for which the Share of Clicks metrics are returned.
   * @return date
  **/
  @Schema(description = "The date within the requested timeframe for which the Share of Clicks metrics are returned.")
  ...
  public DailyShareOfClicks domains(ShareOfClicksDomains domains) {
  ...
  **/
  @Schema(description = "")
  public ShareOfClicksDomains getDomains() {
    return domains;
  }

  public void setDomains(ShareOfClicksDomains domains) {
    this.domains = domains;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DailyShareOfClicks dailyShareOfClicks = (DailyShareOfClicks) o;
    return Objects.equals(this.date, dailyShareOfClicks.date) &&
        Objects.equals(this.domains, dailyShareOfClicks.domains);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, domains);
  }
  ...
  public String toString() {
    ...
    sb.append("class DailyShareOfClicks {\n");
