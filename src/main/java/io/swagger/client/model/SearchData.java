...
/**
 * An object containing the data related to google search volumes.
 */
@Schema(description = "An object containing the data related to google search volumes.")
...
public class SearchData {
  ...
  private Integer yearOverYear = null;
  ...
  public SearchData yearOverYear(Integer yearOverYear) {
   ...
   * @return yearOverYear
  **/
  @Schema(description = "A numeric value representing the last month's search volume divided by the search volume of the same month of the previous year. E.g. +49% year-over-year search trend would be represented as 1.49.  The returned values will be capped at 10, which represents \"newcomers\" (keywords that registered very low search volumes in the previous year).")
  public Integer getYearOverYear() {
    return yearOverYear;
  }

  public void setYearOverYear(Integer yearOverYear) {
    this.yearOverYear = yearOverYear;
  }

  public SearchData searchVolume(Integer searchVolume) {
   ...
   * @return searchVolume
  **/
  @Schema(example = "90500", description = "The latest average 12-month search volume as provided by Google Ads.")
  ...
  public SearchData monthlySearches(List<MonthlySearches> monthlySearches) {
    this.monthlySearches = monthlySearches;
    return this;
  }

  public SearchData addMonthlySearchesItem(MonthlySearches monthlySearchesItem) {
  ...
  **/
  @Schema(example = "{\"month\": \"January\",\"year\": \"2022\",\"search_volume\": 82000}", description = "An array of objects containing the search volumes for each of the previous 13 months as provided by Google Ads.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.yearOverYear, searchData.yearOverYear) &&
        Objects.equals(this.searchVolume, searchData.searchVolume) &&
        Objects.equals(this.monthlySearches, searchData.monthlySearches);
  }

  @Override
  public int hashCode() {
    return Objects.hash(yearOverYear, searchVolume, monthlySearches);
  }
