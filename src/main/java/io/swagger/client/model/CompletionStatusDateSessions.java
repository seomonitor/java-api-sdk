...
public class CompletionStatusDateSessions {
  @SerializedName("actual_sessions")
  private Integer actualSessions = null;

  @SerializedName("forecasted_sessions")
  private Integer forecastedSessions = null;

  public CompletionStatusDateSessions actualSessions(Integer actualSessions) {
    this.actualSessions = actualSessions;
    return this;
  }

   /**
   * The number of sessions recorded from the start of the forecast to the current date.
   * @return actualSessions
  **/
  @Schema(example = "610000", description = "The number of sessions recorded from the start of the forecast to the current date.")
  public Integer getActualSessions() {
    return actualSessions;
  }

  public void setActualSessions(Integer actualSessions) {
    this.actualSessions = actualSessions;
  }

  public CompletionStatusDateSessions forecastedSessions(Integer forecastedSessions) {
    this.forecastedSessions = forecastedSessions;
    return this;
  }

   /**
   * The number of sessions estimated to be obtained from the start of the forecast to the current date.
   * @return forecastedSessions
  **/
  @Schema(example = "600000", description = "The number of sessions estimated to be obtained from the start of the forecast to the current date.")
  public Integer getForecastedSessions() {
    return forecastedSessions;
  }

  public void setForecastedSessions(Integer forecastedSessions) {
    this.forecastedSessions = forecastedSessions;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CompletionStatusDateSessions completionStatusDateSessions = (CompletionStatusDateSessions) o;
    return Objects.equals(this.actualSessions, completionStatusDateSessions.actualSessions) &&
        Objects.equals(this.forecastedSessions, completionStatusDateSessions.forecastedSessions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(actualSessions, forecastedSessions);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompletionStatusDateSessions {\n");
    
    sb.append("    actualSessions: ").append(toIndentedString(actualSessions)).append("\n");
    sb.append("    forecastedSessions: ").append(toIndentedString(forecastedSessions)).append("\n");
    sb.append("}");
    return sb.toString();
  }
