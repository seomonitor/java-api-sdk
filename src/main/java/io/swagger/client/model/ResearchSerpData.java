...
import io.swagger.client.model.ResearchSerpFeature;
...
public class ResearchSerpData {
  @SerializedName("percentage_clicks")
  private BigDecimal percentageClicks = null;

  @SerializedName("serp_features")
  private ResearchSerpFeature serpFeatures = null;

  public ResearchSerpData percentageClicks(BigDecimal percentageClicks) {
  ...
  **/
  @Schema(example = "0.77", description = "The percentage of searches that end up clicking on organic results, based on the sum of Top 10 positions' CTRs after discounting the searches satisfied by SERP features.")
  ...
  public ResearchSerpData serpFeatures(ResearchSerpFeature serpFeatures) {
  ...
  **/
  @Schema(description = "")
  public ResearchSerpFeature getSerpFeatures() {
    return serpFeatures;
  }

  public void setSerpFeatures(ResearchSerpFeature serpFeatures) {
    this.serpFeatures = serpFeatures;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResearchSerpData researchSerpData = (ResearchSerpData) o;
    return Objects.equals(this.percentageClicks, researchSerpData.percentageClicks) &&
        Objects.equals(this.serpFeatures, researchSerpData.serpFeatures);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResearchSerpData {\n");
