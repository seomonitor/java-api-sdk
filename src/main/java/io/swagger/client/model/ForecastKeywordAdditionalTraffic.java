...
public class ForecastKeywordAdditionalTraffic {
  ...
  public ForecastKeywordAdditionalTraffic sessions(Integer sessions) {
   ...
   * @return sessions
  **/
  @Schema(example = "4600", description = "The total estimated Additional Sessions for the keyword throughout the forecast timeframe, including the sessions from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective.  If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.")
  ...
  public ForecastKeywordAdditionalTraffic sessionsBestTarget(Integer sessionsBestTarget) {
  ...
  **/
  @Schema(example = "6700", description = "If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.")
  ...
  public ForecastKeywordAdditionalTraffic conversions(Integer conversions) {
   ...
   * @return conversions
  **/
  @Schema(example = "126", description = "The total estimated Additional Conversions for the keyword throughout the forecast timeframe, including the conversions from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.")
  ...
  public ForecastKeywordAdditionalTraffic conversionsBestTarget(Integer conversionsBestTarget) {
  ...
  **/
  @Schema(example = "560", description = "If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.")
  ...
  public ForecastKeywordAdditionalTraffic revenue(Integer revenue) {
   ...
   * @return revenue
  **/
  @Schema(example = "3400", description = "The estimated Additional Revenue that would be achieved throughout the forecast timeframe, including the revenue from long tail keywords if the Long Tail Effect is enabled for the Scenario or Objective.  If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.")
  ...
  public ForecastKeywordAdditionalTraffic revenueBestTarget(Integer revenueBestTarget) {
  ...
  **/
  @Schema(example = "5600", description = "If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastKeywordAdditionalTraffic forecastKeywordAdditionalTraffic = (ForecastKeywordAdditionalTraffic) o;
    return Objects.equals(this.sessions, forecastKeywordAdditionalTraffic.sessions) &&
        Objects.equals(this.sessionsBestTarget, forecastKeywordAdditionalTraffic.sessionsBestTarget) &&
        Objects.equals(this.conversions, forecastKeywordAdditionalTraffic.conversions) &&
        Objects.equals(this.conversionsBestTarget, forecastKeywordAdditionalTraffic.conversionsBestTarget) &&
        Objects.equals(this.revenue, forecastKeywordAdditionalTraffic.revenue) &&
        Objects.equals(this.revenueBestTarget, forecastKeywordAdditionalTraffic.revenueBestTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastKeywordAdditionalTraffic {\n");
