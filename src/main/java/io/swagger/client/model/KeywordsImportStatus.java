...
public class KeywordsImportStatus {
  @SerializedName("date_start")
  private OffsetDateTime dateStart = null;

  @SerializedName("date_done")
  private OffsetDateTime dateDone = null;
  ...
  public KeywordsImportStatus dateStart(OffsetDateTime dateStart) {
   ...
   * @return dateStart
  **/
  @Schema(description = "The timestamp when the import task was started.")
  ...
  public KeywordsImportStatus dateDone(OffsetDateTime dateDone) {
   ...
   * @return dateDone
  **/
  @Schema(description = "The timestamp when the import task was completed. It returns 'N/A' if the task is still in progress.")
  ...
  public KeywordsImportStatus imported(Integer imported) {
   ...
   * @return imported
  **/
  @Schema(example = "1170", description = "The number of keywords that have been successfully imported so far.")
  ...
  public KeywordsImportStatus processing(Integer processing) {
   ...
   * @return processing
  **/
  @Schema(example = "265", description = "The number of keywords still being processed and imported.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordsImportStatus keywordsImportStatus = (KeywordsImportStatus) o;
    return Objects.equals(this.dateStart, keywordsImportStatus.dateStart) &&
        Objects.equals(this.dateDone, keywordsImportStatus.dateDone) &&
        Objects.equals(this.imported, keywordsImportStatus.imported) &&
        Objects.equals(this.processing, keywordsImportStatus.processing);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dateStart, dateDone, imported, processing);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordsImportStatus {\n");
