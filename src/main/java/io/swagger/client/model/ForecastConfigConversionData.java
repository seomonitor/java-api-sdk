...
public class ForecastConfigConversionData {
  @SerializedName("conversion_rate")
  private Double conversionRate = null;

  @SerializedName("avg_order_value")
  private Double avgOrderValue = null;

  public ForecastConfigConversionData conversionRate(Double conversionRate) {
    this.conversionRate = conversionRate;
    return this;
  }

   /**
   * The average Conversion Rate of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Conversions as the multiplier of Additional Sessions.
   * @return conversionRate
  **/
  @Schema(description = "The average Conversion Rate of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Conversions as the multiplier of Additional Sessions.")
  ...
  public ForecastConfigConversionData avgOrderValue(Double avgOrderValue) {
    this.avgOrderValue = avgOrderValue;
    return this;
  }

   /**
   * The Average Order Value of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Revenue as the multiplier of Additional Conversions.
   * @return avgOrderValue
  **/
  @Schema(description = "The Average Order Value of the keywords included in the forecast scenario, used in the calculation of the estimated Additional Revenue as the multiplier of Additional Conversions.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastConfigConversionData forecastConfigConversionData = (ForecastConfigConversionData) o;
    return Objects.equals(this.conversionRate, forecastConfigConversionData.conversionRate) &&
        Objects.equals(this.avgOrderValue, forecastConfigConversionData.avgOrderValue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(conversionRate, avgOrderValue);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastConfigConversionData {\n");
    
    sb.append("    conversionRate: ").append(toIndentedString(conversionRate)).append("\n");
    sb.append("    avgOrderValue: ").append(toIndentedString(avgOrderValue)).append("\n");
    sb.append("}");
    return sb.toString();
  }
