...
public class ForecastTrafficRevenue {
  ...
  public ForecastTrafficRevenue inertial(Integer inertial) {
    this.inertial = inertial;
    return this;
  }

   /**
   * The number of inertial revenue.
   * @return inertial
  **/
  @Schema(description = "The number of inertial revenue.")
  ...
  public ForecastTrafficRevenue additional(Integer additional) {
    this.additional = additional;
    return this;
  }

   /**
   * The value of additional revenue, in the campaign currency.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this is the value calculated for the lower (worst) target rank.
   * @return additional
  **/
  @Schema(description = "The value of additional revenue, in the campaign currency.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.")
  ...
  public ForecastTrafficRevenue additionalBestTarget(Integer additionalBestTarget) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastTrafficRevenue forecastTrafficRevenue = (ForecastTrafficRevenue) o;
    return Objects.equals(this.inertial, forecastTrafficRevenue.inertial) &&
        Objects.equals(this.additional, forecastTrafficRevenue.additional) &&
        Objects.equals(this.additionalBestTarget, forecastTrafficRevenue.additionalBestTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastTrafficRevenue {\n");
