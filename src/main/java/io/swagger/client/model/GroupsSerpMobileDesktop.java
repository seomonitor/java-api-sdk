...
public class GroupsSerpMobileDesktop {
  @SerializedName("feature")
  private String feature = null;

  @SerializedName("presence_count")
  private Integer presenceCount = null;

  @SerializedName("listed_count")
  private Integer listedCount = null;

  public GroupsSerpMobileDesktop feature(String feature) {
    this.feature = feature;
    return this;
  }

   /**
   * The abbreviated name of the SERP feature.
   * @return feature
  **/
  @Schema(example = "DEF", description = "The abbreviated name of the SERP feature.")
  ...
  public GroupsSerpMobileDesktop presenceCount(Integer presenceCount) {
    this.presenceCount = presenceCount;
    return this;
  }

   /**
   * The number of keywords for which the specific SERP feature is present in the results on the last day of the selected timeframe.
   * @return presenceCount
  **/
  @Schema(example = "12", description = "The number of keywords for which the specific SERP feature is present in the results on the last day of the selected timeframe.")
  ...
  public GroupsSerpMobileDesktop listedCount(Integer listedCount) {
    this.listedCount = listedCount;
    return this;
  }

   /**
   * Out of the &#x60;presence_count&#x60;, the number of SERP features in which the website is listed on the last day of the selected timeframe.
   * @return listedCount
  **/
  @Schema(example = "2", description = "Out of the `presence_count`, the number of SERP features in which the website is listed on the last day of the selected timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsSerpMobileDesktop groupsSerpMobileDesktop = (GroupsSerpMobileDesktop) o;
    return Objects.equals(this.feature, groupsSerpMobileDesktop.feature) &&
        Objects.equals(this.presenceCount, groupsSerpMobileDesktop.presenceCount) &&
        Objects.equals(this.listedCount, groupsSerpMobileDesktop.listedCount);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feature, presenceCount, listedCount);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsSerpMobileDesktop {\n");
    
    sb.append("    feature: ").append(toIndentedString(feature)).append("\n");
    sb.append("    presenceCount: ").append(toIndentedString(presenceCount)).append("\n");
