...
import io.swagger.client.model.SerpFeaturePresenceSerpData;
...
public class SerpFeaturePresence {
  ...
  private List<SerpFeaturePresenceSerpData> serpData = null;

  public SerpFeaturePresence keywordId(Integer keywordId) {
   ...
   * @return keywordId
  **/
  @Schema(description = "The unique ID used to identify and reference the keyword in the system. It can be stored and used in other endpoints for filtering.")
  ...
  public SerpFeaturePresence keyword(String keyword) {
  ...
  **/
  ...
  public SerpFeaturePresence serpData(List<SerpFeaturePresenceSerpData> serpData) {
    this.serpData = serpData;
    return this;
  }

  public SerpFeaturePresence addSerpDataItem(SerpFeaturePresenceSerpData serpDataItem) {
    if (this.serpData == null) {
      this.serpData = new ArrayList<SerpFeaturePresenceSerpData>();
    }
    this.serpData.add(serpDataItem);
    return this;
  }
   ...
   * @return serpData
  **/
  @Schema(description = "Parent field containing the data for SERP features present on the keyword for each day of the selected timeframe, for each device.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation.")
  public List<SerpFeaturePresenceSerpData> getSerpData() {
    return serpData;
  }

  public void setSerpData(List<SerpFeaturePresenceSerpData> serpData) {
    this.serpData = serpData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SerpFeaturePresence serpFeaturePresence = (SerpFeaturePresence) o;
    return Objects.equals(this.keywordId, serpFeaturePresence.keywordId) &&
        Objects.equals(this.keyword, serpFeaturePresence.keyword) &&
        Objects.equals(this.serpData, serpFeaturePresence.serpData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keywordId, keyword, serpData);
  }
  ...
  public String toString() {
    ...
    sb.append("class SerpFeaturePresence {\n");
