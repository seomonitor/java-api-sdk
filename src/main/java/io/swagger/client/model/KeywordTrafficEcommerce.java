...
/**
 * An object containing the information about the transactions aggregated as sums for the specific timeframe.
 */
@Schema(description = "An object containing the information about the transactions aggregated as sums for the specific timeframe.")
...
public class KeywordTrafficEcommerce {
  ...
  public KeywordTrafficEcommerce transactions(Integer transactions) {
    this.transactions = transactions;
    return this;
  }

   /**
   * Sum of transactions uncovered from not-provided whitin the selected timeframe. Data is available only if an Analytics  profile is connected.
   * @return transactions
  **/
  @Schema(example = "1512", description = "Sum of transactions uncovered from not-provided whitin the selected timeframe. Data is available only if an Analytics  profile is connected.")
  ...
  public KeywordTrafficEcommerce revenue(Integer revenue) {
    this.revenue = revenue;
    return this;
  }

   /**
   * Total ecommerce revenue uncovered through the (not provided) solution within the selected timeframe.
   * @return revenue
  **/
  @Schema(example = "97000", description = "Total ecommerce revenue uncovered through the (not provided) solution within the selected timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordTrafficEcommerce keywordTrafficEcommerce = (KeywordTrafficEcommerce) o;
    return Objects.equals(this.transactions, keywordTrafficEcommerce.transactions) &&
        Objects.equals(this.revenue, keywordTrafficEcommerce.revenue);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactions, revenue);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordTrafficEcommerce {\n");
