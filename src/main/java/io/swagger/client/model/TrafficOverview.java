...
import io.swagger.client.model.TrafficEcommerce;
import io.swagger.client.model.TrafficGoals;
...
public class TrafficOverview {
  ...
  private TrafficEcommerce ecommerce = null;

  @SerializedName("goals")
  private TrafficGoals goals = null;

  @SerializedName("bounce_rate")
  private BigDecimal bounceRate = null;

  public TrafficOverview date(LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   * @return date
  **/
  @Schema(example = "Sat Jan 07 02:00:00 SAST 2023", description = "The date for which the traffic data is being returned, in YYYY-MM-DD format.")
  ...
  public TrafficOverview sessions(Integer sessions) {
   ...
   * @return sessions
  **/
  @Schema(example = "508000", description = "The sum of sessions for the specified traffic segment, if the campaign is connected to both Google Search Console and Google Analytics – or clicks, if the campaign is only connected to Google Search Console, on the date within the selected timeframe.")
  ...
  public TrafficOverview ecommerce(TrafficEcommerce ecommerce) {
  ...
  **/
  @Schema(description = "")
  public TrafficEcommerce getEcommerce() {
    return ecommerce;
  }

  public void setEcommerce(TrafficEcommerce ecommerce) {
    this.ecommerce = ecommerce;
  }

  public TrafficOverview goals(TrafficGoals goals) {
    this.goals = goals;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public TrafficGoals getGoals() {
    return goals;
  }

  public void setGoals(TrafficGoals goals) {
    this.goals = goals;
  }

  public TrafficOverview bounceRate(BigDecimal bounceRate) {
   ...
   * @return bounceRate
  **/
  @Schema(example = "0.3", description = "The percentage of single-page sessions for the website segment on the specified date.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TrafficOverview trafficOverview = (TrafficOverview) o;
    return Objects.equals(this.date, trafficOverview.date) &&
        Objects.equals(this.sessions, trafficOverview.sessions) &&
        Objects.equals(this.ecommerce, trafficOverview.ecommerce) &&
        Objects.equals(this.goals, trafficOverview.goals) &&
        Objects.equals(this.bounceRate, trafficOverview.bounceRate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, sessions, ecommerce, goals, bounceRate);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrafficOverview {\n");
