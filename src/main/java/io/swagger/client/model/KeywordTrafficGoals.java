...
/**
 * An object containing the information about goals aggregated as sums for the specific timeframe.
 */
@Schema(description = "An object containing the information about goals aggregated as sums for the specific timeframe.")
...
public class KeywordTrafficGoals {
  ...
  public KeywordTrafficGoals revenue(Integer revenue) {
    this.revenue = revenue;
    return this;
  }

   /**
   * Total goal revenue uncovered through the (not provided) solution for the selected goals within the selected timeframe.
   * @return revenue
  **/
  @Schema(example = "83000", description = "Total goal revenue uncovered through the (not provided) solution for the selected goals within the selected timeframe.")
  ...
  public KeywordTrafficGoals completions(Integer completions) {
    this.completions = completions;
    return this;
  }

   /**
   * Total goal completions within the selected timeframe.
   * @return completions
  **/
  @Schema(example = "852", description = "Total goal completions within the selected timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordTrafficGoals keywordTrafficGoals = (KeywordTrafficGoals) o;
    return Objects.equals(this.revenue, keywordTrafficGoals.revenue) &&
        Objects.equals(this.completions, keywordTrafficGoals.completions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(revenue, completions);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordTrafficGoals {\n");
