...
import io.swagger.client.model.KeywordCanibalizationLandingPageChange;
import io.swagger.client.model.KeywordCanibalizationRankData;
...
public class KeywordCanibalizationOnDate {
  @SerializedName("date")
  private LocalDate date = null;

  @SerializedName("rank_data")
  private KeywordCanibalizationRankData rankData = null;

  @SerializedName("landing_page_change")
  private KeywordCanibalizationLandingPageChange landingPageChange = null;

  public KeywordCanibalizationOnDate date(LocalDate date) {
    this.date = date;
    return this;
  }
  ...
  **/
  ...
  public KeywordCanibalizationOnDate rankData(KeywordCanibalizationRankData rankData) {
  ...
  **/
  @Schema(description = "")
  public KeywordCanibalizationRankData getRankData() {
    return rankData;
  }

  public void setRankData(KeywordCanibalizationRankData rankData) {
    this.rankData = rankData;
  }

  public KeywordCanibalizationOnDate landingPageChange(KeywordCanibalizationLandingPageChange landingPageChange) {
    this.landingPageChange = landingPageChange;
    return this;
  }

   /**
   * Get landingPageChange
   * @return landingPageChange
  **/
  @Schema(description = "")
  public KeywordCanibalizationLandingPageChange getLandingPageChange() {
    return landingPageChange;
  }

  public void setLandingPageChange(KeywordCanibalizationLandingPageChange landingPageChange) {
    this.landingPageChange = landingPageChange;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordCanibalizationOnDate keywordCanibalizationOnDate = (KeywordCanibalizationOnDate) o;
    return Objects.equals(this.date, keywordCanibalizationOnDate.date) &&
        Objects.equals(this.rankData, keywordCanibalizationOnDate.rankData) &&
        Objects.equals(this.landingPageChange, keywordCanibalizationOnDate.landingPageChange);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, rankData, landingPageChange);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordCanibalizationOnDate {\n");
    
    sb.append("    date: ").append(toIndentedString(date)).append("\n");
    sb.append("    rankData: ").append(toIndentedString(rankData)).append("\n");
    sb.append("    landingPageChange: ").append(toIndentedString(landingPageChange)).append("\n");
    sb.append("}");
    return sb.toString();
  }
