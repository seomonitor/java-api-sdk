...
public class AddCampaignPostBody {
  ...
  public AddCampaignPostBody campaignUrl(String campaignUrl) {
    this.campaignUrl = campaignUrl;
    return this;
  }

   /**
   * The domain of the campaign you want to add.
   * @return campaignUrl
  **/
  @Schema(description = "The domain of the campaign you want to add.")
  ...
  public AddCampaignPostBody locationCode(String locationCode) {
    this.locationCode = locationCode;
    return this;
  }

   /**
   * The location code for the campaign you want to add. This can be obtained by calling the Get Locations endpoint (/campaign-management/v3.0/locations).
   * @return locationCode
  **/
  @Schema(description = "The location code for the campaign you want to add. This can be obtained by calling the Get Locations endpoint (/campaign-management/v3.0/locations).")
  ...
  public AddCampaignPostBody companyId(Integer companyId) {
    this.companyId = companyId;
    return this;
  }

   /**
   * The id of the company where the campaign will be added. Required only if user has access to multiple companies.
   * @return companyId
  **/
  @Schema(description = "The id of the company where the campaign will be added. Required only if user has access to multiple companies.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AddCampaignPostBody addCampaignPostBody = (AddCampaignPostBody) o;
    return Objects.equals(this.campaignUrl, addCampaignPostBody.campaignUrl) &&
        Objects.equals(this.locationCode, addCampaignPostBody.locationCode) &&
        Objects.equals(this.companyId, addCampaignPostBody.companyId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(campaignUrl, locationCode, companyId);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddCampaignPostBody {\n");
