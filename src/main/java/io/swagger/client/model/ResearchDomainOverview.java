...
import io.swagger.client.model.DomainOverviewTraffic;
import io.swagger.client.model.DomainOverviewVisibility;
import io.swagger.client.model.ResearchSearchData;
import io.swagger.client.model.TopicOverviewSerpData;
...
public class ResearchDomainOverview {
  @SerializedName("related_keywords")
  private Integer relatedKeywords = null;

  @SerializedName("search_data")
  private ResearchSearchData searchData = null;

  @SerializedName("serp_data")
  private TopicOverviewSerpData serpData = null;

  @SerializedName("est_traffic")
  private DomainOverviewTraffic estTraffic = null;

  @SerializedName("visibility_data")
  private DomainOverviewVisibility visibilityData = null;

  public ResearchDomainOverview relatedKeywords(Integer relatedKeywords) {
  ...
  **/
  @Schema(example = "187", description = "The total number of curated keywords that the domain or url is ranking for.")
  public Integer getRelatedKeywords() {
    return relatedKeywords;
  }

  public void setRelatedKeywords(Integer relatedKeywords) {
    this.relatedKeywords = relatedKeywords;
  }

  public ResearchDomainOverview searchData(ResearchSearchData searchData) {
  ...
  **/
  ...
  public ResearchDomainOverview serpData(TopicOverviewSerpData serpData) {
  ...
  **/
  @Schema(description = "")
  public TopicOverviewSerpData getSerpData() {
    return serpData;
  }

  public void setSerpData(TopicOverviewSerpData serpData) {
    this.serpData = serpData;
  }

  public ResearchDomainOverview estTraffic(DomainOverviewTraffic estTraffic) {
  ...
  **/
  @Schema(description = "")
  public DomainOverviewTraffic getEstTraffic() {
    return estTraffic;
  }

  public void setEstTraffic(DomainOverviewTraffic estTraffic) {
    this.estTraffic = estTraffic;
  }

  public ResearchDomainOverview visibilityData(DomainOverviewVisibility visibilityData) {
  ...
  **/
  @Schema(description = "")
  public DomainOverviewVisibility getVisibilityData() {
    return visibilityData;
  }

  public void setVisibilityData(DomainOverviewVisibility visibilityData) {
    this.visibilityData = visibilityData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResearchDomainOverview researchDomainOverview = (ResearchDomainOverview) o;
    return Objects.equals(this.relatedKeywords, researchDomainOverview.relatedKeywords) &&
        Objects.equals(this.searchData, researchDomainOverview.searchData) &&
        Objects.equals(this.serpData, researchDomainOverview.serpData) &&
        Objects.equals(this.estTraffic, researchDomainOverview.estTraffic) &&
        Objects.equals(this.visibilityData, researchDomainOverview.visibilityData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(relatedKeywords, searchData, serpData, estTraffic, visibilityData);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResearchDomainOverview {\n");
    ...
    sb.append("    estTraffic: ").append(toIndentedString(estTraffic)).append("\n");
    sb.append("    visibilityData: ").append(toIndentedString(visibilityData)).append("\n");
    sb.append("}");
    return sb.toString();
  }
