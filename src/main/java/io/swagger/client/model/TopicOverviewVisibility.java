...
public class TopicOverviewVisibility {
  ...
  public TopicOverviewVisibility visibility(Double visibility) {
   ...
   * @return visibility
  **/
  @Schema(example = "0.19", description = "The desktop Visibility of your website on the day of the latest crawl which is refreshed within the past 30 days.")
  ...
  public TopicOverviewVisibility trend(Double trend) {
    this.trend = trend;
    return this;
  }
   ...
   * @return trend
  **/
  @Schema(example = "-0.2", description = "The percentage increase or decrease in your desktop Visibility over the past two crawl dates.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopicOverviewVisibility topicOverviewVisibility = (TopicOverviewVisibility) o;
    return Objects.equals(this.visibility, topicOverviewVisibility.visibility) &&
        Objects.equals(this.trend, topicOverviewVisibility.trend);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopicOverviewVisibility {\n");
