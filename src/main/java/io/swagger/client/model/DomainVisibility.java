...
public class DomainVisibility {
  ...
  public DomainVisibility domain(String domain) {
    this.domain = domain;
    return this;
  }

   /**
   * Campaign name or competitor domain
   * @return domain
  **/
  @Schema(description = "Campaign name or competitor domain")
  ...
  public DomainVisibility visibility(Double visibility) {
    this.visibility = visibility;
    return this;
  }

   /**
   * Visibility - A numeric value between 0 and 100
   * @return visibility
  **/
  @Schema(description = "Visibility - A numeric value between 0 and 100")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DomainVisibility domainVisibility = (DomainVisibility) o;
    return Objects.equals(this.domain, domainVisibility.domain) &&
        Objects.equals(this.visibility, domainVisibility.visibility);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, visibility);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainVisibility {\n");
