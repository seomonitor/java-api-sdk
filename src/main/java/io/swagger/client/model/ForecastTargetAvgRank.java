...
public class ForecastTargetAvgRank {
  @SerializedName("initial_rank")
  private Integer initialRank = null;

  @SerializedName("trend_3months")
  private Integer trend3months = null;

  @SerializedName("target_rank")
  private Integer targetRank = null;

  @SerializedName("best_target_rank")
  private Integer bestTargetRank = null;

  public ForecastTargetAvgRank initialRank(Integer initialRank) {
    this.initialRank = initialRank;
    return this;
  }

   /**
   * The average initial rank of the keywords included in the scenario, calculated for the month when the scenario was created.
   * @return initialRank
  **/
  @Schema(description = "The average initial rank of the keywords included in the scenario, calculated for the month when the scenario was created.")
  ...
  public ForecastTargetAvgRank trend3months(Integer trend3months) {
    this.trend3months = trend3months;
    return this;
  }

   /**
   * The average increase or drop in positions of the keywords in the scenario, over the previous 3 months up to the month the scenario was created, weighted by the keywords&#x27; search volume.
   * @return trend3months
  **/
  @Schema(description = "The average increase or drop in positions of the keywords in the scenario, over the previous 3 months up to the month the scenario was created, weighted by the keywords' search volume.")
  public Integer getTrend3months() {
    return trend3months;
  }

  public void setTrend3months(Integer trend3months) {
    this.trend3months = trend3months;
  }

  public ForecastTargetAvgRank targetRank(Integer targetRank) {
    this.targetRank = targetRank;
    return this;
  }

   /**
   * The average target rank of the keywords in the Objective. If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, the &#x60;target_rank&#x60; is the lower (worst) average target rank.
   * @return targetRank
  **/
  @Schema(description = "The average target rank of the keywords in the Objective. If the `target_rank_range` parameter returns \"true\", the `target_rank` is the lower (worst) average target rank.")
  ...
  public ForecastTargetAvgRank bestTargetRank(Integer bestTargetRank) {
    this.bestTargetRank = bestTargetRank;
    return this;
  }

   /**
   * If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this parameter is the higher (best) average target rank. If the &#x60;target_rank_range&#x60; parameter returns \&quot;false\&quot;, this parameter will return empty.
   * @return bestTargetRank
  **/
  @Schema(description = "If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) average target rank. If the `target_rank_range` parameter returns \"false\", this parameter will return empty.")
  public Integer getBestTargetRank() {
    return bestTargetRank;
  }

  public void setBestTargetRank(Integer bestTargetRank) {
    this.bestTargetRank = bestTargetRank;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastTargetAvgRank forecastTargetAvgRank = (ForecastTargetAvgRank) o;
    return Objects.equals(this.initialRank, forecastTargetAvgRank.initialRank) &&
        Objects.equals(this.trend3months, forecastTargetAvgRank.trend3months) &&
        Objects.equals(this.targetRank, forecastTargetAvgRank.targetRank) &&
        Objects.equals(this.bestTargetRank, forecastTargetAvgRank.bestTargetRank);
  }

  @Override
  public int hashCode() {
    return Objects.hash(initialRank, trend3months, targetRank, bestTargetRank);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastTargetAvgRank {\n");
    ...
    sb.append("    bestTargetRank: ").append(toIndentedString(bestTargetRank)).append("\n");
    sb.append("}");
    return sb.toString();
  }
