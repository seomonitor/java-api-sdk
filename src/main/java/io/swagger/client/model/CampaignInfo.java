...
/**
 * The campaign&#x27;s general information such as id, url etc. You can later use the id to retrive data for the groups, keywords etc for a specific campaign.
 */
@Schema(description = "The campaign's general information such as id, url etc. You can later use the id to retrive data for the groups, keywords etc for a specific campaign.")
...
public class CampaignInfo {
  ...
  private Integer keywordsCount = null;

  @SerializedName("campaign_currency")
  private String campaignCurrency = null;

  @SerializedName("analytics_currency")
  private String analyticsCurrency = null;
  ...
  @SerializedName("mrr")
  private Integer mrr = null;

  public CampaignInfo id(Integer id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "74516", description = "The id of the campaign")
   ...
   * @return name
  **/
  @Schema(example = "Asos.com", description = "The name of the campaign")
  ...
  public CampaignInfo company(String company) {
    this.company = company;
    return this;
  }

   /**
   * The name of the company which owns the campaign
   * @return company
  **/
  @Schema(example = "Asos", description = "The name of the company which owns the campaign")
  ...
  public CampaignInfo companyId(Integer companyId) {
    this.companyId = companyId;
    return this;
  }

   /**
   * The ID of the company that owns the campaign
   * @return companyId
  **/
  @Schema(example = "51256", description = "The ID of the company that owns the campaign")
  ...
  public CampaignInfo dateCreated(LocalDate dateCreated) {
    this.dateCreated = dateCreated;
    return this;
  }

   /**
   * The date when the campaign was created, in YYYY-MM-DD format.
   * @return dateCreated
  **/
  @Schema(example = "Tue Apr 25 02:00:00 SAST 2023", description = "The date when the campaign was created, in YYYY-MM-DD format.")
  ...
  public CampaignInfo keywordsCount(Integer keywordsCount) {
    this.keywordsCount = keywordsCount;
    return this;
  }

   /**
   * The number of active keywords in the campaign.
   * @return keywordsCount
  **/
  @Schema(example = "588", description = "The number of active keywords in the campaign.")
  ...
  public CampaignInfo campaignCurrency(String campaignCurrency) {
    this.campaignCurrency = campaignCurrency;
    return this;
  }

   /**
   * The campaign currency as configured in the campaign setup.
   * @return campaignCurrency
  **/
  @Schema(example = "EUR", description = "The campaign currency as configured in the campaign setup.")
  ...
  public CampaignInfo analyticsCurrency(String analyticsCurrency) {
    this.analyticsCurrency = analyticsCurrency;
    return this;
  }

   /**
   * The currency pulled from the Google Analytics connection.
   * @return analyticsCurrency
  **/
  @Schema(example = "EUR", description = "The currency pulled from the Google Analytics connection.")
  public String getAnalyticsCurrency() {
    return analyticsCurrency;
  }

  public void setAnalyticsCurrency(String analyticsCurrency) {
    this.analyticsCurrency = analyticsCurrency;
  }

  public CampaignInfo domain(String domain) {
    this.domain = domain;
    return this;
  }

   /**
   * The domain name of the website being tracked in the campaign.
   * @return domain
  **/
  @Schema(example = "www.asos.com", description = "The domain name of the website being tracked in the campaign.")
  ...
  public CampaignInfo location(String location) {
    this.location = location;
    return this;
  }

   /**
   * The location of the campaign as configured in the campaign setup.
   * @return location
  **/
  @Schema(example = "United Kingdom", description = "The location of the campaign as configured in the campaign setup.")
  ...
  public CampaignInfo mrr(Integer mrr) {
    this.mrr = mrr;
    return this;
  }

   /**
   * The value of the monthly recurring revenue (MRR) as configured in the platform.
   * @return mrr
  **/
  @Schema(example = "3000", description = "The value of the monthly recurring revenue (MRR) as configured in the platform.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, campaignInfo.id) &&
        Objects.equals(this.name, campaignInfo.name) &&
        Objects.equals(this.company, campaignInfo.company) &&
        Objects.equals(this.companyId, campaignInfo.companyId) &&
        Objects.equals(this.dateCreated, campaignInfo.dateCreated) &&
        Objects.equals(this.keywordsCount, campaignInfo.keywordsCount) &&
        Objects.equals(this.campaignCurrency, campaignInfo.campaignCurrency) &&
        Objects.equals(this.analyticsCurrency, campaignInfo.analyticsCurrency) &&
        Objects.equals(this.domain, campaignInfo.domain) &&
        Objects.equals(this.location, campaignInfo.location) &&
        Objects.equals(this.mrr, campaignInfo.mrr);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, company, companyId, dateCreated, keywordsCount, campaignCurrency, analyticsCurrency, domain, location, mrr);
  }
  ...
  public String toString() {
    ...
    sb.append("    campaignCurrency: ").append(toIndentedString(campaignCurrency)).append("\n");
    sb.append("    analyticsCurrency: ").append(toIndentedString(analyticsCurrency)).append("\n");
