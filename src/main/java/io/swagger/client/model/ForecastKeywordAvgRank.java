...
public class ForecastKeywordAvgRank {
  @SerializedName("initial_rank")
  private Integer initialRank = null;

  @SerializedName("actual_rank")
  private Integer actualRank = null;

  @SerializedName("estimated_rank")
  private Integer estimatedRank = null;

  @SerializedName("estimated_rank_best_target")
  private Integer estimatedRankBestTarget = null;

  @SerializedName("target_rank")
  private Integer targetRank = null;

  @SerializedName("target_rank_best")
  private Integer targetRankBest = null;

  public ForecastKeywordAvgRank initialRank(Integer initialRank) {
   ...
   * @return initialRank
  **/
  @Schema(example = "10", description = "The initial rank of the keyword for the month when the scenario was created.")
  ...
  public ForecastKeywordAvgRank actualRank(Integer actualRank) {
   ...
   * @return actualRank
  **/
  @Schema(example = "29", description = "The latest rank of the keyword on the day the data is returned. Returns empty if the scenario is not set as an Objective.")
  public Integer getActualRank() {
    return actualRank;
  }

  public void setActualRank(Integer actualRank) {
    this.actualRank = actualRank;
  }

  public ForecastKeywordAvgRank estimatedRank(Integer estimatedRank) {
  ...
  **/
  @Schema(example = "21", description = "The estimated rank of the keyword for the month when the data is returned. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.")
  public Integer getEstimatedRank() {
    return estimatedRank;
  }

  public void setEstimatedRank(Integer estimatedRank) {
    this.estimatedRank = estimatedRank;
  }

  public ForecastKeywordAvgRank estimatedRankBestTarget(Integer estimatedRankBestTarget) {
    this.estimatedRankBestTarget = estimatedRankBestTarget;
    return this;
  }
   ...
   * @return estimatedRankBestTarget
  **/
  @Schema(example = "23", description = "If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.")
  public Integer getEstimatedRankBestTarget() {
    return estimatedRankBestTarget;
  }

  public void setEstimatedRankBestTarget(Integer estimatedRankBestTarget) {
    this.estimatedRankBestTarget = estimatedRankBestTarget;
  }

  public ForecastKeywordAvgRank targetRank(Integer targetRank) {
   ...
   * @return targetRank
  **/
  @Schema(example = "1", description = "The targetted rank of the keyword for the last month of the timeframe. If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the lower (worst) target rank.")
  ...
  public ForecastKeywordAvgRank targetRankBest(Integer targetRankBest) {
    this.targetRankBest = targetRankBest;
    return this;
  }

   /**
   * If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.
   * @return targetRankBest
  **/
  @Schema(example = "9", description = "If the Target Rank Range parameter is enabled for the Scenario or Objective, this is the value for the higher (best) target rank. If not enabled, this parameter will return empty.")
  public Integer getTargetRankBest() {
    return targetRankBest;
  }

  public void setTargetRankBest(Integer targetRankBest) {
    this.targetRankBest = targetRankBest;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastKeywordAvgRank forecastKeywordAvgRank = (ForecastKeywordAvgRank) o;
    return Objects.equals(this.initialRank, forecastKeywordAvgRank.initialRank) &&
        Objects.equals(this.actualRank, forecastKeywordAvgRank.actualRank) &&
        Objects.equals(this.estimatedRank, forecastKeywordAvgRank.estimatedRank) &&
        Objects.equals(this.estimatedRankBestTarget, forecastKeywordAvgRank.estimatedRankBestTarget) &&
        Objects.equals(this.targetRank, forecastKeywordAvgRank.targetRank) &&
        Objects.equals(this.targetRankBest, forecastKeywordAvgRank.targetRankBest);
  }

  @Override
  public int hashCode() {
    return Objects.hash(initialRank, actualRank, estimatedRank, estimatedRankBestTarget, targetRank, targetRankBest);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastKeywordAvgRank {\n");
    
    sb.append("    initialRank: ").append(toIndentedString(initialRank)).append("\n");
    sb.append("    actualRank: ").append(toIndentedString(actualRank)).append("\n");
    sb.append("    estimatedRank: ").append(toIndentedString(estimatedRank)).append("\n");
    sb.append("    estimatedRankBestTarget: ").append(toIndentedString(estimatedRankBestTarget)).append("\n");
    sb.append("    targetRank: ").append(toIndentedString(targetRank)).append("\n");
    sb.append("    targetRankBest: ").append(toIndentedString(targetRankBest)).append("\n");
    sb.append("}");
    return sb.toString();
  }
