...
import io.swagger.client.model.ResearchRankingData;
import io.swagger.client.model.ResearchSearchData;
import io.swagger.client.model.ResearchSerpData;
...
public class TopicKeywordDetail {
  @SerializedName("keyword")
  private String keyword = null;

  @SerializedName("connection_strength")
  private Integer connectionStrength = null;

  @SerializedName("search_data")
  private ResearchSearchData searchData = null;

  @SerializedName("ranking_data")
  private ResearchRankingData rankingData = null;

  @SerializedName("serp_data")
  private ResearchSerpData serpData = null;

  @SerializedName("tracked_keyword_id")
  private Integer trackedKeywordId = null;

  public TopicKeywordDetail keyword(String keyword) {
   ...
   * @return keyword
  **/
  @Schema(example = "\"go fresco\"", description = "The exact keyword phrase for the returned related keyword.")
  ...
  public TopicKeywordDetail connectionStrength(Integer connectionStrength) {
  ...
  **/
  @Schema(example = "5", description = "The strength of the connection between the related keyword returned and the topic specified, in a range from 1 to 5, where 5 is a very strong connection.")
  public Integer getConnectionStrength() {
    return connectionStrength;
  }

  public void setConnectionStrength(Integer connectionStrength) {
    this.connectionStrength = connectionStrength;
  }

  public TopicKeywordDetail searchData(ResearchSearchData searchData) {
  ...
  **/
  @Schema(description = "")
  public ResearchSearchData getSearchData() {
    return searchData;
  }

  public void setSearchData(ResearchSearchData searchData) {
    this.searchData = searchData;
  }

  public TopicKeywordDetail rankingData(ResearchRankingData rankingData) {
  ...
  **/
  @Schema(description = "")
  public ResearchRankingData getRankingData() {
    return rankingData;
  }

  public void setRankingData(ResearchRankingData rankingData) {
    this.rankingData = rankingData;
  }

  public TopicKeywordDetail serpData(ResearchSerpData serpData) {
  ...
  **/
  @Schema(description = "")
  public ResearchSerpData getSerpData() {
    return serpData;
  }

  public void setSerpData(ResearchSerpData serpData) {
    this.serpData = serpData;
  }

  public TopicKeywordDetail trackedKeywordId(Integer trackedKeywordId) {
    this.trackedKeywordId = trackedKeywordId;
    return this;
  }
  ...
  **/
  @Schema(example = "1789784", description = "The unique ID used to identify and reference the keyword in the system. Returned only if the keyword is tracked in the SEOmonitor campaign. It can be stored and used in other endpoints for filtering.")
  public Integer getTrackedKeywordId() {
    return trackedKeywordId;
  }

  public void setTrackedKeywordId(Integer trackedKeywordId) {
    this.trackedKeywordId = trackedKeywordId;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopicKeywordDetail topicKeywordDetail = (TopicKeywordDetail) o;
    return Objects.equals(this.keyword, topicKeywordDetail.keyword) &&
        Objects.equals(this.connectionStrength, topicKeywordDetail.connectionStrength) &&
        Objects.equals(this.searchData, topicKeywordDetail.searchData) &&
        Objects.equals(this.rankingData, topicKeywordDetail.rankingData) &&
        Objects.equals(this.serpData, topicKeywordDetail.serpData) &&
        Objects.equals(this.trackedKeywordId, topicKeywordDetail.trackedKeywordId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyword, connectionStrength, searchData, rankingData, serpData, trackedKeywordId);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopicKeywordDetail {\n");
    
    sb.append("    keyword: ").append(toIndentedString(keyword)).append("\n");
    sb.append("    connectionStrength: ").append(toIndentedString(connectionStrength)).append("\n");
    ...
    sb.append("    trackedKeywordId: ").append(toIndentedString(trackedKeywordId)).append("\n");
    sb.append("}");
    return sb.toString();
  }
