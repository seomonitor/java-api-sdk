...
public class GscData {
  ...
  private Integer avgPosition = null;

  public GscData impressions(Integer impressions) {
   ...
   * @return impressions
  **/
  @Schema(description = "The total number of impressions in Google search results for the specified keyword over the specified timeframe.")
  ...
  public GscData clicks(Integer clicks) {
    this.clicks = clicks;
    return this;
  }
   ...
   * @return clicks
  **/
  @Schema(description = "The total number of clicks that the keyword received in Google search results over the specified timeframe.")
  ...
  public GscData avgPosition(Integer avgPosition) {
   ...
   * @return avgPosition
  **/
  @Schema(description = "The keyword's average position on Google over the specified timeframe, blended for desktop and mobile devices.")
  public Integer getAvgPosition() {
    return avgPosition;
  }

  public void setAvgPosition(Integer avgPosition) {
    this.avgPosition = avgPosition;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GscData gscData = (GscData) o;
    return Objects.equals(this.impressions, gscData.impressions) &&
        Objects.equals(this.clicks, gscData.clicks) &&
        Objects.equals(this.avgPosition, gscData.avgPosition);
  }

  @Override
  public int hashCode() {
    return Objects.hash(impressions, clicks, avgPosition);
  }
