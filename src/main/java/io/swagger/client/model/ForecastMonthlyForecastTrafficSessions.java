...
public class ForecastMonthlyForecastTrafficSessions {
  @SerializedName("inertial")
  private Integer inertial = null;

  @SerializedName("additional")
  private Integer additional = null;

  @SerializedName("additional_best_target")
  private Integer additionalBestTarget = null;

  public ForecastMonthlyForecastTrafficSessions inertial(Integer inertial) {
    this.inertial = inertial;
    return this;
  }

   /**
   * The number of Inertial Sessions.
   * @return inertial
  **/
  @Schema(description = "The number of Inertial Sessions.")
  public Integer getInertial() {
    return inertial;
  }

  public void setInertial(Integer inertial) {
    this.inertial = inertial;
  }

  public ForecastMonthlyForecastTrafficSessions additional(Integer additional) {
    this.additional = additional;
    return this;
  }

   /**
   * The number of Additional Sessions.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this is the value calculated for the lower (worst) target rank.
   * @return additional
  **/
  @Schema(description = "The number of Additional Sessions.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank.")
  ...
  public ForecastMonthlyForecastTrafficSessions additionalBestTarget(Integer additionalBestTarget) {
    this.additionalBestTarget = additionalBestTarget;
    return this;
  }

   /**
   * If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this parameter returns the value calculated for the higher (best) target rank.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;false\&quot;, this parameter will return empty. 
   * @return additionalBestTarget
  **/
  @Schema(description = "If the `target_rank_range` parameter returns \"true\", this parameter returns the value calculated for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty. ")
  public Integer getAdditionalBestTarget() {
    return additionalBestTarget;
  }

  public void setAdditionalBestTarget(Integer additionalBestTarget) {
    this.additionalBestTarget = additionalBestTarget;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastMonthlyForecastTrafficSessions forecastMonthlyForecastTrafficSessions = (ForecastMonthlyForecastTrafficSessions) o;
    return Objects.equals(this.inertial, forecastMonthlyForecastTrafficSessions.inertial) &&
        Objects.equals(this.additional, forecastMonthlyForecastTrafficSessions.additional) &&
        Objects.equals(this.additionalBestTarget, forecastMonthlyForecastTrafficSessions.additionalBestTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(inertial, additional, additionalBestTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastMonthlyForecastTrafficSessions {\n");
    
    sb.append("    inertial: ").append(toIndentedString(inertial)).append("\n");
    sb.append("    additional: ").append(toIndentedString(additional)).append("\n");
    sb.append("    additionalBestTarget: ").append(toIndentedString(additionalBestTarget)).append("\n");
    sb.append("}");
    return sb.toString();
  }
