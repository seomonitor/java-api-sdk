...
public class ForecastTrafficEstimatedAvgRanks {
  @SerializedName("estimated_best_target")
  private Integer estimatedBestTarget = null;

  @SerializedName("estimated")
  private Double estimated = null;

  public ForecastTrafficEstimatedAvgRanks estimatedBestTarget(Integer estimatedBestTarget) {
    this.estimatedBestTarget = estimatedBestTarget;
    return this;
  }
  ...
  **/
  ...
  public Integer getEstimatedBestTarget() {
    return estimatedBestTarget;
  }

  public void setEstimatedBestTarget(Integer estimatedBestTarget) {
    this.estimatedBestTarget = estimatedBestTarget;
  }

  public ForecastTrafficEstimatedAvgRanks estimated(Double estimated) {
    this.estimated = estimated;
    return this;
  }

   /**
   * The estimated average rank.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this is the value calculated for the lower (worst) target rank. 
   * @return estimated
  **/
  @Schema(description = "The estimated average rank.  If the `target_rank_range` parameter returns \"true\", this is the value calculated for the lower (worst) target rank. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastTrafficEstimatedAvgRanks forecastTrafficEstimatedAvgRanks = (ForecastTrafficEstimatedAvgRanks) o;
    return Objects.equals(this.estimatedBestTarget, forecastTrafficEstimatedAvgRanks.estimatedBestTarget) &&
        Objects.equals(this.estimated, forecastTrafficEstimatedAvgRanks.estimated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(estimatedBestTarget, estimated);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastTrafficEstimatedAvgRanks {\n");
    
    sb.append("    estimatedBestTarget: ").append(toIndentedString(estimatedBestTarget)).append("\n");
