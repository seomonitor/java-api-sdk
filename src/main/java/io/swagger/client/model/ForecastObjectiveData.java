...
import io.swagger.client.model.ForecastConfiguration;
import io.swagger.client.model.ForecastMonthlyForecasts;
import io.swagger.client.model.ForecastObjectiveDetails;
import io.swagger.client.model.ForecastOverviewData;
import io.swagger.client.model.ForecastSeoGoal;
...
public class ForecastObjectiveData {
  @SerializedName("objective_data")
  private ForecastObjectiveDetails objectiveData = null;

  @SerializedName("seo_goal")
  private ForecastSeoGoal seoGoal = null;

  @SerializedName("scenario_configuration")
  private ForecastConfiguration scenarioConfiguration = null;

  @SerializedName("overview_data")
  private ForecastOverviewData overviewData = null;

  @SerializedName("monthly_forecast")
  private ForecastMonthlyForecasts monthlyForecast = null;

  @SerializedName("monthly_forecast_extended")
  private ForecastMonthlyForecasts monthlyForecastExtended = null;

  public ForecastObjectiveData objectiveData(ForecastObjectiveDetails objectiveData) {
  ...
  **/
  @Schema(description = "")
  public ForecastObjectiveDetails getObjectiveData() {
    return objectiveData;
  }

  public void setObjectiveData(ForecastObjectiveDetails objectiveData) {
    this.objectiveData = objectiveData;
  }

  public ForecastObjectiveData seoGoal(ForecastSeoGoal seoGoal) {
    this.seoGoal = seoGoal;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public ForecastSeoGoal getSeoGoal() {
    return seoGoal;
  }

  public void setSeoGoal(ForecastSeoGoal seoGoal) {
    this.seoGoal = seoGoal;
  }

  public ForecastObjectiveData scenarioConfiguration(ForecastConfiguration scenarioConfiguration) {
    this.scenarioConfiguration = scenarioConfiguration;
    return this;
  }

   /**
   * Get scenarioConfiguration
   * @return scenarioConfiguration
  **/
  @Schema(description = "")
  public ForecastConfiguration getScenarioConfiguration() {
    return scenarioConfiguration;
  }

  public void setScenarioConfiguration(ForecastConfiguration scenarioConfiguration) {
    this.scenarioConfiguration = scenarioConfiguration;
  }

  public ForecastObjectiveData overviewData(ForecastOverviewData overviewData) {
  ...
  **/
  @Schema(description = "")
  public ForecastOverviewData getOverviewData() {
    return overviewData;
  }

  public void setOverviewData(ForecastOverviewData overviewData) {
    this.overviewData = overviewData;
  }

  public ForecastObjectiveData monthlyForecast(ForecastMonthlyForecasts monthlyForecast) {
  ...
  **/
  @Schema(description = "")
  public ForecastMonthlyForecasts getMonthlyForecast() {
    return monthlyForecast;
  }

  public void setMonthlyForecast(ForecastMonthlyForecasts monthlyForecast) {
    this.monthlyForecast = monthlyForecast;
  }

  public ForecastObjectiveData monthlyForecastExtended(ForecastMonthlyForecasts monthlyForecastExtended) {
    this.monthlyForecastExtended = monthlyForecastExtended;
    return this;
  }

   /**
   * Get monthlyForecastExtended
   * @return monthlyForecastExtended
  **/
  @Schema(description = "")
  public ForecastMonthlyForecasts getMonthlyForecastExtended() {
    return monthlyForecastExtended;
  }

  public void setMonthlyForecastExtended(ForecastMonthlyForecasts monthlyForecastExtended) {
    this.monthlyForecastExtended = monthlyForecastExtended;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastObjectiveData forecastObjectiveData = (ForecastObjectiveData) o;
    return Objects.equals(this.objectiveData, forecastObjectiveData.objectiveData) &&
        Objects.equals(this.seoGoal, forecastObjectiveData.seoGoal) &&
        Objects.equals(this.scenarioConfiguration, forecastObjectiveData.scenarioConfiguration) &&
        Objects.equals(this.overviewData, forecastObjectiveData.overviewData) &&
        Objects.equals(this.monthlyForecast, forecastObjectiveData.monthlyForecast) &&
        Objects.equals(this.monthlyForecastExtended, forecastObjectiveData.monthlyForecastExtended);
  }

  @Override
  public int hashCode() {
    return Objects.hash(objectiveData, seoGoal, scenarioConfiguration, overviewData, monthlyForecast, monthlyForecastExtended);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastObjectiveData {\n");
    
    sb.append("    objectiveData: ").append(toIndentedString(objectiveData)).append("\n");
    sb.append("    seoGoal: ").append(toIndentedString(seoGoal)).append("\n");
    sb.append("    scenarioConfiguration: ").append(toIndentedString(scenarioConfiguration)).append("\n");
    sb.append("    overviewData: ").append(toIndentedString(overviewData)).append("\n");
    sb.append("    monthlyForecast: ").append(toIndentedString(monthlyForecast)).append("\n");
    sb.append("    monthlyForecastExtended: ").append(toIndentedString(monthlyForecastExtended)).append("\n");
    sb.append("}");
    return sb.toString();
  }
