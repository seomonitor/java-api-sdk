...
public class DomainCompetitorVisibility {
  ...
  public DomainCompetitorVisibility visibility(Double visibility) {
    this.visibility = visibility;
    return this;
  }

   /**
   * The desktop Visibility of the requested domain or URL on the day of the latest crawl which is refreshed within the past 30 days.
   * @return visibility
  **/
  @Schema(example = "0.19", description = "The desktop Visibility of the requested domain or URL on the day of the latest crawl which is refreshed within the past 30 days.")
  ...
  public DomainCompetitorVisibility trend(Double trend) {
    this.trend = trend;
    return this;
  }

   /**
   * The percentage increase or decrease in Visibility of the requested domain or URL over the past two crawl dates.
   * @return trend
  **/
  @Schema(example = "0.1", description = "The percentage increase or decrease in Visibility of the requested domain or URL over the past two crawl dates.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DomainCompetitorVisibility domainCompetitorVisibility = (DomainCompetitorVisibility) o;
    return Objects.equals(this.visibility, domainCompetitorVisibility.visibility) &&
        Objects.equals(this.trend, domainCompetitorVisibility.trend);
  }

  @Override
  public int hashCode() {
    return Objects.hash(visibility, trend);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainCompetitorVisibility {\n");
