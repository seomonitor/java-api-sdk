...
import io.swagger.client.model.GroupsAvgRank;
import io.swagger.client.model.GroupsFeatureVisibility;
import io.swagger.client.model.GroupsVisibility;
...
public class GroupDailyVisibility {
  @SerializedName("date")
  private LocalDate date = null;

  @SerializedName("visibility")
  private GroupsVisibility visibility = null;

  @SerializedName("avg_rank")
  private GroupsAvgRank avgRank = null;

  @SerializedName("feature_visibility")
  private GroupsFeatureVisibility featureVisibility = null;

  public GroupDailyVisibility date(LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   * @return date
  **/
  @Schema(example = "Tue Aug 01 02:00:00 SAST 2023", description = "The date within the requested timeframe for which Visibility metrics are returned.")
  ...
  public GroupDailyVisibility visibility(GroupsVisibility visibility) {
  ...
  **/
  @Schema(description = "")
  public GroupsVisibility getVisibility() {
    return visibility;
  }

  public void setVisibility(GroupsVisibility visibility) {
    this.visibility = visibility;
  }

  public GroupDailyVisibility avgRank(GroupsAvgRank avgRank) {
  ...
  **/
  @Schema(description = "")
  public GroupsAvgRank getAvgRank() {
    return avgRank;
  }

  public void setAvgRank(GroupsAvgRank avgRank) {
    this.avgRank = avgRank;
  }

  public GroupDailyVisibility featureVisibility(GroupsFeatureVisibility featureVisibility) {
  ...
  **/
  @Schema(description = "")
  public GroupsFeatureVisibility getFeatureVisibility() {
    return featureVisibility;
  }

  public void setFeatureVisibility(GroupsFeatureVisibility featureVisibility) {
    this.featureVisibility = featureVisibility;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupDailyVisibility groupDailyVisibility = (GroupDailyVisibility) o;
    return Objects.equals(this.date, groupDailyVisibility.date) &&
        Objects.equals(this.visibility, groupDailyVisibility.visibility) &&
        Objects.equals(this.avgRank, groupDailyVisibility.avgRank) &&
        Objects.equals(this.featureVisibility, groupDailyVisibility.featureVisibility);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, visibility, avgRank, featureVisibility);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupDailyVisibility {\n");
    
    sb.append("    date: ").append(toIndentedString(date)).append("\n");
    sb.append("    visibility: ").append(toIndentedString(visibility)).append("\n");
    sb.append("    avgRank: ").append(toIndentedString(avgRank)).append("\n");
    sb.append("    featureVisibility: ").append(toIndentedString(featureVisibility)).append("\n");
    sb.append("}");
    return sb.toString();
  }
