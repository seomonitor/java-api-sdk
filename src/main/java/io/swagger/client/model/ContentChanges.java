...
import io.swagger.client.model.ContentChange;
...
public class ContentChanges {
  ...
  private List<ContentChange> changes = null;

  public ContentChanges date(LocalDate date) {
    this.date = date;
    return this;
  }
   ...
   * @return date
  **/
  @Schema(description = "The date the changes occurred")
  ...
  public ContentChanges rankData(KeywordCanibalizationRankData rankData) {
  ...
  **/
  ...
  public ContentChanges changes(List<ContentChange> changes) {
    this.changes = changes;
    return this;
  }

  public ContentChanges addChangesItem(ContentChange changesItem) {
    if (this.changes == null) {
      this.changes = new ArrayList<ContentChange>();
    }
   ...
   * @return changes
  **/
  @Schema(description = "An array of content changes")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ContentChanges contentChanges = (ContentChanges) o;
    return Objects.equals(this.date, contentChanges.date) &&
        Objects.equals(this.rankData, contentChanges.rankData) &&
        Objects.equals(this.changes, contentChanges.changes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, rankData, changes);
  }
  ...
  public String toString() {
    ...
    sb.append("class ContentChanges {\n");
