...
import io.swagger.client.model.KeywordDailyRankingData;
...
public class KeywordDailyRanks {
  ...
  private KeywordDailyRankingData rankingData = null;

  public KeywordDailyRanks keywordId(Integer keywordId) {
   ...
   * @return keywordId
  **/
  @Schema(example = "355", description = "The unique ID used to identify and reference the keyword in the system. It can be stored and used in other endpoints for filtering.")
  ...
  public KeywordDailyRanks keyword(String keyword) {
   ...
   * @return keyword
  **/
  @Schema(example = "vegan chocolate cake recipe", description = "The exact keyword phrase.")
  ...
  public KeywordDailyRanks rankingData(KeywordDailyRankingData rankingData) {
  ...
  **/
  @Schema(description = "")
  public KeywordDailyRankingData getRankingData() {
    return rankingData;
  }

  public void setRankingData(KeywordDailyRankingData rankingData) {
    this.rankingData = rankingData;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordDailyRanks keywordDailyRanks = (KeywordDailyRanks) o;
    return Objects.equals(this.keywordId, keywordDailyRanks.keywordId) &&
        Objects.equals(this.keyword, keywordDailyRanks.keyword) &&
        Objects.equals(this.rankingData, keywordDailyRanks.rankingData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keywordId, keyword, rankingData);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordDailyRanks {\n");
