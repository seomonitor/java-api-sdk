...
import io.swagger.client.model.ForecastMonthlyForecastTrafficSessions;
import io.swagger.client.model.ForecastTrafficConversions;
import io.swagger.client.model.ForecastTrafficEstimatedAvgRanks;
import io.swagger.client.model.ForecastTrafficRevenue;
import io.swagger.client.model.ForecastTrafficVisibility;
...
public class ForecastMonthlyForecastsTraffic {
  @SerializedName("sessions")
  private ForecastMonthlyForecastTrafficSessions sessions = null;

  @SerializedName("conversions")
  private ForecastTrafficConversions conversions = null;

  @SerializedName("revenue")
  private ForecastTrafficRevenue revenue = null;

  @SerializedName("visibility")
  private ForecastTrafficVisibility visibility = null;

  @SerializedName("estimated_avg_ranks")
  private ForecastTrafficEstimatedAvgRanks estimatedAvgRanks = null;

  public ForecastMonthlyForecastsTraffic sessions(ForecastMonthlyForecastTrafficSessions sessions) {
  ...
  **/
  @Schema(description = "")
  public ForecastMonthlyForecastTrafficSessions getSessions() {
    return sessions;
  }

  public void setSessions(ForecastMonthlyForecastTrafficSessions sessions) {
    this.sessions = sessions;
  }

  public ForecastMonthlyForecastsTraffic conversions(ForecastTrafficConversions conversions) {
  ...
  **/
  @Schema(description = "")
  public ForecastTrafficConversions getConversions() {
    return conversions;
  }

  public void setConversions(ForecastTrafficConversions conversions) {
    this.conversions = conversions;
  }

  public ForecastMonthlyForecastsTraffic revenue(ForecastTrafficRevenue revenue) {
  ...
  **/
  @Schema(description = "")
  public ForecastTrafficRevenue getRevenue() {
    return revenue;
  }

  public void setRevenue(ForecastTrafficRevenue revenue) {
    this.revenue = revenue;
  }

  public ForecastMonthlyForecastsTraffic visibility(ForecastTrafficVisibility visibility) {
  ...
  **/
  @Schema(description = "")
  public ForecastTrafficVisibility getVisibility() {
    return visibility;
  }

  public void setVisibility(ForecastTrafficVisibility visibility) {
    this.visibility = visibility;
  }

  public ForecastMonthlyForecastsTraffic estimatedAvgRanks(ForecastTrafficEstimatedAvgRanks estimatedAvgRanks) {
    this.estimatedAvgRanks = estimatedAvgRanks;
    return this;
  }

   /**
   * Get estimatedAvgRanks
   * @return estimatedAvgRanks
  **/
  @Schema(description = "")
  public ForecastTrafficEstimatedAvgRanks getEstimatedAvgRanks() {
    return estimatedAvgRanks;
  }

  public void setEstimatedAvgRanks(ForecastTrafficEstimatedAvgRanks estimatedAvgRanks) {
    this.estimatedAvgRanks = estimatedAvgRanks;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastMonthlyForecastsTraffic forecastMonthlyForecastsTraffic = (ForecastMonthlyForecastsTraffic) o;
    return Objects.equals(this.sessions, forecastMonthlyForecastsTraffic.sessions) &&
        Objects.equals(this.conversions, forecastMonthlyForecastsTraffic.conversions) &&
        Objects.equals(this.revenue, forecastMonthlyForecastsTraffic.revenue) &&
        Objects.equals(this.visibility, forecastMonthlyForecastsTraffic.visibility) &&
        Objects.equals(this.estimatedAvgRanks, forecastMonthlyForecastsTraffic.estimatedAvgRanks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sessions, conversions, revenue, visibility, estimatedAvgRanks);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastMonthlyForecastsTraffic {\n");
    
    sb.append("    sessions: ").append(toIndentedString(sessions)).append("\n");
    sb.append("    conversions: ").append(toIndentedString(conversions)).append("\n");
    sb.append("    revenue: ").append(toIndentedString(revenue)).append("\n");
    sb.append("    visibility: ").append(toIndentedString(visibility)).append("\n");
    sb.append("    estimatedAvgRanks: ").append(toIndentedString(estimatedAvgRanks)).append("\n");
    sb.append("}");
    return sb.toString();
  }
