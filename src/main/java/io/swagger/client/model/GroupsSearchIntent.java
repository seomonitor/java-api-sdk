 ...
 */
@Schema(description = "Parent field containing the search intent breakdown of the group in percentages out of its total search volume")
...
public class GroupsSearchIntent {
  @SerializedName("informational")
  private Double informational = null;

  @SerializedName("commercial")
  private Double commercial = null;

  @SerializedName("transactional")
  private Double transactional = null;

  public GroupsSearchIntent informational(Double informational) {
  ...
  **/
  @Schema(example = "0.25", description = "The percentage of the search volume of keywords that have informational search intent.")
  ...
  public GroupsSearchIntent commercial(Double commercial) {
   ...
   * @return commercial
  **/
  @Schema(example = "0.25", description = "The percentage of the search volume of keywords that have commercial search intent.")
  ...
  public GroupsSearchIntent transactional(Double transactional) {
  ...
  **/
  @Schema(example = "0.5", description = "The percentage of the search volume of keywords that have transactional search intent.")
  public Double getTransactional() {
    return transactional;
  }

  public void setTransactional(Double transactional) {
    this.transactional = transactional;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsSearchIntent groupsSearchIntent = (GroupsSearchIntent) o;
    return Objects.equals(this.informational, groupsSearchIntent.informational) &&
        Objects.equals(this.commercial, groupsSearchIntent.commercial) &&
        Objects.equals(this.transactional, groupsSearchIntent.transactional);
  }

  @Override
  public int hashCode() {
    return Objects.hash(informational, commercial, transactional);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsSearchIntent {\n");
