...
/**
 * A collection of metrics calculating the effort to reach the top. For more details on how this is calculated: https://help.seomonitor.com/en/articles/5612254-keyword-difficulty
 */
@Schema(description = "A collection of metrics calculating the effort to reach the top. For more details on how this is calculated: https://help.seomonitor.com/en/articles/5612254-keyword-difficulty")
...
public class DifficultyValue {
  ...
  private Boolean top10 = null;

  public DifficultyValue text(String text) {
    this.text = text;
    return this;
  }

   /**
   * Difficulty value as text. Available values are: Top10 &#x3D;&gt; Already in top; Easy &#x3D;&gt; Easy difficulty; Medium &#x3D;&gt; Medium difficulty; Hard &#x3D;&gt; Hard difficulty;
   * @return text
  **/
  @Schema(description = "Difficulty value as text. Available values are: Top10 => Already in top; Easy => Easy difficulty; Medium => Medium difficulty; Hard => Hard difficulty;")
  ...
  public DifficultyValue value(Integer value) {
    this.value = value;
    return this;
  }

   /**
   * Difficulty value as an integer. Available values are: 0 &#x3D;&gt; Already in top; 1 &#x3D;&gt; Easy; 2 &#x3D;&gt; Medium; 3 &#x3D;&gt; Hard;
   * @return value
  **/
  @Schema(description = "Difficulty value as an integer. Available values are: 0 => Already in top; 1 => Easy; 2 => Medium; 3 => Hard;")
  ...
  public DifficultyValue top10(Boolean top10) {
    this.top10 = top10;
    return this;
  }

   /**
   * Boolean value on whether the keyword is already in top 10 or not;
   * @return top10
  **/
  @Schema(description = "Boolean value on whether the keyword is already in top 10 or not;")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DifficultyValue difficultyValue = (DifficultyValue) o;
    return Objects.equals(this.text, difficultyValue.text) &&
        Objects.equals(this.value, difficultyValue.value) &&
        Objects.equals(this.top10, difficultyValue.top10);
  }

  @Override
  public int hashCode() {
    return Objects.hash(text, value, top10);
  }
  ...
  public String toString() {
    ...
    sb.append("class DifficultyValue {\n");
