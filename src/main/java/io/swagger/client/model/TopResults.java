...
import io.swagger.client.model.Top100Results;
...
public class TopResults {
  ...
  @SerializedName("top_100_results")
  private List<Top100Results> top100Results = null;

  public TopResults keywordId(Integer keywordId) {
   ...
   * @return keywordId
  **/
  @Schema(example = "12344", description = "The unique ID used to identify and reference the keyword in the SEOmonitor system. ")
  ...
  public TopResults keyword(String keyword) {
  ...
  **/
  ...
  public TopResults top100Results(List<Top100Results> top100Results) {
    this.top100Results = top100Results;
    return this;
  }

  public TopResults addTop100ResultsItem(Top100Results top100ResultsItem) {
    if (this.top100Results == null) {
      this.top100Results = new ArrayList<Top100Results>();
    }
    this.top100Results.add(top100ResultsItem);
    return this;
  }
  ...
  **/
  @Schema(description = "Parent field containing keyword ranking data for the competitors selected in the SEOmonitor platform, comprising of their domain, the ranking landing page for the keyword, and ranking data.")
  public List<Top100Results> getTop100Results() {
    return top100Results;
  }

  public void setTop100Results(List<Top100Results> top100Results) {
    this.top100Results = top100Results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopResults topResults = (TopResults) o;
    return Objects.equals(this.keywordId, topResults.keywordId) &&
        Objects.equals(this.keyword, topResults.keyword) &&
        Objects.equals(this.top100Results, topResults.top100Results);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keywordId, keyword, top100Results);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopResults {\n");
    
    sb.append("    keywordId: ").append(toIndentedString(keywordId)).append("\n");
    sb.append("    keyword: ").append(toIndentedString(keyword)).append("\n");
    sb.append("    top100Results: ").append(toIndentedString(top100Results)).append("\n");
    sb.append("}");
    return sb.toString();
  }
