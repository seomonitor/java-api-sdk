...
public class AnalyticsData {
  ...
  public AnalyticsData sessions(Integer sessions) {
   ...
   * @return sessions
  **/
  @Schema(description = "The sum of sessions, if the campaign is connected to both Google Search Console and Google Analytics – or clicks, if the campaign is only connected to Google Search Console, over the selected timeframe.")
  ...
  public AnalyticsData ecommerce(TrafficEcommerce ecommerce) {
  ...
  **/
  ...
  public AnalyticsData goals(TrafficGoals goals) {
    this.goals = goals;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.sessions, analyticsData.sessions) &&
        Objects.equals(this.ecommerce, analyticsData.ecommerce) &&
        Objects.equals(this.goals, analyticsData.goals);
  }
