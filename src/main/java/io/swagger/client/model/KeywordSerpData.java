...
import io.swagger.client.model.KeywordSerpFeature;
...
/**
 * An object containing the latest data about the SERP features present in the google searches from desktop and mobile devices.
 */
@Schema(description = "An object containing the latest data about the SERP features present in the google searches from desktop and mobile devices.")
...
public class KeywordSerpData {
  @SerializedName("desktop")
  private List<KeywordSerpFeature> desktop = null;

  @SerializedName("mobile")
  private List<KeywordSerpFeature> mobile = null;

  @SerializedName("percentage_clicks")
  private BigDecimal percentageClicks = null;

  public KeywordSerpData desktop(List<KeywordSerpFeature> desktop) {
    this.desktop = desktop;
    return this;
  }

  public KeywordSerpData addDesktopItem(KeywordSerpFeature desktopItem) {
    if (this.desktop == null) {
      this.desktop = new ArrayList<KeywordSerpFeature>();
    }
   ...
   * @return desktop
  **/
  @Schema(description = "Parent field containing the SERP features data for desktop devices.")
  public List<KeywordSerpFeature> getDesktop() {
    return desktop;
  }

  public void setDesktop(List<KeywordSerpFeature> desktop) {
    this.desktop = desktop;
  }

  public KeywordSerpData mobile(List<KeywordSerpFeature> mobile) {
    this.mobile = mobile;
    return this;
  }

  public KeywordSerpData addMobileItem(KeywordSerpFeature mobileItem) {
    if (this.mobile == null) {
      this.mobile = new ArrayList<KeywordSerpFeature>();
    }
   ...
   * @return mobile
  **/
  @Schema(description = "Parent field containing the SERP features data for mobile devices.")
  public List<KeywordSerpFeature> getMobile() {
    return mobile;
  }

  public void setMobile(List<KeywordSerpFeature> mobile) {
    this.mobile = mobile;
  }

  public KeywordSerpData percentageClicks(BigDecimal percentageClicks) {
  ...
  **/
  @Schema(example = "0.77", description = "The percentage of searches that end up clicking on organic results, after discounting the searches satisfied by SERP features. Blended metric between desktop and mobile searches.")
  public BigDecimal getPercentageClicks() {
    return percentageClicks;
  }

  public void setPercentageClicks(BigDecimal percentageClicks) {
    this.percentageClicks = percentageClicks;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordSerpData keywordSerpData = (KeywordSerpData) o;
    return Objects.equals(this.desktop, keywordSerpData.desktop) &&
        Objects.equals(this.mobile, keywordSerpData.mobile) &&
        Objects.equals(this.percentageClicks, keywordSerpData.percentageClicks);
  }

  @Override
  public int hashCode() {
    return Objects.hash(desktop, mobile, percentageClicks);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordSerpData {\n");
