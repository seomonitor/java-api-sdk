 ...
 * Forecast scenarios
 */
@Schema(description = "Forecast scenarios")
...
public class Scenarios {
  ...
  private Integer monthlyBudget = null;

  public Scenarios forecastId(Integer forecastId) {
   ...
   * @return forecastId
  **/
  @Schema(example = "2282", description = "The ID of the Forecast scenario for which the data is returned. ")
  ...
  public Scenarios name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(example = "\"Furniture forecast\"", description = "The name assigned to the scenario in the platform.")
  ...
  public Scenarios objective(Boolean objective) {
   ...
   * @return objective
  **/
  @Schema(example = "false", description = "Whether the Forecast scenario is set as the current Objective of the campaign.")
  ...
  public Scenarios createdDate(LocalDate createdDate) {
   ...
   * @return createdDate
  **/
  @Schema(description = "The date when the scenario was created, in YYYY-MM-DD format.")
  ...
  public Scenarios createdBy(String createdBy) {
   ...
   * @return createdBy
  **/
  @Schema(example = "\"Andrea Jones\"", description = "The first and last name of the user who created the scenario.")
  ...
  public Scenarios updatedDate(String updatedDate) {
   ...
   * @return updatedDate
  **/
  @Schema(example = "\"2023-08-27\"", description = "The date when the last changes were made to the SEO goal and configuration of the scenario.")
  ...
  public Scenarios monthlyBudget(Integer monthlyBudget) {
  ...
  **/
  @Schema(example = "5600", description = "The monthly budget allocated to the scenario, in the campaign currency.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.forecastId, scenarios.forecastId) &&
        Objects.equals(this.name, scenarios.name) &&
        Objects.equals(this.objective, scenarios.objective) &&
        Objects.equals(this.createdDate, scenarios.createdDate) &&
        Objects.equals(this.createdBy, scenarios.createdBy) &&
        Objects.equals(this.updatedDate, scenarios.updatedDate) &&
        Objects.equals(this.monthlyBudget, scenarios.monthlyBudget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forecastId, name, objective, createdDate, createdBy, updatedDate, monthlyBudget);
  }
