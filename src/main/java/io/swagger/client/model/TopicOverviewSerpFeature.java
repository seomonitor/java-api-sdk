...
public class TopicOverviewSerpFeature {
  ...
  public TopicOverviewSerpFeature feature(String feature) {
  ...
  **/
  ...
  public TopicOverviewSerpFeature count(Integer count) {
    this.count = count;
    return this;
  }

   /**
   * The number of keywords for which the SERP feature is present in the results. 
   * @return count
  **/
  @Schema(example = "50", description = "The number of keywords for which the SERP feature is present in the results. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopicOverviewSerpFeature topicOverviewSerpFeature = (TopicOverviewSerpFeature) o;
    return Objects.equals(this.feature, topicOverviewSerpFeature.feature) &&
        Objects.equals(this.count, topicOverviewSerpFeature.count);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feature, count);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopicOverviewSerpFeature {\n");
