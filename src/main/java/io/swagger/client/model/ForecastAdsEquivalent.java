...
public class ForecastAdsEquivalent {
  @SerializedName("equivalent")
  private Integer equivalent = null;

  @SerializedName("equivalent_best_target")
  private Integer equivalentBestTarget = null;

  public ForecastAdsEquivalent equivalent(Integer equivalent) {
    this.equivalent = equivalent;
    return this;
  }

   /**
   * The equivalent estimated spend if obtaining the same additional traffic through Google Ads alone.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, the &#x60;ads_equivalent&#x60; value is the value for the lower (worst) target rank.
   * @return equivalent
  **/
  @Schema(description = "The equivalent estimated spend if obtaining the same additional traffic through Google Ads alone.  If the `target_rank_range` parameter returns \"true\", the `ads_equivalent` value is the value for the lower (worst) target rank.")
  ...
  public ForecastAdsEquivalent equivalentBestTarget(Integer equivalentBestTarget) {
    this.equivalentBestTarget = equivalentBestTarget;
    return this;
  }

   /**
   * If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this parameter returns the value for the higher (best) target rank.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;false\&quot;, this parameter will return empty. 
   * @return equivalentBestTarget
  **/
  @Schema(description = "If the `target_rank_range` parameter returns \"true\", this parameter returns the value for the higher (best) target rank.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty. ")
  public Integer getEquivalentBestTarget() {
    return equivalentBestTarget;
  }

  public void setEquivalentBestTarget(Integer equivalentBestTarget) {
    this.equivalentBestTarget = equivalentBestTarget;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastAdsEquivalent forecastAdsEquivalent = (ForecastAdsEquivalent) o;
    return Objects.equals(this.equivalent, forecastAdsEquivalent.equivalent) &&
        Objects.equals(this.equivalentBestTarget, forecastAdsEquivalent.equivalentBestTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(equivalent, equivalentBestTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastAdsEquivalent {\n");
    
    sb.append("    equivalent: ").append(toIndentedString(equivalent)).append("\n");
    sb.append("    equivalentBestTarget: ").append(toIndentedString(equivalentBestTarget)).append("\n");
    sb.append("}");
    return sb.toString();
  }
