...
public class ForecastTargetAvgVisibility {
  @SerializedName("initial_visibility")
  private Double initialVisibility = null;

  @SerializedName("trend_3months")
  private Double trend3months = null;

  @SerializedName("target_visibility")
  private Double targetVisibility = null;

  @SerializedName("best_target_visibility")
  private Integer bestTargetVisibility = null;

  public ForecastTargetAvgVisibility initialVisibility(Double initialVisibility) {
    this.initialVisibility = initialVisibility;
    return this;
  }

   /**
   * The average Visibility calculated for the keywords included in the Objective for the month when the scenario was created.
   * @return initialVisibility
  **/
  @Schema(description = "The average Visibility calculated for the keywords included in the Objective for the month when the scenario was created.")
  public Double getInitialVisibility() {
    return initialVisibility;
  }

  public void setInitialVisibility(Double initialVisibility) {
    this.initialVisibility = initialVisibility;
  }

  public ForecastTargetAvgVisibility trend3months(Double trend3months) {
    this.trend3months = trend3months;
    return this;
  }

   /**
   * The average increase or drop in Visibility for the keywords in the Objective, over the previous 3 months up to the month the scenario was created, weighted by the keywords&#x27; search volume.
   * @return trend3months
  **/
  @Schema(description = "The average increase or drop in Visibility for the keywords in the Objective, over the previous 3 months up to the month the scenario was created, weighted by the keywords' search volume.")
  public Double getTrend3months() {
    return trend3months;
  }

  public void setTrend3months(Double trend3months) {
    this.trend3months = trend3months;
  }

  public ForecastTargetAvgVisibility targetVisibility(Double targetVisibility) {
    this.targetVisibility = targetVisibility;
    return this;
  }

   /**
   * The average target Visibility for the keywords in the Objective. If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, the &#x60;target_visibility&#x60; is the lower (worst) average target Visibility.
   * @return targetVisibility
  **/
  @Schema(description = "The average target Visibility for the keywords in the Objective. If the `target_rank_range` parameter returns \"true\", the `target_visibility` is the lower (worst) average target Visibility.")
  public Double getTargetVisibility() {
    return targetVisibility;
  }

  public void setTargetVisibility(Double targetVisibility) {
    this.targetVisibility = targetVisibility;
  }

  public ForecastTargetAvgVisibility bestTargetVisibility(Integer bestTargetVisibility) {
    this.bestTargetVisibility = bestTargetVisibility;
    return this;
  }

   /**
   * If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this parameter is the higher (best) average target Visibility. If the &#x60;target_rank_range&#x60; parameter returns \&quot;false\&quot;, this parameter will return empty.
   * @return bestTargetVisibility
  **/
  @Schema(description = "If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) average target Visibility. If the `target_rank_range` parameter returns \"false\", this parameter will return empty.")
  public Integer getBestTargetVisibility() {
    return bestTargetVisibility;
  }

  public void setBestTargetVisibility(Integer bestTargetVisibility) {
    this.bestTargetVisibility = bestTargetVisibility;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastTargetAvgVisibility forecastTargetAvgVisibility = (ForecastTargetAvgVisibility) o;
    return Objects.equals(this.initialVisibility, forecastTargetAvgVisibility.initialVisibility) &&
        Objects.equals(this.trend3months, forecastTargetAvgVisibility.trend3months) &&
        Objects.equals(this.targetVisibility, forecastTargetAvgVisibility.targetVisibility) &&
        Objects.equals(this.bestTargetVisibility, forecastTargetAvgVisibility.bestTargetVisibility);
  }

  @Override
  public int hashCode() {
    return Objects.hash(initialVisibility, trend3months, targetVisibility, bestTargetVisibility);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastTargetAvgVisibility {\n");
    
    sb.append("    initialVisibility: ").append(toIndentedString(initialVisibility)).append("\n");
    sb.append("    trend3months: ").append(toIndentedString(trend3months)).append("\n");
    sb.append("    targetVisibility: ").append(toIndentedString(targetVisibility)).append("\n");
    sb.append("    bestTargetVisibility: ").append(toIndentedString(bestTargetVisibility)).append("\n");
    sb.append("}");
    return sb.toString();
  }
