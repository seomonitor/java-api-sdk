...
public class GroupsDesktopVisibility {
  ...
  public GroupsDesktopVisibility latest(Double latest) {
    this.latest = latest;
    return this;
  }

   /**
   * The overall desktop Visibility at the end of the specified timeframe.
   * @return latest
  **/
  @Schema(description = "The overall desktop Visibility at the end of the specified timeframe.")
  ...
  public GroupsDesktopVisibility trend(Double trend) {
    this.trend = trend;
    return this;
  }

   /**
   * Percentage change in desktop Visibility of the website for all the keywords in the group over the given timeframe.
   * @return trend
  **/
  @Schema(description = "Percentage change in desktop Visibility of the website for all the keywords in the group over the given timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsDesktopVisibility groupsDesktopVisibility = (GroupsDesktopVisibility) o;
    return Objects.equals(this.latest, groupsDesktopVisibility.latest) &&
        Objects.equals(this.trend, groupsDesktopVisibility.trend);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsDesktopVisibility {\n");
