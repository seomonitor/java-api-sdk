...
public class ForecastAdditionalTraffic {
  @SerializedName("sessions")
  private Integer sessions = null;

  @SerializedName("sessions_best_target")
  private Integer sessionsBestTarget = null;

  @SerializedName("conversions")
  private Integer conversions = null;

  @SerializedName("conversions_best_target")
  private Integer conversionsBestTarget = null;

  @SerializedName("revenue")
  private Integer revenue = null;

  @SerializedName("revenue_best_target")
  private Integer revenueBestTarget = null;

  public ForecastAdditionalTraffic sessions(Integer sessions) {
    this.sessions = sessions;
    return this;
  }

   /**
   * Parent field containing data related to the estimated Additional Non-Brand Organic Sessions that would be achieved throughout the forecast timeframe.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, the &#x60;sessions&#x60; value is the lower (worst) Additional Sessions value.
   * @return sessions
  **/
  @Schema(description = "Parent field containing data related to the estimated Additional Non-Brand Organic Sessions that would be achieved throughout the forecast timeframe.  If the `target_rank_range` parameter returns \"true\", the `sessions` value is the lower (worst) Additional Sessions value.")
  ...
  public ForecastAdditionalTraffic sessionsBestTarget(Integer sessionsBestTarget) {
    this.sessionsBestTarget = sessionsBestTarget;
    return this;
  }

   /**
   * If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this parameter is the higher (best) Additional Sessions value.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;false\&quot;, this parameter will return empty. 
   * @return sessionsBestTarget
  **/
  @Schema(description = "If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) Additional Sessions value.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty. ")
  public Integer getSessionsBestTarget() {
    return sessionsBestTarget;
  }

  public void setSessionsBestTarget(Integer sessionsBestTarget) {
    this.sessionsBestTarget = sessionsBestTarget;
  }

  public ForecastAdditionalTraffic conversions(Integer conversions) {
    this.conversions = conversions;
    return this;
  }

   /**
   * The estimated Additional Non-Brand Organic Conversions that would be achieved throughout the forecast timeframe.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, the &#x60;conversions&#x60; value is the lower (worst) Additional Conversions value.
   * @return conversions
  **/
  @Schema(description = "The estimated Additional Non-Brand Organic Conversions that would be achieved throughout the forecast timeframe.  If the `target_rank_range` parameter returns \"true\", the `conversions` value is the lower (worst) Additional Conversions value.")
  ...
  public ForecastAdditionalTraffic conversionsBestTarget(Integer conversionsBestTarget) {
    this.conversionsBestTarget = conversionsBestTarget;
    return this;
  }

   /**
   * If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this parameter is the higher (best) Additional Conversions value.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;false\&quot;, this parameter will return empty. 
   * @return conversionsBestTarget
  **/
  @Schema(description = "If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) Additional Conversions value.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty. ")
  public Integer getConversionsBestTarget() {
    return conversionsBestTarget;
  }

  public void setConversionsBestTarget(Integer conversionsBestTarget) {
    this.conversionsBestTarget = conversionsBestTarget;
  }

  public ForecastAdditionalTraffic revenue(Integer revenue) {
    this.revenue = revenue;
    return this;
  }

   /**
   * The estimated Additional Non-Brand Organic Revenue that would be achieved throughout the forecast timeframe.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, the &#x60;revenue&#x60; value is the lower (worst) Additional Revenue value.
   * @return revenue
  **/
  @Schema(description = "The estimated Additional Non-Brand Organic Revenue that would be achieved throughout the forecast timeframe.  If the `target_rank_range` parameter returns \"true\", the `revenue` value is the lower (worst) Additional Revenue value.")
  ...
  public ForecastAdditionalTraffic revenueBestTarget(Integer revenueBestTarget) {
    this.revenueBestTarget = revenueBestTarget;
    return this;
  }

   /**
   * If the &#x60;target_rank_range&#x60; parameter returns \&quot;true\&quot;, this parameter is the higher (best) Additional Revenue value.  If the &#x60;target_rank_range&#x60; parameter returns \&quot;false\&quot;, this parameter will return empty. 
   * @return revenueBestTarget
  **/
  @Schema(description = "If the `target_rank_range` parameter returns \"true\", this parameter is the higher (best) Additional Revenue value.  If the `target_rank_range` parameter returns \"false\", this parameter will return empty. ")
  public Integer getRevenueBestTarget() {
    return revenueBestTarget;
  }

  public void setRevenueBestTarget(Integer revenueBestTarget) {
    this.revenueBestTarget = revenueBestTarget;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ForecastAdditionalTraffic forecastAdditionalTraffic = (ForecastAdditionalTraffic) o;
    return Objects.equals(this.sessions, forecastAdditionalTraffic.sessions) &&
        Objects.equals(this.sessionsBestTarget, forecastAdditionalTraffic.sessionsBestTarget) &&
        Objects.equals(this.conversions, forecastAdditionalTraffic.conversions) &&
        Objects.equals(this.conversionsBestTarget, forecastAdditionalTraffic.conversionsBestTarget) &&
        Objects.equals(this.revenue, forecastAdditionalTraffic.revenue) &&
        Objects.equals(this.revenueBestTarget, forecastAdditionalTraffic.revenueBestTarget);
  }

  @Override
  public int hashCode() {
    return Objects.hash(sessions, sessionsBestTarget, conversions, conversionsBestTarget, revenue, revenueBestTarget);
  }
  ...
  public String toString() {
    ...
    sb.append("class ForecastAdditionalTraffic {\n");
    
    sb.append("    sessions: ").append(toIndentedString(sessions)).append("\n");
    sb.append("    sessionsBestTarget: ").append(toIndentedString(sessionsBestTarget)).append("\n");
    sb.append("    conversions: ").append(toIndentedString(conversions)).append("\n");
    sb.append("    conversionsBestTarget: ").append(toIndentedString(conversionsBestTarget)).append("\n");
    sb.append("    revenue: ").append(toIndentedString(revenue)).append("\n");
    sb.append("    revenueBestTarget: ").append(toIndentedString(revenueBestTarget)).append("\n");
    sb.append("}");
    return sb.toString();
  }
