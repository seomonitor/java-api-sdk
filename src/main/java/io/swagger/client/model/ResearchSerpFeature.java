...
public class ResearchSerpFeature {
  ...
  public ResearchSerpFeature feature(String feature) {
   ...
   * @return feature
  **/
  @Schema(example = "IMG", description = "The abbreviated name of the SERP feature.")
  ...
  public ResearchSerpFeature position(Integer position) {
   ...
   * @return position
  **/
  @Schema(example = "4", description = "The position of the feature on the Google results page. It can be a number from 1 to 100 or \"side\" if the element is on the right-side panel (e.g., Knowledge Graph on desktop searches).")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResearchSerpFeature researchSerpFeature = (ResearchSerpFeature) o;
    return Objects.equals(this.feature, researchSerpFeature.feature) &&
        Objects.equals(this.position, researchSerpFeature.position);
  }

  @Override
  public int hashCode() {
    return Objects.hash(feature, position);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResearchSerpFeature {\n");
