 ...
 */
@Schema(description = "Parent field containing the Visibility for the requested SERP feature, for the date specified.")
...
public class GroupsFeatureVisibility {
  ...
  public GroupsFeatureVisibility desktop(Double desktop) {
   ...
   * @return desktop
  **/
  @Schema(example = "20.1", description = "The desktop SERP feature Visibility.")
  ...
  public GroupsFeatureVisibility mobile(Double mobile) {
    this.mobile = mobile;
    return this;
  }
   ...
   * @return mobile
  **/
  @Schema(example = "0", description = "The mobile SERP feature Visibility.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsFeatureVisibility groupsFeatureVisibility = (GroupsFeatureVisibility) o;
    return Objects.equals(this.desktop, groupsFeatureVisibility.desktop) &&
        Objects.equals(this.mobile, groupsFeatureVisibility.mobile);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsFeatureVisibility {\n");
