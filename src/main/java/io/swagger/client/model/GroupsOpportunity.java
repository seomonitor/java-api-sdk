...
public class GroupsOpportunity {
  @SerializedName("score")
  private BigDecimal score = null;

  @SerializedName("additional_monthly_sessions")
  private Integer additionalMonthlySessions = null;
  ...
  public GroupsOpportunity score(BigDecimal score) {
    this.score = score;
    return this;
  }
   ...
   * @return score
  **/
  @Schema(example = "5.7", description = "The Opportunity score from 0 to 10.  For the keywords where the Opportunity score is not computed, the value returned will be \"N/A\".")
  ...
  public GroupsOpportunity additionalMonthlySessions(Integer additionalMonthlySessions) {
    this.additionalMonthlySessions = additionalMonthlySessions;
    return this;
  }

   /**
   * The potential additional monthly sessions if the keywords rank in top 3 on average.
   * @return additionalMonthlySessions
  **/
  @Schema(example = "883000", description = "The potential additional monthly sessions if the keywords rank in top 3 on average.")
  public Integer getAdditionalMonthlySessions() {
    return additionalMonthlySessions;
  }

  public void setAdditionalMonthlySessions(Integer additionalMonthlySessions) {
    this.additionalMonthlySessions = additionalMonthlySessions;
  }

  public GroupsOpportunity difficulty(String difficulty) {
   ...
   * @return difficulty
  **/
  @Schema(example = "hard", description = "The Difficulty level of the keyword to rank in Top 10. Possible values are `already_top_10`, `easy`, `medium`, or `hard`.")
  ...
  public GroupsOpportunity avgCpc(Double avgCpc) {
    this.avgCpc = avgCpc;
    return this;
  }
   ...
   * @return avgCpc
  **/
  @Schema(example = "1.12", description = "The average cost per click.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsOpportunity groupsOpportunity = (GroupsOpportunity) o;
    return Objects.equals(this.score, groupsOpportunity.score) &&
        Objects.equals(this.additionalMonthlySessions, groupsOpportunity.additionalMonthlySessions) &&
        Objects.equals(this.difficulty, groupsOpportunity.difficulty) &&
        Objects.equals(this.avgCpc, groupsOpportunity.avgCpc);
  }

  @Override
  public int hashCode() {
    return Objects.hash(score, additionalMonthlySessions, difficulty, avgCpc);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsOpportunity {\n");
    
    sb.append("    score: ").append(toIndentedString(score)).append("\n");
    sb.append("    additionalMonthlySessions: ").append(toIndentedString(additionalMonthlySessions)).append("\n");
