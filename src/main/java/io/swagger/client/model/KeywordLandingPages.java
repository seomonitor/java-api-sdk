...
import io.swagger.client.model.LandingPages;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * An object containing the landing pages that the keyword currently ranks for in a google search and the desired values (if any) that you have set in the app. If the keyword ranks outside top 100 the landing page value is the firs one that we found by searching site:yourdomain.com keyword.
 */
@Schema(description = "An object containing the landing pages that the keyword currently ranks for in a google search and the desired values (if any) that you have set in the app. If the keyword ranks outside top 100 the landing page value is the firs one that we found by searching site:yourdomain.com keyword.")
...
public class KeywordLandingPages {
  @SerializedName("desktop")
  private LandingPages desktop = null;

  @SerializedName("mobile")
  private LandingPages mobile = null;

  public KeywordLandingPages desktop(LandingPages desktop) {
  ...
  **/
  @Schema(description = "")
  public LandingPages getDesktop() {
    return desktop;
  }

  public void setDesktop(LandingPages desktop) {
    this.desktop = desktop;
  }

  public KeywordLandingPages mobile(LandingPages mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public LandingPages getMobile() {
    return mobile;
  }

  public void setMobile(LandingPages mobile) {
    this.mobile = mobile;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordLandingPages keywordLandingPages = (KeywordLandingPages) o;
    return Objects.equals(this.desktop, keywordLandingPages.desktop) &&
        Objects.equals(this.mobile, keywordLandingPages.mobile);
  }

  @Override
  public int hashCode() {
    return Objects.hash(desktop, mobile);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordLandingPages {\n");
