...
public class DomainCompetitorRank {
  @SerializedName("rank")
  ...
  public DomainCompetitorRank rank(Integer rank) {
    this.rank = rank;
    return this;
  }
   ...
   * @return rank
  **/
  @Schema(example = "28", description = "The position on Google at the latest crawl date refreshed within the past 30 days, for desktop devices.")
  ...
  public DomainCompetitorRank trend(Integer trend) {
    this.trend = trend;
    return this;
  }
   ...
   * @return trend
  **/
  @Schema(example = "-1", description = "The difference in positions on Google between the latest rank and the rank identified at the previous crawl, for desktop devices.")
  ...
  public DomainCompetitorRank landingPage(String landingPage) {
    this.landingPage = landingPage;
    return this;
  }

   /**
   * The landing page of the requested domain on URL that is currently ranking with the keyword on Google searches performed from desktop devices.
   * @return landingPage
  **/
  @Schema(example = "\"https://www.ubereats.com/gb/category/leicester-eng/dessert\"", description = "The landing page of the requested domain on URL that is currently ranking with the keyword on Google searches performed from desktop devices.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DomainCompetitorRank domainCompetitorRank = (DomainCompetitorRank) o;
    return Objects.equals(this.rank, domainCompetitorRank.rank) &&
        Objects.equals(this.trend, domainCompetitorRank.trend) &&
        Objects.equals(this.landingPage, domainCompetitorRank.landingPage);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rank, trend, landingPage);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainCompetitorRank {\n");
