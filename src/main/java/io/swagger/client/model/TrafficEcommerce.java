...
public class TrafficEcommerce {
  ...
  public TrafficEcommerce conversions(Integer conversions) {
   ...
   * @return conversions
  **/
  @Schema(example = "1512", description = "The sum of conversions uncovered through the (not provided) solution on the date within the selected timeframe.")
  ...
  public TrafficEcommerce revenue(Integer revenue) {
   ...
   * @return revenue
  **/
  @Schema(example = "97000", description = "The sum of ecommerce revenue uncovered through the (not provided) solution on the specified date within the selected timeframe.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TrafficEcommerce trafficEcommerce = (TrafficEcommerce) o;
    return Objects.equals(this.conversions, trafficEcommerce.conversions) &&
        Objects.equals(this.revenue, trafficEcommerce.revenue);
  }
  ...
  public String toString() {
    ...
    sb.append("class TrafficEcommerce {\n");
