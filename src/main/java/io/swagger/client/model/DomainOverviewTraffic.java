...
import io.swagger.client.model.OverviewTrafficData;
...
public class DomainOverviewTraffic {
  @SerializedName("my_traffic")
  private OverviewTrafficData myTraffic = null;

  @SerializedName("competitor_traffic")
  private OverviewTrafficData competitorTraffic = null;

  public DomainOverviewTraffic myTraffic(OverviewTrafficData myTraffic) {
  ...
  **/
  @Schema(description = "")
  public OverviewTrafficData getMyTraffic() {
    return myTraffic;
  }

  public void setMyTraffic(OverviewTrafficData myTraffic) {
    this.myTraffic = myTraffic;
  }

  public DomainOverviewTraffic competitorTraffic(OverviewTrafficData competitorTraffic) {
    this.competitorTraffic = competitorTraffic;
    return this;
  }

   /**
   * Get competitorTraffic
   * @return competitorTraffic
  **/
  @Schema(description = "")
  public OverviewTrafficData getCompetitorTraffic() {
    return competitorTraffic;
  }

  public void setCompetitorTraffic(OverviewTrafficData competitorTraffic) {
    this.competitorTraffic = competitorTraffic;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DomainOverviewTraffic domainOverviewTraffic = (DomainOverviewTraffic) o;
    return Objects.equals(this.myTraffic, domainOverviewTraffic.myTraffic) &&
        Objects.equals(this.competitorTraffic, domainOverviewTraffic.competitorTraffic);
  }

  @Override
  public int hashCode() {
    return Objects.hash(myTraffic, competitorTraffic);
  }
  ...
  public String toString() {
    ...
    sb.append("class DomainOverviewTraffic {\n");
    
    sb.append("    myTraffic: ").append(toIndentedString(myTraffic)).append("\n");
    sb.append("    competitorTraffic: ").append(toIndentedString(competitorTraffic)).append("\n");
    sb.append("}");
    return sb.toString();
  }
