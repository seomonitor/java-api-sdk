...
/**
 * Details about the current objective (if any) set for the campaign.
 */
@Schema(description = "Details about the current objective (if any) set for the campaign.")
...
public class Objective {
  ...
  private Double actualSessions = null;

  @SerializedName("estimated_sessions")
  private Integer estimatedSessions = null;

  @SerializedName("performance")
  private BigDecimal performance = null;
  ...
  public Objective status(String status) {
    this.status = status;
    return this;
  }

   /**
   * The status of the Objective, based on the campaign performance.  Possible values: &#x60;on_track&#x60;, &#x60;behind&#x60;, &#x60;at_risk&#x60;.
   * @return status
  **/
  @Schema(example = "on_track", description = "The status of the Objective, based on the campaign performance.  Possible values: `on_track`, `behind`, `at_risk`.")
  ...
  public Objective actualSessions(Double actualSessions) {
    this.actualSessions = actualSessions;
    return this;
  }

   /**
   * The non-brand organic traffic sessions recorded in the past 30 days.
   * @return actualSessions
  **/
  @Schema(example = "78400", description = "The non-brand organic traffic sessions recorded in the past 30 days.")
  public Double getActualSessions() {
    return actualSessions;
  }

  public void setActualSessions(Double actualSessions) {
    this.actualSessions = actualSessions;
  }

  public Objective estimatedSessions(Integer estimatedSessions) {
    this.estimatedSessions = estimatedSessions;
    return this;
  }

   /**
   * The non-brand organic traffic sessions estimated to be obtained in the past 30 days, based on the SEO goal set up in the Forecast Objective.
   * @return estimatedSessions
  **/
  @Schema(example = "78400", description = "The non-brand organic traffic sessions estimated to be obtained in the past 30 days, based on the SEO goal set up in the Forecast Objective.")
  ...
  public Objective performance(BigDecimal performance) {
    this.performance = performance;
    return this;
  }

   /**
   * The campaign&#x27;s traffic performance over the past 30 days, calculated by dividing the actual non-brand organic traffic by the estimated traffic in the last 30 days.
   * @return performance
  **/
  @Schema(example = "1.00", description = "The campaign's traffic performance over the past 30 days, calculated by dividing the actual non-brand organic traffic by the estimated traffic in the last 30 days.")
  ...
  public Objective startMonth(String startMonth) {
    this.startMonth = startMonth;
    return this;
  }

   /**
   * The first month of the forecast scenario that was set as an Objective.
   * @return startMonth
  **/
  @Schema(example = "Jun 2023", description = "The first month of the forecast scenario that was set as an Objective.")
  ...
  public Objective endMonth(String endMonth) {
    this.endMonth = endMonth;
    return this;
  }

   /**
   * The last month of the forecast scenario that was set as an Objective. 
   * @return endMonth
  **/
  @Schema(example = "Jul 2024", description = "The last month of the forecast scenario that was set as an Objective. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, objective.status) &&
        Objects.equals(this.actualSessions, objective.actualSessions) &&
        Objects.equals(this.estimatedSessions, objective.estimatedSessions) &&
        Objects.equals(this.performance, objective.performance) &&
        Objects.equals(this.startMonth, objective.startMonth) &&
        Objects.equals(this.endMonth, objective.endMonth);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, actualSessions, estimatedSessions, performance, startMonth, endMonth);
  }
  ...
  public String toString() {
    ...
    sb.append("    actualSessions: ").append(toIndentedString(actualSessions)).append("\n");
    sb.append("    estimatedSessions: ").append(toIndentedString(estimatedSessions)).append("\n");
