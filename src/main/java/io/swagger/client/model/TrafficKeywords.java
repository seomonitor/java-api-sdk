...
import io.swagger.client.model.AnalyticsData;
import io.swagger.client.model.GscData;
...
public class TrafficKeywords {
  ...
  private Boolean brand = null;

  @SerializedName("current_page")
  private String currentPage = null;

  @SerializedName("gsc_data")
  private GscData gscData = null;

  @SerializedName("analytics_data")
  private AnalyticsData analyticsData = null;

  public TrafficKeywords keyword(String keyword) {
   ...
   * @return keyword
  **/
  @Schema(example = "blue sneakers", description = "The exact keyword phrase for which traffic data is returned.")
  ...
  public TrafficKeywords trackedKeywordId(Integer trackedKeywordId) {
  ...
  **/
  @Schema(example = "36374", description = "The unique ID used to identify and reference the keyword in the system. Returned only if the keyword is tracked in the SEOmonitor campaign. It can be stored and used in other endpoints for filtering.")
  ...
  public TrafficKeywords brand(Boolean brand) {
    this.brand = brand;
    return this;
  }
   ...
   * @return brand
  **/
  @Schema(example = "false", description = "Whether the keyword is a brand name.")
  ...
  public TrafficKeywords currentPage(String currentPage) {
   ...
   * @return currentPage
  **/
  @Schema(description = "The current landing page that ranks for the keyword, irrespective of the specified timeframe.")
  ...
  public TrafficKeywords gscData(GscData gscData) {
  ...
  **/
  @Schema(description = "")
  public GscData getGscData() {
    return gscData;
  }

  public void setGscData(GscData gscData) {
    this.gscData = gscData;
  }

  public TrafficKeywords analyticsData(AnalyticsData analyticsData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TrafficKeywords trafficKeywords = (TrafficKeywords) o;
    return Objects.equals(this.keyword, trafficKeywords.keyword) &&
        Objects.equals(this.trackedKeywordId, trafficKeywords.trackedKeywordId) &&
        Objects.equals(this.brand, trafficKeywords.brand) &&
        Objects.equals(this.currentPage, trafficKeywords.currentPage) &&
        Objects.equals(this.gscData, trafficKeywords.gscData) &&
        Objects.equals(this.analyticsData, trafficKeywords.analyticsData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(keyword, trackedKeywordId, brand, currentPage, gscData, analyticsData);
  }
