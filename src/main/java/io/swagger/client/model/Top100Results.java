...
public class Top100Results {
  ...
  public Top100Results domain(String domain) {
    this.domain = domain;
    return this;
  }
   ...
   * @return domain
  **/
  @Schema(example = "footwear.com", description = "The root domain name of the competitor.")
  ...
  public Top100Results landingPage(String landingPage) {
   ...
   * @return landingPage
  **/
  @Schema(example = "https://www.footwear.com/athletic-shoes", description = "The full URL path of the page on the competitor's site that is currently ranking for this exact keyword.")
  ...
  public Top100Results rank(Integer rank) {
    this.rank = rank;
    return this;
  }
   ...
   * @return rank
  **/
  @Schema(example = "1", description = "The organic search ranking position of this specific result for the keyword on Google.")
  ...
  public Top100Results title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return title
  **/
  @Schema(example = "Athletic Shoes for Men and Women", description = "The title of the search result.")
  ...
  public Top100Results description(String description) {
   ...
   * @return description
  **/
  @Schema(example = "Find the perfect athletic shoes for your sport or activity. Free shipping and returns. Top brands for running, walking, cross-training and more.", description = "The description of the search result.")
  ...
  public Top100Results searchIntent(String searchIntent) {
   ...
   * @return searchIntent
  **/
  @Schema(description = "The main search intent of the landing page. Possible values are `informational`, `commercial`, and `transactional`.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Top100Results top100Results = (Top100Results) o;
    return Objects.equals(this.domain, top100Results.domain) &&
        Objects.equals(this.landingPage, top100Results.landingPage) &&
        Objects.equals(this.rank, top100Results.rank) &&
        Objects.equals(this.title, top100Results.title) &&
        Objects.equals(this.description, top100Results.description) &&
        Objects.equals(this.searchIntent, top100Results.searchIntent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, landingPage, rank, title, description, searchIntent);
  }
