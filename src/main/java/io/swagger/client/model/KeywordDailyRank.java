...
public class KeywordDailyRank {
  ...
  public KeywordDailyRank date(LocalDate date) {
    this.date = date;
    return this;
  }

   /**
   * The date of the rank.
   * @return date
  **/
  @Schema(example = "Mon Nov 15 02:00:00 SAST 2021", description = "The date of the rank.")
  ...
  public KeywordDailyRank rank(Integer rank) {
    this.rank = rank;
    return this;
  }

   /**
   * The rank of the keyword on the day of the date field. 
   * @return rank
  **/
  @Schema(example = "2", description = "The rank of the keyword on the day of the date field. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordDailyRank keywordDailyRank = (KeywordDailyRank) o;
    return Objects.equals(this.date, keywordDailyRank.date) &&
        Objects.equals(this.rank, keywordDailyRank.rank);
  }

  @Override
  public int hashCode() {
    return Objects.hash(date, rank);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordDailyRank {\n");
