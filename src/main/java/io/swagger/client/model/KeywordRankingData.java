...
import io.swagger.client.model.KeywordRankTrend;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * An object containing information about the ranking data on Google search for both devices desktop and mobile.
 */
@Schema(description = "An object containing information about the ranking data on Google search for both devices desktop and mobile.")
...
public class KeywordRankingData {
  ...
  private KeywordRankTrend desktop = null;

  @SerializedName("mobile")
  private KeywordRankTrend mobile = null;

  public KeywordRankingData desktop(KeywordRankTrend desktop) {
  ...
  **/
  @Schema(description = "")
  public KeywordRankTrend getDesktop() {
    return desktop;
  }

  public void setDesktop(KeywordRankTrend desktop) {
    this.desktop = desktop;
  }

  public KeywordRankingData mobile(KeywordRankTrend mobile) {
    this.mobile = mobile;
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public KeywordRankTrend getMobile() {
    return mobile;
  }

  public void setMobile(KeywordRankTrend mobile) {
    this.mobile = mobile;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordRankingData keywordRankingData = (KeywordRankingData) o;
    return Objects.equals(this.desktop, keywordRankingData.desktop) &&
        Objects.equals(this.mobile, keywordRankingData.mobile);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordRankingData {\n");
