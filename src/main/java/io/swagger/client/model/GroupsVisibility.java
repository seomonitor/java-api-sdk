 ...
 */
@Schema(description = "Parent field containing the desktop and mobile Visibility metrics of the requested domain for the date specified.")
...
public class GroupsVisibility {
  ...
  public GroupsVisibility desktop(Double desktop) {
   ...
   * @return desktop
  **/
  @Schema(example = "0.56", description = "The desktop Visibility of the requested domain.")
  ...
  public GroupsVisibility mobile(Double mobile) {
    this.mobile = mobile;
    return this;
  }
   ...
   * @return mobile
  **/
  @Schema(example = "0.53", description = "The mobile Visibility of the requested domain.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupsVisibility groupsVisibility = (GroupsVisibility) o;
    return Objects.equals(this.desktop, groupsVisibility.desktop) &&
        Objects.equals(this.mobile, groupsVisibility.mobile);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupsVisibility {\n");
