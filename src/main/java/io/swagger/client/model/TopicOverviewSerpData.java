...
import io.swagger.client.model.TopicOverviewSerpFeature;
...
public class TopicOverviewSerpData {
  @SerializedName("percentage_clicks")
  private Integer percentageClicks = null;

  @SerializedName("serp_features")
  private List<TopicOverviewSerpFeature> serpFeatures = null;

  public TopicOverviewSerpData percentageClicks(Integer percentageClicks) {
  ...
  **/
  @Schema(description = "The percentage of searches that end up clicking on organic results, based on the sum of Top 10 positions' CTRs after discounting the searches satisfied by SERP features.")
  public Integer getPercentageClicks() {
    return percentageClicks;
  }

  public void setPercentageClicks(Integer percentageClicks) {
    this.percentageClicks = percentageClicks;
  }

  public TopicOverviewSerpData serpFeatures(List<TopicOverviewSerpFeature> serpFeatures) {
    this.serpFeatures = serpFeatures;
    return this;
  }

  public TopicOverviewSerpData addSerpFeaturesItem(TopicOverviewSerpFeature serpFeaturesItem) {
    if (this.serpFeatures == null) {
      this.serpFeatures = new ArrayList<TopicOverviewSerpFeature>();
    }
    this.serpFeatures.add(serpFeaturesItem);
    return this;
  }
   ...
   * @return serpFeatures
  **/
  @Schema(example = "[         {             \"feature\": \"IMG\",             \"count\": 10         }     ]", description = "Parent field containing the top 10 SERP features present for the returned keywords and their presence count for the day of the latest crawl refreshed within the past 30 days, for desktop searches.  Please refer to the Quick Start Guide for the complete feature name of each abbreviation. ")
  public List<TopicOverviewSerpFeature> getSerpFeatures() {
    return serpFeatures;
  }

  public void setSerpFeatures(List<TopicOverviewSerpFeature> serpFeatures) {
    this.serpFeatures = serpFeatures;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TopicOverviewSerpData topicOverviewSerpData = (TopicOverviewSerpData) o;
    return Objects.equals(this.percentageClicks, topicOverviewSerpData.percentageClicks) &&
        Objects.equals(this.serpFeatures, topicOverviewSerpData.serpFeatures);
  }

  @Override
  public int hashCode() {
    return Objects.hash(percentageClicks, serpFeatures);
  }
  ...
  public String toString() {
    ...
    sb.append("class TopicOverviewSerpData {\n");
    
    sb.append("    percentageClicks: ").append(toIndentedString(percentageClicks)).append("\n");
    sb.append("    serpFeatures: ").append(toIndentedString(serpFeatures)).append("\n");
    sb.append("}");
    return sb.toString();
  }
