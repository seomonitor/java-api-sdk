...
public class MonthlySearches {
  ...
  public MonthlySearches searchVolume(Integer searchVolume) {
    this.searchVolume = searchVolume;
    return this;
  }

   /**
   * The search volume recorded.
   * @return searchVolume
  **/
  @Schema(example = "82000", description = "The search volume recorded.")
  ...
  public MonthlySearches month(String month) {
    this.month = month;
    return this;
  }

   /**
   * The month for which the search volume is recorded.
   * @return month
  **/
  @Schema(example = "January", description = "The month for which the search volume is recorded.")
  ...
  public MonthlySearches year(Integer year) {
   ...
   /**
   * The year for the month for which the search volume is recorded.
   * @return year
  **/
  @Schema(example = "2022", description = "The year for the month for which the search volume is recorded.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.searchVolume, monthlySearches.searchVolume) &&
        Objects.equals(this.month, monthlySearches.month) &&
        Objects.equals(this.year, monthlySearches.year);
  }

  @Override
  public int hashCode() {
    return Objects.hash(searchVolume, month, year);
  }
