...
/**
 * Details about a SERP feature present in the google search and your presence inside tthat SERP feature.
 */
@Schema(description = "Details about a SERP feature present in the google search and your presence inside tthat SERP feature.")
...
public class KeywordSerpFeature {
  ...
  public KeywordSerpFeature position(Object position) {
    this.position = position;
    return this;
  }

   /**
   * The position of the feature on the Google results page. It can be a number from 1 to 100 or \&quot;side\&quot; if the element is on the right-side panel (e.g., Knowledge Graph on desktop searches).
   * @return position
  **/
  @Schema(example = "1", description = "The position of the feature on the Google results page. It can be a number from 1 to 100 or \"side\" if the element is on the right-side panel (e.g., Knowledge Graph on desktop searches).")
  ...
  public KeywordSerpFeature feature(String feature) {
   ...
   * @return feature
  **/
  @Schema(example = "adt", description = "The abbreviated name of the SERP feature.")
  ...
  public KeywordSerpFeature listed(Boolean listed) {
    this.listed = listed;
    return this;
  }

   /**
   * Whether your website is listed or not in the SERP feature.
   * @return listed
  **/
  @Schema(example = "true", description = "Whether your website is listed or not in the SERP feature.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeywordSerpFeature keywordSerpFeature = (KeywordSerpFeature) o;
    return Objects.equals(this.position, keywordSerpFeature.position) &&
        Objects.equals(this.feature, keywordSerpFeature.feature) &&
        Objects.equals(this.listed, keywordSerpFeature.listed);
  }

  @Override
  public int hashCode() {
    return Objects.hash(position, feature, listed);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeywordSerpFeature {\n");
