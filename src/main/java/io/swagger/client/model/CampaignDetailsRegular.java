...
import io.swagger.client.model.CampaignInfo;
import io.swagger.client.model.CampaignVisibility;
import io.swagger.client.model.Objective;
...
public class CampaignDetailsRegular {
  @SerializedName("campaign_info")
  private CampaignInfo campaignInfo = null;

  @SerializedName("visibility")
  private CampaignVisibility visibility = null;

  @SerializedName("multiple_locations")
  private List<Object> multipleLocations = null;

  @SerializedName("health_status")
  private String healthStatus = null;

  @SerializedName("objective_status")
  private Objective objectiveStatus = null;

  @SerializedName("reporting_status")
  private String reportingStatus = null;

  @SerializedName("account_manager")
  private String accountManager = null;

  public CampaignDetailsRegular campaignInfo(CampaignInfo campaignInfo) {
  ...
  **/
  ...
  public CampaignDetailsRegular visibility(CampaignVisibility visibility) {
  ...
  **/
  ...
  public CampaignDetailsRegular multipleLocations(List<Object> multipleLocations) {
    this.multipleLocations = multipleLocations;
    return this;
  }

  public CampaignDetailsRegular addMultipleLocationsItem(Object multipleLocationsItem) {
    if (this.multipleLocations == null) {
      this.multipleLocations = new ArrayList<Object>();
    }
    this.multipleLocations.add(multipleLocationsItem);
    return this;
  }

   /**
   * Parent field containing data for the additional tracked locations of the campaign.
   * @return multipleLocations
  **/
  @Schema(example = "[{\"campaign_id\": 12746, \"location\": \"London\", \"visibility\": {\"weekly\": {\"desktop\": {\"latest\": 0.32, \"trend\": 0.02},\"mobile\": {\"latest\": 0.33, \"trend\": 0.03},\"blended\": {\"latest\": 0.32, \"trend\": 0.03}},\"monthly\": {\"desktop\": {\"latest\": 0.31, \"trend\": 0.01},\"mobile\": {\"latest\": 0.34, \"trend\": 0.04},\"blended\": {\"latest\": 0.325, \"trend\": 0.025}}}}]", description = "Parent field containing data for the additional tracked locations of the campaign.")
  public List<Object> getMultipleLocations() {
    return multipleLocations;
  }

  public void setMultipleLocations(List<Object> multipleLocations) {
    this.multipleLocations = multipleLocations;
  }

  public CampaignDetailsRegular healthStatus(String healthStatus) {
    this.healthStatus = healthStatus;
    return this;
  }

   /**
   * The health status of the campaign.  Possible values: &#x60;poor&#x60;, &#x60;average&#x60;, &#x60;healthy&#x60;. 
   * @return healthStatus
  **/
  @Schema(example = "healthy", description = "The health status of the campaign.  Possible values: `poor`, `average`, `healthy`. ")
  ...
  public CampaignDetailsRegular objectiveStatus(Objective objectiveStatus) {
  ...
  **/
  @Schema(description = "")
  public Objective getObjectiveStatus() {
    return objectiveStatus;
  }

  public void setObjectiveStatus(Objective objectiveStatus) {
    this.objectiveStatus = objectiveStatus;
  }

  public CampaignDetailsRegular reportingStatus(String reportingStatus) {
    this.reportingStatus = reportingStatus;
    return this;
  }

   /**
   * The reporting status for the current month.  Possible values:   &#x60;pending&#x60;: The default status of the report at the beginning of the month.  &#x60;overdue&#x60;: If the report is not submitted by the due date set.  &#x60;in_progress&#x60;: If someone started working on the report in Google Slides.  &#x60;submitted&#x60;: If the report has been uploaded or finalized in Google Slides.  &#x60;inactive&#x60;: If the report tracking is turned off for the campaign. 
   * @return reportingStatus
  **/
  @Schema(example = "submitted", description = "The reporting status for the current month.  Possible values:   `pending`: The default status of the report at the beginning of the month.  `overdue`: If the report is not submitted by the due date set.  `in_progress`: If someone started working on the report in Google Slides.  `submitted`: If the report has been uploaded or finalized in Google Slides.  `inactive`: If the report tracking is turned off for the campaign. ")
  ...
  public CampaignDetailsRegular accountManager(String accountManager) {
    this.accountManager = accountManager;
    return this;
  }

   /**
   * The first and last name of the user assigned as the Account Manager of the campaign.
   * @return accountManager
  **/
  @Schema(example = "Jo Hart", description = "The first and last name of the user assigned as the Account Manager of the campaign.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CampaignDetailsRegular campaignDetailsRegular = (CampaignDetailsRegular) o;
    return Objects.equals(this.campaignInfo, campaignDetailsRegular.campaignInfo) &&
        Objects.equals(this.visibility, campaignDetailsRegular.visibility) &&
        Objects.equals(this.multipleLocations, campaignDetailsRegular.multipleLocations) &&
        Objects.equals(this.healthStatus, campaignDetailsRegular.healthStatus) &&
        Objects.equals(this.objectiveStatus, campaignDetailsRegular.objectiveStatus) &&
        Objects.equals(this.reportingStatus, campaignDetailsRegular.reportingStatus) &&
        Objects.equals(this.accountManager, campaignDetailsRegular.accountManager);
  }

  @Override
  public int hashCode() {
    return Objects.hash(campaignInfo, visibility, multipleLocations, healthStatus, objectiveStatus, reportingStatus, accountManager);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignDetailsRegular {\n");
    ...
    sb.append("    reportingStatus: ").append(toIndentedString(reportingStatus)).append("\n");
