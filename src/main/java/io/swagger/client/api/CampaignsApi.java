...
import io.swagger.client.model.CampaignDetailsRegular;
...
public class CampaignsApi {
    ...
    /**
     * Build call for dashboardV30CampaignsTrackedGet
     * @param campaignIds The Tracked Campaigns IDs for which you want the data to be returned.  Please refer to the Quick Start Guide to learn how to retrieve your campaign IDs.  If you do not specify &#x60;campaign_ids&#x60;, the endpoint will return the data for all active Tracked Campaigns you have access to, across all company accounts. (optional)
     * @param companyId The ID of the subscription that contains the Tracked Campaigns for which you want to return data. This is useful for users who have access to multiple company accounts.  Please refer to the Quick Start Guide to learn how to retrieve your company IDs.  If you don&#x27;t specify a &#x60;company_id&#x60;, the endpoint will return the data for all Tracked Campaigns you have access to, across all company accounts. (optional)
     * @param limit The maximum number of Tracked Campaigns to return data for.   Maximum Value: 100 records per request  If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 10. (optional)
     ...
     */
    public com.squareup.okhttp.Call dashboardV30CampaignsTrackedGetCall(String campaignIds, Integer companyId, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/dashboard/v3.0/campaigns/tracked";

        List<Pair> localVarQueryParams = new ArrayList<Pair>();
        List<Pair> localVarCollectionQueryParams = new ArrayList<Pair>();
        if (campaignIds != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("campaign_ids", campaignIds));
        if (companyId != null)
    ...
    private com.squareup.okhttp.Call dashboardV30CampaignsTrackedGetValidateBeforeCall(String campaignIds, Integer companyId, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = dashboardV30CampaignsTrackedGetCall(campaignIds, companyId, limit, offset, progressListener, progressRequestListener);
        return call;
     ...
     * @param limit The maximum number of Tracked Campaigns to return data for.   Maximum Value: 100 records per request  If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 10. (optional)
     * @param offset This parameter specifies the starting point within the collection of resource results. It&#x27;s typically used with the &#x60;limit&#x60; parameter to implement pagination.  If you do not specify an &#x60;offset&#x60;, the API will start from the first record. (optional)
     * @return List&lt;CampaignDetailsRegular&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<CampaignDetailsRegular> dashboardV30CampaignsTrackedGet(String campaignIds, Integer companyId, Integer limit, Integer offset) throws ApiException {
        ApiResponse<List<CampaignDetailsRegular>> resp = dashboardV30CampaignsTrackedGetWithHttpInfo(campaignIds, companyId, limit, offset);
        return resp.getData();
    }
     ...
     * @param limit The maximum number of Tracked Campaigns to return data for.   Maximum Value: 100 records per request  If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 10. (optional)
     * @param offset This parameter specifies the starting point within the collection of resource results. It&#x27;s typically used with the &#x60;limit&#x60; parameter to implement pagination.  If you do not specify an &#x60;offset&#x60;, the API will start from the first record. (optional)
     * @return ApiResponse&lt;List&lt;CampaignDetailsRegular&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<CampaignDetailsRegular>> dashboardV30CampaignsTrackedGetWithHttpInfo(String campaignIds, Integer companyId, Integer limit, Integer offset) throws ApiException {
        com.squareup.okhttp.Call call = dashboardV30CampaignsTrackedGetValidateBeforeCall(campaignIds, companyId, limit, offset, null, null);
        Type localVarReturnType = new TypeToken<List<CampaignDetailsRegular>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Tracked Campaigns (asynchronously)
     * This endpoint returns a list of active Tracked Campaigns with their details, such as campaign_id, name, URL, keyword number, date created, account manager details, and Visibility data.
     * @param campaignIds The Tracked Campaigns IDs for which you want the data to be returned.  Please refer to the Quick Start Guide to learn how to retrieve your campaign IDs.  If you do not specify &#x60;campaign_ids&#x60;, the endpoint will return the data for all active Tracked Campaigns you have access to, across all company accounts. (optional)
     * @param companyId The ID of the subscription that contains the Tracked Campaigns for which you want to return data. This is useful for users who have access to multiple company accounts.  Please refer to the Quick Start Guide to learn how to retrieve your company IDs.  If you don&#x27;t specify a &#x60;company_id&#x60;, the endpoint will return the data for all Tracked Campaigns you have access to, across all company accounts. (optional)
     * @param limit The maximum number of Tracked Campaigns to return data for.   Maximum Value: 100 records per request  If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 10. (optional)
     ...
     */
    public com.squareup.okhttp.Call dashboardV30CampaignsTrackedGetAsync(String campaignIds, Integer companyId, Integer limit, Integer offset, final ApiCallback<List<CampaignDetailsRegular>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = dashboardV30CampaignsTrackedGetValidateBeforeCall(campaignIds, companyId, limit, offset, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<CampaignDetailsRegular>>(){}.getType();
