...
import io.swagger.client.model.ForecastKeywords;
import io.swagger.client.model.ForecastObjectiveData;
import io.swagger.client.model.ForecastScenarioData;
...
public class ForecastApi {
    ...
    /**
     * Build call for forecastV30KeywordsGet
     ...
     * @param forecastId This parameter specifies the ID of the Forecast scenario set as an Objective for which you want to return data.   Please refer to the &#x27;Quick Start Guide&#x27;  to retrieve the ID of your scenarios.  (required)
     ...
     */
    public com.squareup.okhttp.Call forecastV30KeywordsGetCall(Integer campaignId, Integer forecastId, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/forecast/v3.0/keywords";
        ...
        if (forecastId != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("forecast_id", forecastId));
        if (limit != null)
    ...
    private com.squareup.okhttp.Call forecastV30KeywordsGetValidateBeforeCall(Integer campaignId, Integer forecastId, Integer limit, Integer offset, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'campaignId' is set
        if (campaignId == null) {
            throw new ApiException("Missing the required parameter 'campaignId' when calling forecastV30KeywordsGet(Async)");
        }
        // verify the required parameter 'forecastId' is set
        if (forecastId == null) {
            throw new ApiException("Missing the required parameter 'forecastId' when calling forecastV30KeywordsGet(Async)");
        }
        
        com.squareup.okhttp.Call call = forecastV30KeywordsGetCall(campaignId, forecastId, limit, offset, progressListener, progressRequestListener);
        return call;
     ...
     * @param limit This parameter determines the maximum number of records to return in a single request.   Maximum Value: 1000 records per request   If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 100. (optional)
     * @param offset This parameter specifies the starting point within the collection of resource results. It&#x27;s typically used with the &#x60;limit&#x60; parameter to implement pagination.  If you do not specify an &#x60;offset&#x60;, the API will start from the first record. (optional)
     * @return List&lt;ForecastKeywords&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<ForecastKeywords> forecastV30KeywordsGet(Integer campaignId, Integer forecastId, Integer limit, Integer offset) throws ApiException {
        ApiResponse<List<ForecastKeywords>> resp = forecastV30KeywordsGetWithHttpInfo(campaignId, forecastId, limit, offset);
        return resp.getData();
    }
     ...
     * @param limit This parameter determines the maximum number of records to return in a single request.   Maximum Value: 1000 records per request   If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 100. (optional)
     * @param offset This parameter specifies the starting point within the collection of resource results. It&#x27;s typically used with the &#x60;limit&#x60; parameter to implement pagination.  If you do not specify an &#x60;offset&#x60;, the API will start from the first record. (optional)
     * @return ApiResponse&lt;List&lt;ForecastKeywords&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<ForecastKeywords>> forecastV30KeywordsGetWithHttpInfo(Integer campaignId, Integer forecastId, Integer limit, Integer offset) throws ApiException {
        com.squareup.okhttp.Call call = forecastV30KeywordsGetValidateBeforeCall(campaignId, forecastId, limit, offset, null, null);
        Type localVarReturnType = new TypeToken<List<ForecastKeywords>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Forecast keywords (asynchronously)
     * This endpoint returns the forecast data for the keywords included in the Forecast Scenario or Objective, including keyword data, target rank data, and additional traffic data, for the forecast timeframe.
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario set as an Objective for which you want to return data.   Please refer to the &#x27;Quick Start Guide&#x27;  to retrieve the ID of your scenarios.  (required)
     * @param limit This parameter determines the maximum number of records to return in a single request.   Maximum Value: 1000 records per request   If you do not specify a &#x60;limit&#x60;, the default number of records returned per request will be 100. (optional)
     ...
     */
    public com.squareup.okhttp.Call forecastV30KeywordsGetAsync(Integer campaignId, Integer forecastId, Integer limit, Integer offset, final ApiCallback<List<ForecastKeywords>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = forecastV30KeywordsGetValidateBeforeCall(campaignId, forecastId, limit, offset, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<ForecastKeywords>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for forecastV30ObjectiveGet
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call forecastV30ObjectiveGetCall(Integer campaignId, Integer forecastId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/forecast/v3.0/objective";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call forecastV30ObjectiveGetValidateBeforeCall(Integer campaignId, Integer forecastId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'campaignId' is set
        if (campaignId == null) {
            throw new ApiException("Missing the required parameter 'campaignId' when calling forecastV30ObjectiveGet(Async)");
        }
        // verify the required parameter 'forecastId' is set
        if (forecastId == null) {
            throw new ApiException("Missing the required parameter 'forecastId' when calling forecastV30ObjectiveGet(Async)");
        }
        
        com.squareup.okhttp.Call call = forecastV30ObjectiveGetCall(campaignId, forecastId, progressListener, progressRequestListener);
        return call;
     ...
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  (required)
     * @return ForecastObjectiveData
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ForecastObjectiveData forecastV30ObjectiveGet(Integer campaignId, Integer forecastId) throws ApiException {
        ApiResponse<ForecastObjectiveData> resp = forecastV30ObjectiveGetWithHttpInfo(campaignId, forecastId);
        return resp.getData();
    }
     ...
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  (required)
     * @return ApiResponse&lt;ForecastObjectiveData&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ForecastObjectiveData> forecastV30ObjectiveGetWithHttpInfo(Integer campaignId, Integer forecastId) throws ApiException {
        com.squareup.okhttp.Call call = forecastV30ObjectiveGetValidateBeforeCall(campaignId, forecastId, null, null);
        Type localVarReturnType = new TypeToken<ForecastObjectiveData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Forecast objective Data (asynchronously)
     * This endpoint returns the data of Forecast Scenarios set as Objectives, including the SEO goal and configuration parameters, the forecast results overview data, and the monthly actual and estimated results for the forecast timeframe.
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call forecastV30ObjectiveGetAsync(Integer campaignId, Integer forecastId, final ApiCallback<ForecastObjectiveData> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = forecastV30ObjectiveGetValidateBeforeCall(campaignId, forecastId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ForecastObjectiveData>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for forecastV30ScenarioGet
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  To get data for the Campaign Objective, use the &#x27;Get Forecast Objective Data&#x27;.  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call forecastV30ScenarioGetCall(Integer campaignId, Integer forecastId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/forecast/v3.0/scenario";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call forecastV30ScenarioGetValidateBeforeCall(Integer campaignId, Integer forecastId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'campaignId' is set
        if (campaignId == null) {
            throw new ApiException("Missing the required parameter 'campaignId' when calling forecastV30ScenarioGet(Async)");
        }
        // verify the required parameter 'forecastId' is set
        if (forecastId == null) {
            throw new ApiException("Missing the required parameter 'forecastId' when calling forecastV30ScenarioGet(Async)");
        }
        
        com.squareup.okhttp.Call call = forecastV30ScenarioGetCall(campaignId, forecastId, progressListener, progressRequestListener);
        return call;
     ...
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  To get data for the Campaign Objective, use the &#x27;Get Forecast Objective Data&#x27;.  (required)
     * @return ForecastScenarioData
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ForecastScenarioData forecastV30ScenarioGet(Integer campaignId, Integer forecastId) throws ApiException {
        ApiResponse<ForecastScenarioData> resp = forecastV30ScenarioGetWithHttpInfo(campaignId, forecastId);
        return resp.getData();
    }
     ...
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  To get data for the Campaign Objective, use the &#x27;Get Forecast Objective Data&#x27;.  (required)
     * @return ApiResponse&lt;ForecastScenarioData&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ForecastScenarioData> forecastV30ScenarioGetWithHttpInfo(Integer campaignId, Integer forecastId) throws ApiException {
        com.squareup.okhttp.Call call = forecastV30ScenarioGetValidateBeforeCall(campaignId, forecastId, null, null);
        Type localVarReturnType = new TypeToken<ForecastScenarioData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Forecast scenario Data (asynchronously)
     * This endpoint returns the data of Forecast Scenarios created in a specified campaign, including the scenario details, the SEO goal and configuration parameters, the forecast results overview data, and the monthly estimated results for the forecast timeframe.
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param forecastId This parameter specifies the ID of the Forecast scenario for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your Forecast scenarios.  To get data for the Campaign Objective, use the &#x27;Get Forecast Objective Data&#x27;.  (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call forecastV30ScenarioGetAsync(Integer campaignId, Integer forecastId, final ApiCallback<ForecastScenarioData> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = forecastV30ScenarioGetValidateBeforeCall(campaignId, forecastId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ForecastScenarioData>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for forecastV30ScenariosGet
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call forecastV30ScenariosGetCall(Integer campaignId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/forecast/v3.0/scenarios";
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call forecastV30ScenariosGetValidateBeforeCall(Integer campaignId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'campaignId' is set
        if (campaignId == null) {
            throw new ApiException("Missing the required parameter 'campaignId' when calling forecastV30ScenariosGet(Async)");
        }
        
        com.squareup.okhttp.Call call = forecastV30ScenariosGetCall(campaignId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Scenarios forecastV30ScenariosGet(Integer campaignId) throws ApiException {
        ApiResponse<Scenarios> resp = forecastV30ScenariosGetWithHttpInfo(campaignId);
        return resp.getData();
    }
     ...
     * This endpoint returns a list of Scenarios created in a specified campaign, including the Objective if one is set, and their details.
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @return ApiResponse&lt;Scenarios&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Scenarios> forecastV30ScenariosGetWithHttpInfo(Integer campaignId) throws ApiException {
        com.squareup.okhttp.Call call = forecastV30ScenariosGetValidateBeforeCall(campaignId, null, null);
        Type localVarReturnType = new TypeToken<Scenarios>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Forecast scenarios (asynchronously)
     * This endpoint returns a list of Scenarios created in a specified campaign, including the Objective if one is set, and their details.
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call forecastV30ScenariosGetAsync(Integer campaignId, final ApiCallback<Scenarios> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = forecastV30ScenariosGetValidateBeforeCall(campaignId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Scenarios>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
