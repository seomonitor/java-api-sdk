...
import io.swagger.client.model.TrafficKeywords;
import io.swagger.client.model.TrafficOverview;
...
public class OrganicTrafficApi {
    private ApiClient apiClient;

    public OrganicTrafficApi() {
        this(Configuration.getDefaultApiClient());
    }

    public OrganicTrafficApi(ApiClient apiClient) {
    ...
    /**
     * Build call for organicTrafficV30DailyTrafficGet
     ...
     * @param segment The name assigned to the segment in the platform. Accepted values are &#x60;all&#x60;, &#x60;non-brand&#x60;, &#x60;brand&#x60;, or the name of a custom traffic segment created in the SEOmonitor platform, e.g. \&quot;blog\&quot;.  Unless otherwise specified, data will be returned for the Non-Brand segment by default. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call organicTrafficV30DailyTrafficGetCall(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/organic-traffic/v3.0/daily-traffic";
    ...
    private com.squareup.okhttp.Call organicTrafficV30DailyTrafficGetValidateBeforeCall(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'campaignId' is set
        if (campaignId == null) {
            throw new ApiException("Missing the required parameter 'campaignId' when calling organicTrafficV30DailyTrafficGet(Async)");
        }
        // verify the required parameter 'startDate' is set
        if (startDate == null) {
            throw new ApiException("Missing the required parameter 'startDate' when calling organicTrafficV30DailyTrafficGet(Async)");
        }
        // verify the required parameter 'endDate' is set
        if (endDate == null) {
            throw new ApiException("Missing the required parameter 'endDate' when calling organicTrafficV30DailyTrafficGet(Async)");
        }
        
        com.squareup.okhttp.Call call = organicTrafficV30DailyTrafficGetCall(campaignId, startDate, endDate, segment, progressListener, progressRequestListener);
        return call;
     ...
     */
    public TrafficOverview organicTrafficV30DailyTrafficGet(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment) throws ApiException {
        ApiResponse<TrafficOverview> resp = organicTrafficV30DailyTrafficGetWithHttpInfo(campaignId, startDate, endDate, segment);
        return resp.getData();
    }
     ...
     * @param endDate This parameter specifies the end date of the timeframe for which you want to return the data, in YYYY-MM-DD format. (required)
     * @param segment The name assigned to the segment in the platform. Accepted values are &#x60;all&#x60;, &#x60;non-brand&#x60;, &#x60;brand&#x60;, or the name of a custom traffic segment created in the SEOmonitor platform, e.g. \&quot;blog\&quot;.  Unless otherwise specified, data will be returned for the Non-Brand segment by default. (optional)
     * @return ApiResponse&lt;TrafficOverview&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TrafficOverview> organicTrafficV30DailyTrafficGetWithHttpInfo(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment) throws ApiException {
        com.squareup.okhttp.Call call = organicTrafficV30DailyTrafficGetValidateBeforeCall(campaignId, startDate, endDate, segment, null, null);
        Type localVarReturnType = new TypeToken<TrafficOverview>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Daily Traffic Data by Segment (asynchronously)
     * This endpoint returns the organic traffic metrics by day for a traffic segment over a specified timeframe.  The data returned includes the number of sessions, conversions, bounce rate, and revenue.
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param startDate This parameter specifies the start date of the timeframe for which you want to return the data, in YYYY-MM-DD format. (required)
     * @param endDate This parameter specifies the end date of the timeframe for which you want to return the data, in YYYY-MM-DD format. (required)
     ...
     */
    public com.squareup.okhttp.Call organicTrafficV30DailyTrafficGetAsync(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, final ApiCallback<TrafficOverview> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = organicTrafficV30DailyTrafficGetValidateBeforeCall(campaignId, startDate, endDate, segment, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TrafficOverview>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for organicTrafficV30KeywordsGet
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param startDate This parameter specifies the start date of the timeframe for which you want to return the data, in YYYY-MM-DD format. (required)
     * @param endDate This parameter specifies the end date of the timeframe for which you want to return the data, in YYYY-MM-DD format. (required)
     * @param segment The name assigned to the segment in the platform. Accepted values are &#x60;all&#x60;, &#x60;non-brand&#x60;, &#x60;brand&#x60;, or the name of a custom traffic segment created in the SEOmonitor platform, e.g. \&quot;blog\&quot;.  Unless otherwise specified, data will be returned for the Non-Brand segment by default. (optional)
     ...
     * @param orderBy This parameter enables you to sort the returned data based on a specified field.  The field names you can use to sort data are:  - &#x60;avg_position&#x60;   - &#x60;sessions&#x60;  - &#x60;transactions&#x60;  - &#x60;goals&#x60;  - &#x60;transactions_revenue&#x60;  - &#x60;goals_revenue&#x60;   If you do not specify an &#x60;order_direction&#x60;, the default is &#x60;asc&#x60;, which means the API will sort the data in ascending order.  (optional)
     * @param orderDirection This parameter determines the sorting direction of the &#x60;order_by&#x60; field. You can sort the data in either ascending (&#x60;asc&#x60;) or descending (&#x60;desc&#x60;) order.  If the &#x60;tracking_status&#x60; is not specified, data for all keywords is returned. (optional)
     * @param trackingStatus This parameter enables you to filter the results based on the keyword property of being tracked in the SEOmonitor platform. Allowed values are &#x60;tracked&#x60;, &#x60;untracked&#x60;, and &#x60;all&#x60;.  If the &#x60;tracking_status&#x60; is not specified, data for all keywords is returned. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call organicTrafficV30KeywordsGetCall(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, Integer limit, Integer offset, String orderBy, String orderDirection, String trackingStatus, String search, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/organic-traffic/v3.0/keywords";
        ...
        localVarQueryParams.addAll(apiClient.parameterToPair("tracking_status", trackingStatus));
        if (search != null)
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call organicTrafficV30KeywordsGetValidateBeforeCall(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, Integer limit, Integer offset, String orderBy, String orderDirection, String trackingStatus, String search, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'campaignId' is set
        if (campaignId == null) {
            throw new ApiException("Missing the required parameter 'campaignId' when calling organicTrafficV30KeywordsGet(Async)");
        }
        // verify the required parameter 'startDate' is set
        if (startDate == null) {
            throw new ApiException("Missing the required parameter 'startDate' when calling organicTrafficV30KeywordsGet(Async)");
        }
        // verify the required parameter 'endDate' is set
        if (endDate == null) {
            throw new ApiException("Missing the required parameter 'endDate' when calling organicTrafficV30KeywordsGet(Async)");
        }
        
        com.squareup.okhttp.Call call = organicTrafficV30KeywordsGetCall(campaignId, startDate, endDate, segment, limit, offset, orderBy, orderDirection, trackingStatus, search, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public TrafficKeywords organicTrafficV30KeywordsGet(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, Integer limit, Integer offset, String orderBy, String orderDirection, String trackingStatus, String search) throws ApiException {
        ApiResponse<TrafficKeywords> resp = organicTrafficV30KeywordsGetWithHttpInfo(campaignId, startDate, endDate, segment, limit, offset, orderBy, orderDirection, trackingStatus, search);
        return resp.getData();
    }
     ...
     * @param trackingStatus This parameter enables you to filter the results based on the keyword property of being tracked in the SEOmonitor platform. Allowed values are &#x60;tracked&#x60;, &#x60;untracked&#x60;, and &#x60;all&#x60;.  If the &#x60;tracking_status&#x60; is not specified, data for all keywords is returned. (optional)
     * @param search The &#x60;search&#x60; parameter allows you to filter the results based on a keyword search. The API will return only those records where the keyword matches (fully or partially) the provided search term.  The search parameter is case-insensitive, allowing partial matches irrespective of casing. (optional)
     * @return ApiResponse&lt;TrafficKeywords&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<TrafficKeywords> organicTrafficV30KeywordsGetWithHttpInfo(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, Integer limit, Integer offset, String orderBy, String orderDirection, String trackingStatus, String search) throws ApiException {
        com.squareup.okhttp.Call call = organicTrafficV30KeywordsGetValidateBeforeCall(campaignId, startDate, endDate, segment, limit, offset, orderBy, orderDirection, trackingStatus, search, null, null);
        Type localVarReturnType = new TypeToken<TrafficKeywords>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get Traffic Data by Keywords (asynchronously)
     * This endpoint returns the traffic data by keyword for a specific traffic segment and timeframe.  Note: This endpoint will return data only if SEOmonitor pulled Google Search Console and/or Google Analytics data for the selected timeframe through an active connection.
     * @param campaignId This parameter specifies the ID of the campaign for which you want to return data.   Please refer to the Quick Start Guide to learn how to retrieve the IDs of your campaigns. (required)
     * @param startDate This parameter specifies the start date of the timeframe for which you want to return the data, in YYYY-MM-DD format. (required)
     * @param endDate This parameter specifies the end date of the timeframe for which you want to return the data, in YYYY-MM-DD format. (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call organicTrafficV30KeywordsGetAsync(Integer campaignId, LocalDate startDate, LocalDate endDate, String segment, Integer limit, Integer offset, String orderBy, String orderDirection, String trackingStatus, String search, final ApiCallback<TrafficKeywords> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = organicTrafficV30KeywordsGetValidateBeforeCall(campaignId, startDate, endDate, segment, limit, offset, orderBy, orderDirection, trackingStatus, search, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<TrafficKeywords>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
